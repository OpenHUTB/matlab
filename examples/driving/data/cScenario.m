classdef cScenario
    ...
    methods(Access=private,Hidden=true)
        ...
        function ds=copyMap(obj,scenario)
            ...
            ds=drivingScenario;
            ds.SampleTime=scenario.SampleTime;
            ds.StopTime=scenario.StopTime;
            ds.VerticalAxis='Y';
            ds.RoadHistory=scenario.RoadHistory;
            ds.RoadSegments=scenario.RoadSegments;
            ds.RoadTiles=scenario.RoadTiles;
            ds.RoadCenters=scenario.RoadCenters;
            ds.RoadTileCentroids=scenario.RoadTileCentroids;
            ds.RoadTileMaxRadii=scenario.RoadTileMaxRadii;
            ds.RoadID=scenario.RoadID;
            ds.CachedLaneMarkingVertices=scenario.CachedLaneMarkingVertices;
            ds.CachedLaneMarkingFaces=scenario.CachedLaneMarkingFaces;
            ds.ShowRoadBorders=scenario.ShowRoadBorders;
            ds.IsOpenDRIVERoad=scenario.IsOpenDRIVERoad;
            ds.EndRoadIDsRoadCenters=scenario.EndRoadIDsRoadCenters;
            ds.SampleTime=scenario.SampleTime;
            ds.StopTime=scenario.StopTime;
        end
