function[items,layout,info]=rfblkscreate_filedata_pane_generalmixer(this,varargin)
    ...
    [tempitems,layout,info]=rfblkscreate_filedata_pane_generalamp(this,varargin{:});
    ...
    file,fileprompt,browse,interpMethod,interpMethodprompt,mixerType,...
    mixerTypeprompt,flo,floprompt,spacerMain};
