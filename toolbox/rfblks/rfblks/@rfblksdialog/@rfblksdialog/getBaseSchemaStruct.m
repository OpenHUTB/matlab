function dlgStruct=getBaseSchemaStruct(this,parameters,...
    maskDescription,optPane)
    ...
    descriptionPane=rfblksGetContainerWidgetBase(...
    'group',this.Block.MaskType,'descriptionPane');
    ...
    dlgStruct.PreApplyCallback='rfblksDDGPreApply';
    dlgStruct.PreApplyArgs={this,'%dialog'};
    dlgStruct.PostApplyCallback='rfblksPostApply';
