function dlgStruct=getDialogSchema(this,dummy)
    ...
    radius=rfblksGetLeafWidgetBase('edit','','Radius',...
    this,'Radius');
    radius.RowSpan=[1,1];
    radius.ColSpan=[lwidget,rwidget];

    radiusprompt=rfblksGetLeafWidgetBase('text','Wire radius (m):',...
    'RadiusPrompt',0);
    radiusprompt.RowSpan=[1,1];
    radiusprompt.ColSpan=[lprompt,rprompt];
    ...
    separationprompt=rfblksGetLeafWidgetBase('text','Wire separation (m):',...
    'SeparationPrompt',0);
    ...
    mainPane.Items={radius,separation,muR,epsilonR,lossTangent,sigmaCond,...
    lineLength,stubMode,termination,radiusprompt,separationprompt,...
