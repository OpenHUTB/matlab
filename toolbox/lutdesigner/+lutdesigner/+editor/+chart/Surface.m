classdef(Sealed)Surface<lutdesigner.editor.chart.ViewModel
...
SelectionPlot
    ...
    methods(Access=protected)
        function plotImpl(this,iv1Data,iv2Data,dvData)
            this.DataPlot=surf(this.Axes,iv1Data,iv2Data,dvData,'EdgeColor','interp','Tag','Data');
            this.DataPlot.CData=dvData;
            view(this.Axes,3);
        end
