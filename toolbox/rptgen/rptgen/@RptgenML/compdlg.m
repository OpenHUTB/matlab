function[selection,value]=compdlg(varargin)
    ...
    if mod(length(varargin),2)~=0
        ...
        error(message('rptgen:RptgenML:invalidCompDialogArguments'));
    end
    for i=1:2:length(varargin)
        ...
        otherwise
            error(message('rptgen:RptgenML:unknownCompDlgParameter',varargin{i}));
        end
    end
    ...
    l=handle.listener(allCategories,findprop(allCategories(1),'Expanded'),'PropertyPostSet',{@populateListbox,listbox});
