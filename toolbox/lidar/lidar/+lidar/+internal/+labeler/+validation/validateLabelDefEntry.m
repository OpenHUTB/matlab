function varargout=validateLabelDefEntry(columnNames,varargin)
    ...
    for argNum=1:numArgs
        ...
        case 'Type'
            ...
            varargout{argNum}=isa(varargin{argNum},'labelType')||isa(varargin{argNum},'lidarLabelType')...
            &&isscalar(varargin{argNum});
        ...
        case 'VoxelLabelID'
            ...
            isVoxelLabelType=varargin{labelTypeCol}==lidarLabelType.Voxel;
            id=varargin{argNum};

            if isVoxelLabelType
                varargout{argNum}=isValidVoxelLabelID(id);
            else
...
function TF=isValidVoxelLabelID(id)
    try
