function receiveFile(this,src,dst,ssh)
    ...
    try
        ...
        if isempty(dstpath)
            ...
            ftpobj.mget(srcname,dstpath);
        end

    catch ME
        this.throwErrorAsCaller('slrealtime:target:receiveFileError',...
        src,this.TargetSettings.name,dst,ME.message);
    end
end
