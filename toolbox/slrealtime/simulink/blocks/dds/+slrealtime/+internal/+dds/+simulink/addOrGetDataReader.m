function dataReader=addOrGetDataReader(modelName,blockName,topicPath,qosPath,...
    ...
    subscriber=slrealtime.internal.dds.simulink.addOrGetSubscriber(modelName,blockName,domainPath);
    readerName=[blockName,'_Reader'];
