classdef(StrictDefaults)GrayscaleOpening<visionhdl.internal.abstractLineMemoryKernel
...
%#ok<*EMCLS>
    ...
    methods(Static,Access=protected)
        function header=getHeaderImpl
            ...
            header=matlab.system.display.Header('visionhdl.GrayscaleOpening',...
            'ShowSourceLink',false,...
            'Title','Grayscale Opening');
        end

    end

    methods
        function obj=GrayscaleOpening(varargin)
    ...
    methods(Access=protected)
        ...
        function setupImpl(obj,pixelIn,ctrlIn)
            ...
            if isempty(coder.target)||~eml_ambiguous_types
                ...
                validateattributes(pixelIn,{'double','single','uint8','uint16','uint32','uint64','embedded.fi'},{'scalar'},'','pixelIn');
                if isfi(pixelIn)
