function topNet=elaborateBilateralFilter(this,topNet,blockInfo,inSig,outSig)
    ...
    if inputDim(1)==1
        ...
        filterKernelNet=this.elabBilateralFilterKernel(topNet,blockInfo,sigInfo);
    else

        filterKernelNet=this.elabBilateralFilterKernelMultiPixel(topNet,blockInfo,sigInfo);
    end
    ...
    preValidOut=topNet.addSignal(ctlType,'preValdiOut');
