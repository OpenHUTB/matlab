function topNet=elaborateMultiPixelCornerDetector(this,topNet,blockInfo,insignals,outsignals)
    ...
    LMKInfo.PaddingMethod='Symmetric';
    ...
    if blockInfo.BinaryImageOutputPort
        ...
        for ii=1:1:blockInfo.NumberOfPixels
            BImageOut(ii)=topNet.addSignal(ctrlType,'corner');
