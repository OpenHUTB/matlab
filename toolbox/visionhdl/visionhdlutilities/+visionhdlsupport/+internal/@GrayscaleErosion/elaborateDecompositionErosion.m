function cNet=elaborateDecompositionErosion(this,topNet,blockInfo,sigInfo,inRate)
    ...
    vanHerkNet=this.elaborateVanHerkErosion(cNet,blockInfo,sigInfo,inRate);
    ...
    VHCore=pirelab.instantiateNetwork(cNet,vanHerkNet,vanHerkIn,vanHerkOut,'VanHerkErosion');
    ...
    dataOutColREG=cNet.addSignal2('Type',inType,'Name','DataOutColREG');
    ...
    notValid=cNet.addSignal2('Type',booleanT,'Name','notValid');
    validOutS=cNet.addSignal2('Type',booleanT,'Name','validOutS');
    constLow=cNet.addSignal2('Type',inType,'Name','constLow');
    ...
    pipeDelay=ceil(log2(blockInfo.kHeight))+2;
    ...
    if mod(blockInfo.kWidth,2)==0
        ...
        pirelab.getIntDelayComp(cNet,validLB,validOutS,pipeDelay-1);
        pirelab.getUnitDelayComp(cNet,validOutS,validOut);

        pirelab.getLogicComp(cNet,validOutS,notValid,'not');
        pirelab.getUnitDelayComp(cNet,dataOutCol,dataOutColREG);
        pirelab.getUnitDelayResettableComp(cNet,dataOutColREG,dataOut,notValid);
    else
        pirelab.getIntDelayComp(cNet,hStartLB,hStartOut,pipeDelay-1);
        pirelab.getIntDelayComp(cNet,hEndLB,hEndOut,pipeDelay-1);
        pirelab.getIntDelayComp(cNet,vStartLB,vStartOut,pipeDelay-1);
        pirelab.getIntDelayComp(cNet,vEndLB,vEndOut,pipeDelay-1);
        pirelab.getIntDelayComp(cNet,validLB,validOutS,pipeDelay-2);
        pirelab.getUnitDelayComp(cNet,validOutS,validOut);

        pirelab.getLogicComp(cNet,validOutS,notValid,'not');
        pirelab.getWireComp(cNet,dataOutCol,dataOutColREG);
        pirelab.getUnitDelayResettableComp(cNet,dataOutColREG,dataOut,notValid);
