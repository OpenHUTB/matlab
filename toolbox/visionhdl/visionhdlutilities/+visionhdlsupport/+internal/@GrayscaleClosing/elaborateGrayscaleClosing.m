function elaborateGrayscaleClosing(this,topNet,blockInfo,inSignals,outSignals)
    ...
    grayScaleErodeNet=this.addGrayscaleDilation(topNet,dilationBlockInfo,sigInfo,inSignals,dilateOut);
    gE=pirelab.instantiateNetwork(topNet,grayScaleErodeNet,inSignals,dilateOut,'DilationCore');


    grayScaleDilateNet=this.addGrayscaleErosion(topNet,erosionBlockInfo,sigInfo,dilateOut,outSignals);
    gD=pirelab.instantiateNetwork(topNet,grayScaleDilateNet,dilateOut,outSignals,'ErosionCore');
