function cNet=elaborateVanHerkDilation(this,topNet,blockInfo,sigInfo,inRate)
    ...
    pirelab.getMinMaxComp(cNet,[forwardMaxREG,backwardMaxREG],dataMerge,'MergeStreamMax','max');
    ...
    if(mod(blockInfo.kWidth,2))==0
        pirelab.getIntDelayComp(cNet,dataMerge,dataOutREG,ceil(blockInfo.kWidth/2));
    ...
    pirelab.getSwitchComp(cNet,[constLow,dataOutREG],dataOutPre,validOut);
    pirelab.getWireComp(cNet,dataOutPre,dataOut);
