function hisl_0004
    ...
    options.sldvOpts={'DetectBlockConditions','HISL_0004'};

    rec=ModelAdvisor.SLDVCheck('mathworks.sldv.hism.hisl_0004',options);
...
function entities=FindEntities(system)
    ...
    blocks=Simulink.ID.getSID(find_system(system,'MatchFilter',@Simulink.match.internal.filterOutInactiveVariantSubsystemChoices,'RegExp','on','FollowLinks',fl,'LookUnderMasks',lum,'BlockType','Math','Operator','log|log10'));
