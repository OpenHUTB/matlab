function[v,obj]=maxConstraintViolation_AMats_regularized_(obj,x,ix0)
...
%#codegen
    ...
    if(~isempty(obj.Aineq))
        ...
        obj.maxConstrWorkspace=coder.internal.blas.xgemv('T',obj.nVarOrig,mIneq,1.0,obj.Aineq,...
        INT_ONE,obj.ldA,x,ix0,INT_ONE,-1.0,obj.maxConstrWorkspace,INT_ONE,INT_ONE);



        for idx=1:mIneq
            obj.maxConstrWorkspace(idx)=obj.maxConstrWorkspace(idx)-x(ix0+obj.nVarOrig+idx-1);
    ...
    if(~isempty(obj.Aeq))
        ...
        obj.maxConstrWorkspace=coder.internal.blas.xgemv('T',obj.nVarOrig,mEq,1.0,obj.Aeq,...
        INT_ONE,obj.ldA,x,ix0,INT_ONE,-1.0,obj.maxConstrWorkspace,INT_ONE,INT_ONE);



        offsetEq1=obj.nVarOrig+mIneq-1;
        offsetEq2=offsetEq1+mEq;
        for idx=1:mEq
            obj.maxConstrWorkspace(idx)=obj.maxConstrWorkspace(idx)-x(ix0+offsetEq1+idx)+x(ix0+offsetEq2+idx);
