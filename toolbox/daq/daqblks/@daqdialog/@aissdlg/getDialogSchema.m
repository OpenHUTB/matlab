function dlgStruct=getDialogSchema(obj,~)
    ...
    function parameterPane=localCreateAIParamGroup(obj,devices,existDAQObject,channelDataGenereatedFromObject)
        ...
        AIWidgetTags.DeviceMenu,devices,[rowInDialog,rowInDialog],colSpan,'daqblks.daqslcallback');
        ...
        AIWidgetTags.TableHeaderText,[rowInDialog,rowInDialog],colSpan);
        TableHeaderText.Alignment=8;


        colSpan=[2,2];
        SelectAll=tamslgate('privateslwidgetpushbutton',sprintf('Select All'),...
        AIWidgetTags.SelectAll,[rowInDialog,rowInDialog],...
        ...
        AIWidgetTags.BlockSampleTime,[rowInDialog,rowInDialog],...
        colSpan,'daqblks.daqslcallback');
        ...
        items={DaqDeviceMenu,TableHeaderText,SelectAll,UnselectAll,...
        ChannelTable,NPortsMenu,BlockSampleTimeField,OutputTimeStampField};
        colSpan=[1,3];
