...
function ttDisableAllBreakPointRF(cbinfo,action)
    ...
    shouldEnable=checkDisableAllBreakPointsEnabled(ttMan);
...
function shouldEnable=checkDisableAllBreakPointsEnabled(ttMan)
    shouldEnable=false;
