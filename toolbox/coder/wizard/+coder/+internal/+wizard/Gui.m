...
Title
    ...
    methods
        function obj=Gui(modelName)
            obj.ModelHandle=coder.internal.wizard.Wizard.getModelHandle(modelName);
            ...
            obj.Title=[message('RTW:wizard:QuickStart').getString,': ',modelName];
        ...
        function dlgstruct=getDialogSchema(obj,~)
            ...
            dlgstruct.CloseCallback='coder.internal.wizard.Gui.closeCallBack';
        ...
        function registerNameChangeCallback(obj)
            ...
            if~bdObj.hasCallback('PostNameChange',id)
                ...
                id,@()coder.internal.wizard.Gui.modelNameChangeCallback(modelHandle));
            end
        end
    end
    methods(Static=true)
        ...
        function modelNameChangeCallback(modelHandle)
            ...
            if~modelObject.hasCallback('PostNameChange',newId)
                Simulink.addBlockDiagramCallback(modelHandle,'PostNameChange',newId,@()coder.internal.wizard.Gui.modelNameChangeCallback(modelHandle));
            end
