...
function LogMinusTable=generateLogMinusTable(cfType)
    ...
    LogMinusTable=reinterpretcast(tmp1,numerictype(1,cfType.Log2IntermediatePrec+cfType.Log2NumberOfIterations+2,...
