function addMLFBAnnotation(varSubsys,mlfbName,fixptMlfbName)
    varSubsys=getfullname(varSubsys);
    [folder,~,~]=fileparts(mfilename('fullpath'));
    templateMdl=load_system(fullfile(folder,'MLFBAnnotationTemplate.slx'));
    ...
    try
        ...
        msg=strrep(msg,'MLFB_Annotation_Msg1',message('Coder:FXPCONV:MLFB_Annotation_Msg1').getString());
        msg=strrep(msg,'MLFB_Annotation_Msg2',message('Coder:FXPCONV:MLFB_Annotation_Msg2').getString());

        msg=strrep(msg,'MLFB_Annotation_Msg31',message('Coder:FXPCONV:MLFB_Annotation_Msg31').getString());
        msg=strrep(msg,'MLFB_Annotation_Msg3',message('Coder:FXPCONV:MLFB_Annotation_Msg3',formatBlockName(mlfbName)).getString());

        msg=strrep(msg,'MLFB_Annotation_Msg41',message('Coder:FXPCONV:MLFB_Annotation_Msg41').getString());
        msg=strrep(msg,'MLFB_Annotation_Msg4',message('Coder:FXPCONV:MLFB_Annotation_Msg4',formatBlockName(fixptMlfbName)).getString());


        msg=strrep(msg,'MLFB_Annotation_Msg5',message('Coder:FXPCONV:MLFB_Annotation_Msg5').getString());
        msg=strrep(msg,'MLFB_Annotation_Msg6',message('Coder:FXPCONV:MLFB_Annotation_Msg6').getString());
