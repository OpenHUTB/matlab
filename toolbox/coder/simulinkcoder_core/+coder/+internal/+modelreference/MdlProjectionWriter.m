...
classdef MdlProjectionWriter<coder.internal.modelreference.FunctionInterfaceWriter
    methods(Access=public)
        function this=MdlProjectionWriter(functionInterface,modelInterfaceUtils,codeInfoUtils,writer)
    ...
    methods(Access=protected)
        function p=getFunctionPrototype(~,~)
            p='void mdlProjection(SimStruct *S)';
        end
