classdef ArgOut<autosar.updater.ModelMappingMatcher
    ...
    methods
        function this=ArgOut(modelName)
        ...
        function markAsUnmatched(this)
            ...
            for ii=1:length(modelMapping.ServerFunctions)
                ...
                argInBlks=autosar.mm.mm2sl.SLModelBuilder.findSimulinkBlock(fcnCallInportPath,'ArgOut','');
        ...
        function[isMapped,blockPath]=isMapped(this,varargin)
            ...
            sys,'ArgOut','','ArgumentName',m3iArgument.Name);
        ...
        function logDeletions(this,changeLogger,~)
            this.logManualBlkDeletions(this.UnmatchedElements,'ArgOut','MarkBlockForDelete',changeLogger);
        end
    end
end
