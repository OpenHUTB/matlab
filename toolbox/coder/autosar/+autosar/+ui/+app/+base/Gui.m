...
HelpArgs
    ...
    methods(Access=public)
        function obj=Gui(env,ID,guiTag,title)
            ...
            obj.Title=title;
            obj.Tag=guiTag;
            webfolder='/toolbox/coder/autosar/+autosar/+ui/+app/web/';
        ...
        function cleanup(obj)
            ...
            if isa(obj.Env,'autosar.ui.app.link.ModelLinkingWizard')
                obj.Env.Manager.unregisterModelLinkingWizard(obj.Env.CompBlkH);
            elseif isa(obj.Env,'autosar.ui.app.quickstart.Wizard')
                obj.Env.Manager.unregisterQuickStartWizard(obj.Env.ModelHandle);
            elseif isa(obj.Env,'autosar.ui.app.import.ComponentImportWizard')||...
                isa(obj.Env,'autosar.ui.app.import.CompositionImportWizard')
                obj.Env.Manager.unregisterImportWizard(obj.Env.getSLSourceH());
            end
        ...
        function success=pushAnswer(obj,msg)
            ...
            for i=1:length(options)
                ...
                if~isempty(o)
                    if~strcmp(o.QuestionId,qId)
                        error('Options should belong to the same question');
                    end
                    o.setAnswer(value);
                end
            end
        ...
        function dlgstruct=getDialogSchema(obj,~)
            ...
            dlgstruct.CloseCallback='autosar.ui.app.base.Gui.closeCallBack';
    ...
    methods(Access=private)
        ...
        function switchTopic(obj,topicId)
            ...
            q=env.QuestionMap('SystemTargetFile');
        ...
        function launchHelp(obj)
            ...
            helpview(fullfile(docroot,'autosar','helptargets.map'),helpViewID);
        end
        ...
        function arxmlSelect(obj)
            obj.Env.arxmlSelect;
        end

        function modelSelect(obj)
            obj.Env.modelSelect;
        end
        ...
        function validateModel(obj)
            obj.Env.validateModel;
        end

        function sharedDictionarySelect(obj)
            obj.Env.sharedDictionarySelect;
        end
