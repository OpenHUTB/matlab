...
classdef(ConstructOnLoad)DivShiftLeft<RTW.TflCOperationEntryML
    methods
        function obj=DivShiftLeft(varargin)
            mlock;
            ...
            if dty.Bias==0&&...
                ...
                if(net_saf==1)&&(shiftVal<0)
                    ...
                    if length(ent.Implementation.Arguments)==3
                        ...
                        ent.Implementation.Arguments(3).Value=-1*shiftVal;
                    else
                        arg=RTW.TflArgNumericConstant('shift');
                        arg.Value=-1*shiftVal;
