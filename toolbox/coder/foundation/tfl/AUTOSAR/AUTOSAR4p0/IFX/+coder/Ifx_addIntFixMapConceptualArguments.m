function hEnt=Ifx_addIntFixMapConceptualArguments(hEnt,datatype_y1,datatype_u1,datatype_u2,datatype_bp01,...
    datatype_bpS1,datatype_bp02,datatype_bpS2,datatype_T)
    ...
    arg=hEnt.getTflArgFromString('u4',datatype_bpS1{1});
    ...
    arg=hEnt.getTflArgFromString('u6',datatype_bpS2{1});
