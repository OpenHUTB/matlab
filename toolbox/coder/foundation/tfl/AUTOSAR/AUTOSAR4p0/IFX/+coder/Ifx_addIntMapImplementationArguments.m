function hEnt=Ifx_addIntMapImplementationArguments(hEnt,datatype_y1,datatype_u1,datatype_u2,datatype_u3,...
    ...
    if~createRowMajorRoutine
        ...
        datatypeOrder={datatype_y1{2},datatype_u2{2},datatype_u1{2},datatype_Ny{2},datatype_Nx{2},datatype_u4{2},...
        datatype_u3{2},datatype_u5{2}};
    else
        ...
        datatypeOrder={datatype_y1{2},datatype_u1{2},datatype_u2{2},datatype_Nx{2},datatype_Ny{2},datatype_u3{2},...
        datatype_u4{2},datatype_u5{2}};
    end
