...
classdef(ConstructOnLoad)Ifx_IntCurCustomEntry<RTW.TflCFunctionEntryML
    methods
        function obj=Ifx_IntCurCustomEntry(varargin)
            mlock;
        ...
        function ent=do_match(hThis,...
            ...
            if(isequivalent(hCSO.ConceptualArgs(2).Type,hCSO.ConceptualArgs(3).Type.BaseType)&&...
                isequivalent(hCSO.ConceptualArgs(1).Type,hCSO.ConceptualArgs(4).Type.BaseType))
