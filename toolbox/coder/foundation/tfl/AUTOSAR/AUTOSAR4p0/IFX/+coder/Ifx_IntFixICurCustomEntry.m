...
classdef(ConstructOnLoad)Ifx_IntFixICurCustomEntry<RTW.TflCFunctionEntryML
    methods
        function obj=Ifx_IntFixICurCustomEntry(varargin)
            mlock;
        ...
        function ent=do_match(hThis,...
            ...
            if(isequivalent(hCSO.ConceptualArgs(2).Type,hCSO.ConceptualArgs(3).Type)&&...
                ...
                isequal(hCSO.ConceptualArgs(3).Type.Slope,hCSO.ConceptualArgs(4).Type.Slope))
