function hEnt=Ifx_addIntFixCurConceptualArguments(hEnt,datatype_y1,datatype_u,datatype_bp0,datatype_bpS,datatype_T)
    ...
    arg=hEnt.getTflArgFromString('u3',datatype_bpS{1});
