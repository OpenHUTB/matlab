function in = setExternalOutputsFcn( in, callback )
...
in.ExperimentalProperties.RapidAccelExternalOutputsFcn = callback;

end 

% Decoded using De-pcode utility v1.2 from file /tmp/tmpMjgE5n.p.
