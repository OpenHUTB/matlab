function callback = getExternalInputsFcn( in )
...
callback = in.ExperimentalProperties.RapidAccelExternalInputsFcn;

end 



% Decoded using De-pcode utility v1.2 from file /tmp/tmp1j4SsU.p.
