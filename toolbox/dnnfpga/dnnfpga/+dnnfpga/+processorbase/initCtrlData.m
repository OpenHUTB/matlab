...
function[resultSize,resultSizeDivByOpW,imgSizeDivByOpW,xy0,rxy0,wAddr0,dw,dr,dz,rzLimitOriginal]=initCtrlData(padding,stride,stridePhase,dilation,imgSize,origOpSizeValue,wSizeLimit,opW)
    ...
    assert(all(paddedImgSize>=dilatedOpSize));
    resultSize=ceil((paddedImgSize-dilatedOpSize+1-stridePhase)./stride);
