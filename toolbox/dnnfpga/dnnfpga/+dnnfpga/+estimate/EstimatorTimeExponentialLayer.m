classdef EstimatorTimeExponentialLayer<dnnfpga.estimate.EstimatorTransfer

    methods


        function ExponentialLayerTime=GetLayerTime(this,hPC,cnnp,param,HWparams,InternalArchParam,layerIndex,NumofFcLayers,calData)
            ...
            LayerCompute=this.GetExponentialLayerCompTime(hPC,param,cnnp,calData);
            LayerOpt=this.getLayerOpt(LayerInfo,HWparams);
            ExponentialLayerTime.layer=this.AssembleLayerResult(LayerOpt,LayerCompute,LayerInBurst,LayerOutBurst,InternalArchParam);

        end

        function ExponentialLayerCompTime=GetExponentialLayerCompTime(this,hPC,param,cnnp,calData)
            ...
            CompletePathLatency=cc.InputOutputLatency+cc.DataMemReadLatency+cc.SingleProdLatency+cc.ExpLatency+...
            ...
            ExponentialLayerCompTime=(LayerConfigTime+TotalPathLatency);
