function[debug_enable,debug_select,image_valid,image_addr,debug_rdaddr,debug_dma_enable,debug_dma_len,debug_dma_width,debug_dma_offset,debug_dma_direction,debug_dma_start,stateOut,done]=dnnfpgaInputcontrollerInput_controller(inputStart,image_length,debug_dma_offset_in,debug_dma_width_in,dma_done_in,DEBUG_ADDR_WIDTH,DEBUG_ID_ADDRW,DEBUG_BANK_ADDRW)
%#codegen
    ...
    debug_select_id=fi(0,0,DEBUG_ID_ADDRW,0);
