...
ColorControlPoints
    ...
    methods
        ...
        function obj=VolumeConfiguration(settingName)
            ...
            case{'default','gray',getString(message('images:volumeViewer:linear'))}
            ...
            case getString(message('images:volumeViewer:ctbone'))
            ...
            case getString(message('images:volumeViewer:ctsoft_tissue'))
            ...
            case getString(message('images:volumeViewer:ctlung'))
            ...
            case getString(message('images:volumeViewer:ctcoronary'))
            ...
            case getString(message('images:volumeViewer:mri'))
            ...
            case getString(message('images:volumeViewer:ctmip'))
            ...
            case getString(message('images:volumeViewer:mrimip'))
