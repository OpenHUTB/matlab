classdef Harris<images.internal.app.registration.model.FeatureProperty
...
filterSize
    ...
    methods
        ...
        function[fixedPoints,movingPoints]=detectFeatures(self,fixed,moving)
            ...
            'harris',fixed,'MinQuality',self.minQuality,...
            'FilterSize',self.filterSize);
            movingPoints=images.internal.app.registration.model.harrismineigen(...
            'harris',moving,'MinQuality',self.minQuality,...
            'FilterSize',self.filterSize);
        end
