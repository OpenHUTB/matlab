function TF=checkOpenGLDrivers
    ...
    if windowsSoftwareOpenGL
        error(message('images:volumeViewerToolgroup:windowsSoftwareOpenGL','"opengl hardware"','"doc opengl"'));
    end

    if badVideoDriver
        warning(message('images:volumeViewerToolgroup:badGraphicsDriver','''VolumeViewerUseHardware''','false'));
        s=settings;
