classdef DistributedFixedPathLabelDataDiffGUIProvider<comparisons.internal.DiffGUIProvider
    ...
    methods
        ...
        function bool=canHandle(obj,first,second,options)
            ...
            &&isDistributedFixedPathLabelData(first.Path)...
            &&isDistributedFixedPathLabelData(second.Path);
        end
...
function bool=isDistributedFixedPathLabelData(file)
