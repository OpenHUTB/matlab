function activateSidePanelContext(divFigure,panelId,title,region,parentFigure,parentNodeId)

%    This function publishes a message to client (SidePanelManager.js) to
%    activate figure tools's context so it shows up in the figure's uicontainer. 
...
channel = "/figure/sidePanel/activateContext";
