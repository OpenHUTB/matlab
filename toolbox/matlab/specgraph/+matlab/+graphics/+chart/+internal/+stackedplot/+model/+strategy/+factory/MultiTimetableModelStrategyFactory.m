classdef MultiTimetableModelStrategyFactory<matlab.graphics.chart.internal.stackedplot.model.strategy.factory.ModelStrategyFactory
    ...
    methods
        ...
        function s=createAxesXDataStrategy(~)
            s=matlab.graphics.chart.internal.stackedplot.model.strategy.axesxdata.MultiTimetableAxesXDataStrategy();
        end
        ...
        function s=createXLabelStrategy(~)
            s=matlab.graphics.chart.internal.stackedplot.model.strategy.xlabel.MultiTimetableXLabelStrategy();
        end

        function s=createXLimitsStrategy(~)
            s=matlab.graphics.chart.internal.stackedplot.model.strategy.xlimits.MultiTimetableXLimitsStrategy();
        end
        ...
        function s=createPropertyGroupsStrategy(~)
            s=matlab.graphics.chart.internal.stackedplot.model.strategy.propertygroups.MultiTimetablePropertyGroupsStrategy();
        end
