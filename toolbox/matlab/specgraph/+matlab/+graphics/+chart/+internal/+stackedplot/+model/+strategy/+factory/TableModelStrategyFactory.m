classdef TableModelStrategyFactory<matlab.graphics.chart.internal.stackedplot.model.strategy.factory.ModelStrategyFactory
    ...
    methods
        ...
        function s=createAxesXDataStrategy(~)
            s=matlab.graphics.chart.internal.stackedplot.model.strategy.axesxdata.TableAxesXDataStrategy();
        end
        ...
        function s=createXLabelStrategy(~)
            s=matlab.graphics.chart.internal.stackedplot.model.strategy.xlabel.TableXLabelStrategy();
        end

        function s=createXLimitsStrategy(~)
            s=matlab.graphics.chart.internal.stackedplot.model.strategy.xlimits.TableXLimitsStrategy();
        end
        ...
        function s=createPropertyGroupsStrategy(~)
            s=matlab.graphics.chart.internal.stackedplot.model.strategy.propertygroups.TablePropertyGroupsStrategy();
        end
        ...
        function s=createXVariableValidationStrategy(~)
            s=matlab.graphics.chart.internal.stackedplot.model.strategy.xvariablevalidation.TableXVariableValidationStrategy();
        end
