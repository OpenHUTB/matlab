function elementSchema=f6port_noise_rf(~)
...
function schema=schema
    ...
    schema=NetworkEngine.ElementSchemaBuilder('f6port_noise_rf');
    schema.descriptor='F6PORT_NOISE_RF';
