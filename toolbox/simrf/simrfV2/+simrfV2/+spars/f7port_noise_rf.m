function elementSchema=f7port_noise_rf(~)
...
function schema=schema
    ...
    schema=NetworkEngine.ElementSchemaBuilder('f7port_noise_rf');
    schema.descriptor='F7PORT_NOISE_RF';
