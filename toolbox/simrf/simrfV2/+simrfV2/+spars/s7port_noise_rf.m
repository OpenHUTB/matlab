function elementSchema=s7port_noise_rf(~)
...
function schema=schema
    ...
    schema=NetworkEngine.ElementSchemaBuilder('s7port_noise_rf');
    schema.descriptor='S7PORT_NOISE_RF';
    ...
    Z0.type=ne_type('real',[1,7],'Ohm');
    Z0.default={ones(1,7)*50,'Ohm'};
    ...
    D.type=ne_type('real',[1,49],'1');
    D.default={zeros(1,49),'1'};
