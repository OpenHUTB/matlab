function dlgStruct=getDialogSchema(this,~)
    ...
    addCSfilters=simrfV2GetLeafWidgetBase('checkbox',...
    'Add Channel Select filters','AddCSFilters',this,'AddCSFilters');
    addCSfilters.RowSpan=[rs_filt,rs_filt];
    addCSfilters.ColSpan=[floor(number_grid/2)+1,number_grid];
    addCSfilters.DialogRefresh=1;
    ...
    filters.Items={addIRfilter,addCSfilters};
    ...
    [impItems,impLayout,slBlkVis]=simrfV2create_iqdemodimp_pane(this,...
    ...
    slBlkVis,idxMaskNames,'CS',this.AddCSFilters);
