function[items,layout,slBlkVis]=simrfV2create_rfdemodimp_pane(this,...
    ...
    'LO to In isolation:','isolationprompt',0);
    ...
    items={isolationprompt,isolation,isolation_unit,NF,NFprompt,...
    addphasenoise,phasenoiseoffsetprompt,phasenoiseoffset,...
    phasenoiselevelprompt,phasenoiselevel,autoimp,imprespprompt,...
    impresp,imprespunit,plotbutton};
