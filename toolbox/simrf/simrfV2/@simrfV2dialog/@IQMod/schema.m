function schema
    ...
    this=schema.class(rfPackage,'IQMod',parent);
    ...
    schema.prop(this,'GainMismatch','string');
    schema.prop(this,'GainMismatch_unit','SimRFV2PowerGainUnit');
    schema.prop(this,'PhaseMismatch','string');
    schema.prop(this,'PhaseMismatch_unit','SimRFV2PhaseUnitType');
    schema.prop(this,'Isolation','string');
    schema.prop(this,'Isolation_unit','SimRFV2PowerGainUnit');
    schema.prop(this,'NFloor','string');
    ...
    schema.prop(this,'AddIRFilters','bool');
