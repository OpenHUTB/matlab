function dlgStruct=getDialogSchema(this,~)
    ...
    rs_filt=1;
    addIRfilters=simrfV2GetLeafWidgetBase('checkbox',...
    'Add Image Reject filters','AddIRFilters',this,'AddIRFilters');
    addIRfilters.RowSpan=[rs_filt,rs_filt];
    addIRfilters.ColSpan=[lprompt,floor(number_grid/2)];
    addIRfilters.DialogRefresh=1;
    ...
    filters.Items={addIRfilters,addCSfilter};
    ...
    slBlkVis([idxMaskNames.Zin,idxMaskNames.Zout,idxMaskNames.NFloor])={'on'};
    ...
    [impItems,impLayout,slBlkVis]=simrfV2create_iqmodimp_pane(this,...
    ...
    slBlkVis,idxMaskNames,'IR',this.AddIRFilters);
