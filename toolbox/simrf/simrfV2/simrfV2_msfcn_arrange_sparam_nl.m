function simrfV2_msfcn_arrange_sparam_nl(block)
                                    ...
                                    function Output(block)
                                        ...
                                        if block.InputPort(1).IsSampleHit
                                            if block.Dwork(1).Data==0
                                                SParamElem2Len=length(block.DialogPrm(3).Data)-1;
                                                SParamElem1Selncol=size(block.DialogPrm(1).Data,2);
                                                ...
                                                mat_zero_excitation=reshape(block.Dwork(2).Data,[],...
                                                SParamElem1Selncol);
                                                for jInd=3:block.NumDworks
                                                    mat(:,(1:SParamElem1Selncol)+(jInd-3)*SParamElem1Selncol)=...
