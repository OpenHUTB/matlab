function simRFV2GTTestbenchCallbackFcn(block,action)
    ...
    case 'simrfInit'
        ...
        MaskDisplay=sprintf('port_label(''output'',1,''Gain (dB)'');');
        ...
        if regexpi(get_param(top_sys,'SimulationStatus'),...
            ...
            if(uncheckedIntConf)
                ...
                if isempty(simrfV2_find_repblk(block,'Configuration'))
                    ...
                    stepSize=(1/MaskWSValues.Base_bw)/MaskWSValues.OS;
                    set_param([block,'/Configuration'],'StepSize',...
                    num2str(stepSize));
                    uncheckedNoise=...
    ...
    otherwise
        ...
        ,'Test (DUT) and differ from the expected gain obtained from RF '...
        ...
        ,'gain and that obtained from RF budget calculations may '...
