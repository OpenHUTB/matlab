function simRFV2IP3TestbenchCallbackFcn(block,action)
    ...
    otherwise
        ...
        ,'Device Under Test (DUT) and differ from the expected IP3 '...
        ,'obtained from RF budget calculations. In this case, '...
        ,'use the knob to reduce the input power amplitude value '...
        ,'until the resulting IP3 value settles down.\n\n'];
        string_out{4}=['4. Other discrepancies between the '...
        ,'measured and expected IP3 values may originate from the '...
        ,'more realistic account of the DUT performance obtained '...
        ,'using the RF Blockset simulation. In this case, verify that'...
        ,'the DUT performance is evaluated correctly using RF '...
