...
classdef(Sealed)IfThen<sltest.assessments.Binary
    properties(SetAccess=immutable,Hidden)
isDiscreteTrigger
    end
    methods
        function self=IfThen(left,right,isDiscreteTrigger)
    ...
    methods(Access=protected,Hidden)
        function internal=constructInternal(self)
            ...
            internal=alias(self.left.internal.implies(self.right.internal),ifkeyword,' ',self.left.internal,' then, ',self.right.internal);
        end
    end
end
