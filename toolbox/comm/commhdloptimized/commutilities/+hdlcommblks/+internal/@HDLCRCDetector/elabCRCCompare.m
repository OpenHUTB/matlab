function cmpNet=elabCRCCompare(~,topNet,blockInfo,inRate)
    ...
    'OutportNames',{'dataOut','startOut','endOut','validOut','err','csumbufferenb'},...
    'OutportTypes',[dataType,ufix1Type,ufix1Type,ufix1Type,ufix1Type,ufix1Type]...
    );
    ...
    csumbufferenb=cmpNet.PirOutputSignals(6);
    ...
    if(ratio==1)
        ...
        pirelab.getWireComp(cmpNet,endin,csumbufferenb);
    else
        ...
        pirelab.getWireComp(cmpNet,cnt2enb,csumbufferenb);
        ...
        delayComp=pirelab.getIntDelayEnabledComp(cmpNet,dataref,checksumreg,bufferenb,...
        ratio,'',0,0);
