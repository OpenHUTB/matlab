classdef BCHEncoder<matlab.system.SFunSystem
...
%#function mcombchrsencoder
    ...
    methods
        function obj=BCHEncoder(varargin)
            ...
            if(nargin>=3)&&...
                ~comm.internal.utilities.isCharOrStringScalar(varargin{1})&&...
                ~comm.internal.utilities.isCharOrStringScalar(varargin{2})&&...
                ~(comm.internal.utilities.isCharOrStringScalar(varargin(3))&&...
                ismember(varargin(3),obj.getDisplayPropertiesImpl))
...
1...
                ...
                if eStr.ecode
                    ...
                    coder.internal.errorIf(true,['comm:system:BCHRS:',eStr.eID(colons(end)+1:end)]);
                end
