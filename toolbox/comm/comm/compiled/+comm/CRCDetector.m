classdef CRCDetector<matlab.system.SFunSystem
...
CheckSumsPerFrame
    ...
    methods
        function obj=CRCDetector(varargin)
            ...
            obj@matlab.system.SFunSystem('mcomcrcsynddetect');
    ...
    methods(Static,Hidden)
        function a=getAlternateBlock
            a='commcrc2/General CRC Syndrome Detector';
        end
