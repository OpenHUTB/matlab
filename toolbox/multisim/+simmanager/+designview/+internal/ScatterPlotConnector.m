...
classdef ScatterPlotConnector<simmanager.designview.internal.FigureObjectConnector
    methods(Access=?simmanager.designview.ScatterPlot)
        function obj=ScatterPlotConnector(scatterPlot)
