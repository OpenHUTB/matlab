classdef StringForNearestEvenPow2SpacingPrelookupFunction<FunctionApproximation.internal.prelookupfunction.StringForPrelookupFunction
    ...
    methods(Static)
        function prelookupString=getPrelookupString(inputNumber)
            ...
            'if (index(',num2str(inputNumber),') < length(breakpointValues',num2str(inputNumber),')) && (accumneg(breakpointValues',num2str(inputNumber),'(index(',num2str(inputNumber),')+1),inputValues',num2str(inputNumber),...
