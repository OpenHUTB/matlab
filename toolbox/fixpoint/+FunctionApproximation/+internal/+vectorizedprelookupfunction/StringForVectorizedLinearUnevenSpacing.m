classdef StringForVectorizedLinearUnevenSpacing<FunctionApproximation.internal.prelookupfunction.StringForPrelookupFunction
    ...
    methods(Static)
        function prelookupString=getPrelookupString(inputNumber)
            ...
            ',breakpointValues',num2str(inputNumber),',idxType,fracType);',newline];
        end
    end
end
