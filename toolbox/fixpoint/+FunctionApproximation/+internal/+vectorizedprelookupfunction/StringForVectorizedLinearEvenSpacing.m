classdef StringForVectorizedLinearEvenSpacing<FunctionApproximation.internal.prelookupfunction.StringForPrelookupFunction
    ...
    methods(Static)
        function prelookupString=getPrelookupString(inputNumber)
            ...
            ',breakpointValues',num2str(inputNumber),',idxType,fracType,bpSpaceReciprocal',num2str(inputNumber),');',newline];
        end
    end
end
