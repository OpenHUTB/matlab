classdef NDLogicStringForOutputUnsignedFixed<handle
    ...
    methods(Static)
        function string=getInterpolationLogicString()
            ...
            'else',newline,...
            'if tableValues(bpIdx1+1) >= tableValues(bpIdx1)',newline,...
            ...
            'tmp = cast(tableValues(bpIdx1),''like'',tableValuesDelta);',newline,...
            'tableValuesDelta(1) = tableValues(bpIdx1 + 1);',newline,...
            'intermediateValue(1) = tmp - (frac(1) * (tmp - tableValuesDelta(1)));',newline,...
            'end',newline,...
            'end',newline,newline];
            ...
            'else',newline,...
            'if tableValues(bpIdx2+1) >= tableValues(bpIdx2)',newline,...
            ...
            'tmp = cast(tableValues(bpIdx2),''like'',tableValuesDelta);',newline,...
            'tableValuesDelta(2) = tableValues(bpIdx2 + 1);',newline,...
            'intermediateValue(2) = tmp - (frac(1) * (tmp - tableValuesDelta(2)));',newline,...
            'end',newline,...
            'end',newline,...
            ...
            'tmp = cast(tableValues(bpIdx2),''like'',tableValuesDelta);',newline,...
            'tableValuesDelta(k+1) = tableValues(bpIdx2 + 1);',newline,...
            'intermediateValue(k+1) = tmp - (frac(1) * (tmp - tableValuesDelta(k+1)));',newline,...
            'end',newline,...
            'end',newline,...
