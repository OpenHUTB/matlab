classdef MagnitudeAndPhase<phased.apps.internal.WaveformViewer.PlotData
...
Layout
    ...
    methods
        function self=MagnitudeAndPhase(parent)
            self.View=parent;
            self.Figure=self.View.MagnitudeAndPhaseFig;
        ...
        function magnitudePhasePlot(self,data)
            ...
            plot(self.TopAxes,l,abs(self.Wav));
            phased.apps.internal.WaveformViewer.SetLimits(abs(self.Wav),self.TopAxes)
            ...
            plot(self.BottomAxes,l,angle(self.Wav));
            phased.apps.internal.WaveformViewer.SetLimits(angle(self.Wav),self.BottomAxes)
            ...
            if k>1&&data.Index==ind(1)
                ...
                legend(self.BottomAxes,self.View.Canvas.WaveformList.Data{data.Index});
            end
            if strcmp(de_units,'u')
                de_units='\mu';
            end
        ...
        function genCode(self,strWriter)
            ...
            ,'subplot(2,1,2);',newline,'plot(l,angle(x));'...
