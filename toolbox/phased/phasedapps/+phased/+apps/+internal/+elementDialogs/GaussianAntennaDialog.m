classdef(Hidden,Sealed)GaussianAntennaDialog<handle
...
Layout
    ...
    methods
        function obj=GaussianAntennaDialog(parent)
    ...
    methods
        ...
        function updateElementObject(obj)
            ...
            obj.Parent.App.CurrentElement=phased.GaussianAntennaElement(...
            'FrequencyRange',Freq,'Beamwidth',[obj.AzBeamwidth,obj.ElBeamwidth]);
        end

        function gencode(obj,sw)
            addcr(sw,'% Create an gaussian antenna element');
            addcr(sw,'Elem = phased.GaussianAntennaElement;')
            if isscalar(obj.SignalFreq)
                Freq=[0,obj.SignalFreq];
            else
                Freq=[min(obj.SignalFreq)...
        ...
        function genreport(obj,sw)
            addcr(sw,'% Element Type ......................................... Gaussian Antenna Element')
    ...
    methods(Access=private)
        function createUIControls(obj)
            if~isUIFigure(obj.Parent)
                ...
                getString(message('phased:apps:arrayapp:Gaussian'))]);
            else
        ...
        function parameterChanged(obj,e)
            ...
            case 'AzBeamwidthEdit'
                try
                    ...
                    {'nonempty','nonnan','finite','row','real','scalar',...
