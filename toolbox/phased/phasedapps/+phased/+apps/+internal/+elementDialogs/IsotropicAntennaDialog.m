classdef(Hidden,Sealed)IsotropicAntennaDialog<handle
...
Layout
    ...
    methods
        function obj=IsotropicAntennaDialog(parent)
    ...
    methods
        ...
        function updateElementObject(obj)
            ...
            obj.Parent.App.CurrentElement=phased.IsotropicAntennaElement(...
            'BackBaffled',obj.BackBaffled,...
            'FrequencyRange',Freq);
        end

        function gencode(obj,sw)
            addcr(sw,'% Create an isotropic antenna element');
            addcr(sw,'Elem = phased.IsotropicAntennaElement;')
            if obj.BackBaffled
        ...
        function genreport(obj,sw)
            addcr(sw,'% Element Type ......................................... Isotropic Antenna Element')
    ...
    methods(Access=private)
        function createUIControls(obj)
            if~isUIFigure(obj.Parent)
                ...
                getString(message('phased:apps:arrayapp:Isotropic'))]);
            else
            ...
            getString(message('phased:apps:arrayapp:BackBaffled')),...
            getString(message('phased:apps:arrayapp:BackBaffledTT')),...
