function[dl1,bt1,dl,bt,msb]=decsg_atx(gd,sf,ns)
    ...
    while bf1
        ...
        edges=lsn+csn+esn;
        em=sparse(edges,edges);
        cm=sparse(2*edges,2*edges);
        ...
        if bf2
            ...
            if edges*edges~=sum(sum(sign(em)))
    ...
    if~bf2
        [dl1,bt1]=csgdel_atx(dl,bt,find(~lsh));
