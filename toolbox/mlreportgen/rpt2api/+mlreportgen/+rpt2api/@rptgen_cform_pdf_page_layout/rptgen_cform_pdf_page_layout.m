classdef rptgen_cform_pdf_page_layout<mlreportgen.rpt2api.rptgen_cform_page_layout
    ...
    methods
        ...
        function this=rptgen_cform_pdf_page_layout(component,rptFileConverter)
    ...
    methods(Access=protected)
        ...
        function counter=getVariableNameCounter(this)
            ...
            if isempty(this.VariableNameCounter)
                ...
                mlreportgen.rpt2api.rptgen_cform_pdf_page_layout.getCurrentCounter();
            end
    ...
    methods(Static)
        ...
        function template=getTemplate(templateName)
            import mlreportgen.rpt2api.rptgen_cform_pdf_page_layout
            templateFolder=fullfile(rptgen_cform_pdf_page_layout.getClassFolder,...
            'templates');
