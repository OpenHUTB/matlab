classdef m2m_CommonSourceInterpolation<slEnginePir.model2model&handle
    ...
    methods(Access='public')
        function m2mObj=m2m_CommonSourceInterpolation(aOriSys)
            pirObj=pir;
            pirObj.destroyPirCtx(aOriSys);
            ...
            m2mObj.fXformObj=Simulink.SLPIR.M2MCommonSourceInterpolationXform();
        end
