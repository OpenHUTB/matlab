classdef PointCloudDisplay<vision.internal.labeler.tool.display.Display&matlab.mixin.SetGet
...
ProjectedViewStatus
    ...
    methods
        ...
        function initializePixelLabeler(~)
    ...
    methods
        ...
        function TF=isOneROIInstanceSelectedOfDefFamily(this,sublabelItemData)
            ...
            TF=false;
            N=getNumROIInstanceSelected(this);
            if N==1
                Ns=this.CuboidLabeler.getNumSelectedROIsOfDefFamily(sublabelItemData);
                TF=(Ns==1);
            end
        end
...
...
    ...
    methods(Access=protected)
        ...
        function updateCLim(this,X,Y,Z,updateLimits)
            ...
            if this.ColorByClusterInternal&&~isempty(this.ImageHandle.ClusterData)
            ...
            elseif isa(evt.HitObject,'matlab.ui.container.Panel')&&any(strcmp(evt.HitObject.Tag,{'RightFlagPanel','LeftFlagPanel','ScrubberPanel'}))
                ...
                if this.WasImageLastHitObject||this.WasScrubberLastHitObject
                    ...
                    if~any(strcmp(class(evt.HitObject.Parent),...
                        {'images.roi.Cuboid','images.roi.Rectangle',...
                        'vision.roi.ProjectedCuboid',...
                        'images.roi.Polygon','images.roi.Polyline'}))
    ...
    methods(Static)
        ...
        function axisLim=getLimits(currentMaxMinLim,currentDataLim)
            ...
            axisLim=currentMaxMinLim;
            if(currentMaxMinLim(1)>currentDataLim(1))

                axisLim(1)=currentDataLim(1);
            end

            if(currentMaxMinLim(2)<currentDataLim(2))

                axisLim(2)=currentDataLim(2);
            end
        end
    ...
    methods
        ...
        function disableProjectedView(this)
            if isvalid(this.ProjectedViewDisplay)
                disableProjectedView(this.ProjectedViewDisplay);
            end
        end
