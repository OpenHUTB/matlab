classdef FrameAnnotationStructManager < vision.internal.labeler.annotation.AnnotationStructManager
...
% Decoded using De-pcode utility v1.2 from file /tmp/tmpMGEaoF.p.
