    ...
    methods(Access=protected)
        function createMultisignalLayout(this)
            if~this.IsVideoLabeler
                ...
                signalCol=this.addColumn('HorizontalAlignment','left');
                signalCol.add(this.SignalListDropDownButton);
                signalCol.add(this.ShowLabelsText);
                signalCol.add(this.ShowLabelsDropDown);
            else
                layoutCol=this.addColumn();
                layoutCol.add(this.LayoutButton);
        ...
        function organizeLayout(this)
            ...
            if~isempty(this.SavedLayouts)
                dlg=vision.internal.videoLabeler.tool.OrganizeLayoutDlg(this.GroupName,this.SavedLayouts);
                wait(dlg);
