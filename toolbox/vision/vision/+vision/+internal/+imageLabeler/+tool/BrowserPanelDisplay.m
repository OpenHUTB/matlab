...
classdef BrowserPanelDisplay<vision.internal.uitools.AppFig
...
SignalNavigationContainerObj
    ...
    methods
        ...
        function this=BrowserPanelDisplay(hFig)

            nameDisplayedInTab='BrowserPanelDisplay';

            this=this@vision.internal.uitools.AppFig(hFig,nameDisplayedInTab,true);
            this.Fig.Resize='on';
            this.Fig.Tag='BrowserPanelDisplay';
    ...
    methods(Access=protected)
        ...
        function initialize(this)
            ...
            this.SignalNavigationContainerObj=vision.internal.imageLabeler.tool.SignalNavigationContainer(this.Fig);
        end
    end
end
