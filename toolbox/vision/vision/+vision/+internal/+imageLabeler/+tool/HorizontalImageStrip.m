...
classdef HorizontalImageStrip<images.internal.app.imageBrowser.Thumbnails
...
OverviewBlockedImageGenerated
    ...
    methods
        function this=HorizontalImageStrip(hParent,IsDataBlockedImage)

            thumbNailSize=[72,72];
            this@images.internal.app.imageBrowser.Thumbnails(hParent,thumbNailSize);
        ...
        function appendImage(this,imageData)
            ...
            if this.IsDataBlockedImage
                if isa(imageData(1),'blockedImage')
                    ...
                    this.createAndCacheBlockedImages(imageFilenames,appendData)
                end
            else
    ...
    methods(Access=private)
        function createAndCacheBlockedImages(this,filenames,appendData)
