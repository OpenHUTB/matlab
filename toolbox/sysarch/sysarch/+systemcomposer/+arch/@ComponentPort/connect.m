function cn=connect(this,otherPort,varargin)
    ...
    elseif(this.Direction==systemcomposer.arch.PortDirection.Server||...
        this.Direction==systemcomposer.arch.PortDirection.Client)

        throwError=this.Direction~=systemcomposer.arch.PortDirection.Server||...
        (~otherIsArchPort&&otherPortDir~=systemcomposer.arch.PortDirection.Client)||...
        (otherIsArchPort&&otherPortDir~=systemcomposer.arch.PortDirection.Server);

    elseif this.Direction~=systemcomposer.arch.PortDirection.Output||...
