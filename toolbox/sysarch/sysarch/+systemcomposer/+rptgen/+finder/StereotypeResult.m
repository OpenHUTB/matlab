classdef StereotypeResult<mlreportgen.finder.Result
...
Tag
    ...
    methods(Access={?mlreportgen.report.ReportForm,?systemcomposer.rptgen.finder.StereotypeFinder})
        function this=StereotypeResult(f)
    ...
    methods
        function reporter=getReporter(this)
            ...
            if isempty(this.Reporter)
                reporter=systemcomposer.rptgen.report.Stereotype("Source",this);
