classdef FunctionArgumentWrapper
    ...
    methods
        function obj=FunctionArgumentWrapper(elemUUID,mf0Model)


            obj.argUUID=elemUUID;
            ...
            element=obj.element.p_FunctionElement;
            obj.interface=element.getInterface();
