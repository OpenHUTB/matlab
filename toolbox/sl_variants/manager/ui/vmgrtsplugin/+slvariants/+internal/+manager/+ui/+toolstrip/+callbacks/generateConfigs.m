function generateConfigs(cbinfo)
    ...
    migDiagStageName=getString(message('Simulink:VariantManagerUI:GenerateConfigsDiagStage'));
    ...
    autoGenBroker.generateConfigs(modelH);
