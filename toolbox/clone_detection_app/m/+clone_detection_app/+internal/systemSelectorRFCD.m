...
function systemSelectorRFCD(userdata,cbinfo,action)
    ...
    [~,name,path,selected,state,message]=clone_detection_app.internal.getSystemSelectorInfoCD(userdata,cbinfo,action);
