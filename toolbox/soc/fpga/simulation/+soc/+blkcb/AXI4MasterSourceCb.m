function varargout=AXI4MasterSourceCb(varargin)
...
function MaskInitFcn(blkH,~)%#ok<*DEFNU>
    ...
    try
        ...
        Simulink.suppressDiagnostic([blkPath,'/A4M Source BFM'],'Stateflow:Runtime:DataOverflowErrorMSLD');

        SetMaskDisplay(blkH);
        soc.internal.setBlockIcon(blkH,'socicons.AXIMasterSource');
