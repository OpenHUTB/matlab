classdef MIGArty<soc.xilcomp.MIGBase
    properties
    end

    methods
        function obj=MIGArty(varargin)
            ...
            'proc write_mig_file_design_3_mig_7series_0_0 { str_mig_prj_filepath } {\n',...
            '\n',...
            ...
            '   close $mig_prj_file\n',...
            '}\n',...
            '# End of write_mig_file_design_3_mig_7series_0_0()\n',...
            '\n',...
            ...
            '\n',...
            '  write_mig_file_design_3_mig_7series_0_0 $str_mig_file_path\n',...
            '\n',...
            ...
            ' ] $mig_7series_0\n',...
            '\n',...
            '  # Create instance: mig_clk_wiz, and set properties\n',...
            '  set mig_clk_wiz [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 mig_clk_wiz ]\n',...
            '  set_property -dict [ list \\\n',...
            ...
            '  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins mig_7series_0/clk_ref_i] [get_bd_pins mig_clk_wiz/clk_out1]\n',...
            '  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins mig_clk_wiz/clk_out2]\n',...
