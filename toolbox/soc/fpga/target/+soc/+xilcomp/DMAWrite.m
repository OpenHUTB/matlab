...
classdef DMAWrite<soc.xilcomp.XilinxComponentBase
    properties
burst_size
fifo_depth
    end
    ...
    methods
        function obj=DMAWrite(varargin)
            ...
            obj.addClk('dma_s2mm/s_axi_aclk','SystemClk');
            obj.addRst('dma_s2mm/s_axi_aresetn','SystemRstn');
            obj.addAXI4Slave('dma_s2mm/s_axi','reg','sys',obj.Configuration.dev_addr,obj.Configuration.dev_range);


            obj.addClk('dma_s2mm/m_dest_axi_aclk',obj.type2ClkName(obj.Configuration.mem_type));
            obj.addRst('dma_s2mm/m_dest_axi_aresetn',obj.type2RstnName(obj.Configuration.mem_type));
            obj.addAXI4Master('dma_s2mm/m_dest_axi',obj.Configuration.mem_type,obj.Configuration.mem_type);


            obj.addClk('dma_s2mm/s_axis_aclk','IPCoreClk');


            obj.addInterrupt('dma_s2mm/irq');




            obj.Instance=[...
            'set dma_s2mm [create_bd_cell -type ip -vlnv analog.com:user:axi_dmac:1.0 dma_s2mm]\n',...
