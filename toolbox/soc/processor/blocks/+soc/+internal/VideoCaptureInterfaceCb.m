function varargout = VideoCaptureInterfaceCb( func, blkH, varargin )
...
soc.internal.setBlockIcon( blkH, 'socicons.VideoCaptureInterface' );
catch ME
hadError = true;
rethrow( ME );
end 
...
helpcmd = 'eval(''soc.internal.helpview(''''soc_videocaptureinterface'''')'')';
...
% Decoded using De-pcode utility v1.2 from file /tmp/tmpr5bqQZ.p.
