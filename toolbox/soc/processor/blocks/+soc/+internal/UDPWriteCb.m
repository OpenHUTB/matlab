function varargout = UDPWriteCb( func, blkH, varargin )
if nargout == 0
...
soc.internal.setBlockIcon( blkH, 'socicons.UDPWrite' );
catch ME
hadError = true;
rethrow( ME );
end 
...
helpcmd = 'eval(''soc.internal.helpview(''''soc_udpwrite'''')'')';
set_param( blkH, 'MaskHelp', helpcmd );
end 

% Decoded using De-pcode utility v1.2 from file /tmp/tmp5dkLGJ.p.
