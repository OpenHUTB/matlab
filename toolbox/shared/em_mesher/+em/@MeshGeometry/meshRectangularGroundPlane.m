function[pGP,tGP]=meshRectangularGroundPlane(obj,varargin)
    ...
    if~isempty(feed)
        ...
        rectGP=antenna.Rectangle('Length',gp_L,'Width',gp_W,'Center',[translate_x,translate_y]);
        [~]=mesh(rectGP,'MaxEdgeLength',edgeLength,'GrowthRate',growthRate,...
        'MinEdgeLength',0.01*edgeLength);
        [pGP,tGP]=exportMesh(rectGP);
        offset=0;
