function dlgStruct=dlgSectionOptions(this,varargin)
    ...
    if(this.HierarchicalSectionNumbering&&~strcmpi(this.SortBy,'none'))
        this.ErrorMessage=getString(message('RptgenSL:rsf_csf_slfunc_sys_loop:numberSystemsByHierarchyError'));
    else
        this.ErrorMessage='';
    end
...
wObjectAnchor
    },getString(message('RptgenSL:rsf_csf_slfunc_sys_loop:sectionOptionsLabel')),...
    'LayoutGrid',[4,1],...
    varargin{:});
