function dlgStruct=loop_getDialogSchema(this,~)
    ...
    wInclSLFunc=this.dlgWidget('IncludeSLFunctions',...
    'RowSpan',[3,3],...
    'ColSpan',[1,1]);
...
wLoopType
    ...
    'ColSpan',[1,1])
wInclSLFunc
    },getString(message('RptgenSL:rsl_csl_sys_loop:reportOnLabel')),...
    'LayoutGrid',[4,1],...
...
wSortBy
wFilterTable
    },getString(message('RptgenSL:rsl_csl_sys_loop:loopOptionsLabel')),...
    'LayoutGrid',[2,1],...
    'RowStretch',[0,1]);
