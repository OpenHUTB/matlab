...
classdef Arria10SGMII<eda.internal.boardmanager.EthInterface
    ...
    properties(Constant)
        Name='Gigabit Ethernet - Arria 10 SGMII';
        Communication_Channel='Arria10SGMII';
        isGigaEthInterface=true;
    end

    methods
        function defineInterface(obj)
            obj.addSignalDefinition('ETH_GTREFCLK_P','125MHz reference clock','in',1);
            obj.addSignalDefinition('ETH_GTREFCLK_N','125MHz reference clock','in',1);
