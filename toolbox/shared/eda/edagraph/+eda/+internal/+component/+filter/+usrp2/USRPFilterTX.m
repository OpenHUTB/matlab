...
classdef(ConstructOnLoad=true)USRPFilterTX<eda.internal.component.BlackBox
...
ce_out
    ...
    methods
        function this=USRPFilterTX(varargin)
            ...
            this.filter_in_re=eda.internal.component.Inport('FiType','sfix18');
            this.filter_in_im=eda.internal.component.Inport('FiType','sfix18');
