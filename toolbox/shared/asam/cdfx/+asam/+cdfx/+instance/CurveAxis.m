classdef CurveAxis<asam.cdfx.instance.Instance
...
ReferencingAxisIndices
    ...
    methods
        function obj=CurveAxis(root,sys,inst)
        ...
        function setValue(obj,value,isInternalModify)
            ...
            for idx=1:numel(obj.ReferencingInstances)
                ...
                instanceValue.(axisPropertyName).PhysicalValue=value.PhysicalValue;
                instanceValue.(axisPropertyName).Axis1=value.Axis1;
