function[varargout]=sim3dblksultrasonicsensor(varargin)
...
function Initialization(block)
    ...
    set_param([block,'/Simulation 3D Range Sensor'],'VehicleIdentifier',vehTag.Value);

    ParamList={'SampleTime',[1,1],{'st',0};...
    'detectionRanges',[1,3],{'gt',0};};

    ConfigureOutputPorts(block);
    checkSensorParameters(block);
    SetMountLocation(block,"Simulation 3D Range Sensor");
