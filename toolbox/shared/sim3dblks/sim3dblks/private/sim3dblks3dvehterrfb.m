...
function ParamStruct=Initialization(Block)
    ...
    'HighBeamConeAngle',[1,1],{'gt',0;'lte',90};...
    'LowBeamConeAngle',[1,1],{'gt',0;'lte',90};...
    'LeftHeadlightOrientation',[1,2],{'gte',-180;'lte',180};...
    'RightHeadlightOrientation',[1,2],{'gte',-180;'lte',180};...
