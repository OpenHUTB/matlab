function[varargout]=sim3dblks3dbic(varargin)
...
function IconInfo=DrawCommands(Block)
    ...
    IconInfo.ImageName='sim3dbicycle.png';
    [~,IconInfo.position]=iconImageUpdate(IconInfo.ImageName);
    IconInfo.position=IconInfo.position+[20,0,0,0];
    IconInfo.image='sim3dbicycle.svg';
end
