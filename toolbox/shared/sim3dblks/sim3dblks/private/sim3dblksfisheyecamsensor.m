function[varargout]=sim3dblksfisheyecamsensor(varargin)
    ...
    case 'MountOffsetToggle'
        sim3dFisheyeCameraMountOffsetToggle(Block);
    case 'SetSensorName'
        SetSensorName(Block);
...
function Initialization(Block)
    ...
    set_param([Block,'/Simulation 3D Fisheye Camera'],'VehicleIdentifier',vehTag.Value);
