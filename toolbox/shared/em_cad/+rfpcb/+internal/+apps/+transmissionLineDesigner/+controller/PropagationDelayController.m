classdef PropagationDelayController < rfpcb.internal.apps.transmissionLineDesigner.controller.Controller
...
methods 
function obj = PropagationDelayController( Model, App )
...
log( obj.Model.Logger, '% PropagationDelayController is created.' )
end 
end 
end 


% Decoded using De-pcode utility v1.2 from file /tmp/tmpfUwADc.p.
