classdef GeneralAviationAircraft<sim3d.aircraft.Aircraft


    methods
        function self=GeneralAviationAircraft(actorName,AircraftType,varargin)

            numberOfParts=15;

            r=sim3d.aircraft.GeneralAviationAircraft.parseInputs(varargin{:});
            sim3d.aircraft.GeneralAviationAircraft.VerifyInitialTransformSize(...
        ...
        function ret=getColor(~,color)
            ...
            if ismember(color,sim3d.aircraft.Aircraft.Colors)
                ...
                ret=[sim3d.aircraft.Aircraft.ContentRoot,'/Vehicles/Aircraft/GeneralAviation/Materials/M_GA_Body',clr,'.M_GA_Body',clr];
            else
        ...
        function ret=getAnimation(~,meshType)
            ...
            switch meshType
            case 'GeneralAviation'
                ret=[sim3d.aircraft.Aircraft.ContentRoot,'/Vehicles/Aircraft/GeneralAviation/Animation/GeneralAviationAnimBP.GeneralAviationAnimBP_C'];
            otherwise
                ret='';
            end
        end
    ...
    methods(Access=public,Hidden=true)
        function actorType=getActorType(~)
            actorType=sim3d.utils.ActorTypes.GeneralAviation;
        end
    ...
    methods(Access=private,Static)
        function r=parseInputs(varargin)
            ...
            'Color','blue',...
            'Mesh','GeneralAviation',...
            'Animation','AnimationText',...
            'Translation',single(zeros(15,3)),...
            'Rotation',single(zeros(15,3)),...
            'Scale',single(ones(15,3)),...
            'ActorID',10);
