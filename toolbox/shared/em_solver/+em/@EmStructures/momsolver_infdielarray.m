function momsolver_infdielarray(obj,frequency,ElemNumber,Zterm,addtermination,hwait,pwavesource,...
    ...
    if calculate_dynamic_soln&&D
        ...
        I=solver_infdielarray(obj.MesherStruct.geom,obj.MesherStruct.const,obj,V,omega);
