classdef NonScalarTS<slwebwidgets.tableeditor.messagemanager.BaseMessageManager
    ...
    methods
        ...
        function bool=isSupported(obj,signalID)
            ...
            bool=contains(dataFormat,'multidimtimeseries');
        end
        ...
        function[msgOut,errMsg]=constructMessage(obj,signalID)
            ...
            fixDtOverride=getMetaDataByName(repoUtil,childIDsInOrder(1),'FixDTOverrideType');
            fiTypeToCast=[];
