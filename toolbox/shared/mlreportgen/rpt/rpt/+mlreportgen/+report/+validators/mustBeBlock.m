function mustBeBlock(value,holeId,varargin)
    ...
    exception='mlreportgen:report:validators:mustBeBlock';
...
function is=condition(value,holeId)
    ...
    (isa(value,'mlreportgen.dom.Element')&&...
    (isInlineCompatible(value)||isBlockCompatible(value)));
...
function is=isBlockCompatible(element)
    is=isa(element,'mlreportgen.dom.Element');
end
