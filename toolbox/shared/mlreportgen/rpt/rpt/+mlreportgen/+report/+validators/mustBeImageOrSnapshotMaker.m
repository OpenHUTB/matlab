function mustBeImageOrSnapshotMaker(value,holeId,varargin)

    exception='mlreportgen:report:validators:mustBeImageOrSnapshotMaker';
...
function is=condition(value,holeId)
    ...
    isa(value,'mlreportgen.report.mixin.SnapshotMaker');
