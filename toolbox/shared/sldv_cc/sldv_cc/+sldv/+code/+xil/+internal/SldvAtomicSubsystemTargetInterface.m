classdef(Hidden=true)SldvAtomicSubsystemTargetInterface<rtw.pil.AtomicSubsystemTargetInterface&sldv.code.xil.internal.SldvTargetInterface
    ...
    methods(Access='protected')
        ...
        function writeOutputBody(this)
            writeOutputBody@rtw.pil.AtomicSubsystemTargetInterface(this);
        ...
        function writeSectionIncludes(this)
            ...
            writeSectionIncludes@rtw.pil.AtomicSubsystemTargetInterface(this);
        end
        ...
        function writeSectionStorageForData(this,dataInterfaces,varargin)
            writeSectionStorageForData@rtw.pil.AtomicSubsystemTargetInterface(this,dataInterfaces,varargin{:});
