...
if true
[ tempse1, tempse1_ptr ] = hdlnewsignal( 'add_signext', 'block',  - 1, 0, 0, sevtype, sesltype );
...
if true
[ tempse2, tempse2_ptr ] = hdlnewsignal( 'add_signext', 'block',  - 1, 0, 0, sevtype, sesltype );
...
final_body = hdldatatypeassignment( tempsum_ptr, out, rounding, saturation, [  ], 'real' );
hdlbody = [ hdlbody, final_body ];
end 
...
% Decoded using De-pcode utility v1.2 from file /tmp/tmpuB1gGv.p.
