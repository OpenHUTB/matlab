function initParam(this,RAMType)
    ...
    elseif strcmpi(RAMType,'singleport')
        ...
        error(message('HDLShared:hdldialog:unsupported'));
    end

    if strcmpi(RAMType,'singleport')
        blkParam.required={'ramIsComplex','hasClkEn','readNewData'};
    else
        blkParam.required={'ramIsComplex','hasClkEn'};
    end
    blkParam.optional={};
    this.blkParam=blkParam;
