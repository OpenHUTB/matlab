function str=ramBodyVerilog(this,clk,ce,di,wa,we,ra,rdo)
    ...
    ,[blanks(indent+6),'end\n']...
    ,[blanks(indent+6),'data_int <= ram[',ra.Name,'];\n']...
    ,s2{2}...
    ,'    end // ',this.entityName,procLabel,'\n'...
    ,'\n'...
    ,'  assign ',rdo(1).Name,' = ',so{1},'data_int',s7,so{2},';\n'...
    ];

    if this.dataIsComplex
        str=[str...
        ,'  assign ',rdo(2).Name,' = ',so{1},'data_int',s8,so{2},';\n'...
        ];
    end
