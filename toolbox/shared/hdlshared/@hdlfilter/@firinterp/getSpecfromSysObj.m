function getSpecfromSysObj(this,hS,inputnumerictype)
    ...
    FilterStructure='FIR Interpolator';
    ...
    this.set('InterpolationFactor',InterpolationFactor,...
    ...
    function updateInputInfo(this,inputformat)
        ...
        function updateCoeffInfo(this,hS)
            ...
            coeffs=hS.Numerator;
            interpfact=hS.InterpolationFactor;
            this.InterpolationFactor=interpfact;
            this.PolyphaseCoefficients=polyphase_coeffs(coeffs,interpfact);
