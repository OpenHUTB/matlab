function[hdl_arch,prodptr,last_sum,final_result]=emit_serialmac(this,delaylist,counter_out,coeffs_data,ce)
    ...
    indx_inputs=zeros(phases,length(input_pipe_exp));
    for n=1:phases
        indx_inputs(n,:)=input_pipe_exp;
    end
    ...
    needAccum=needAccumulator(this);
    ...
    for muln=1:mults
        ...
        coeffs_index1{muln},counter_out,coeffmuxvals,['product',num2str(muln)],...
        ...
        for row=1:phases
            ...
            if~isempty(indx_power2coeffs)
                ...
                for n=1:numel(input_indx)
                    ...
                    [pwr2prodout,pwr2body,pwr2signals,pwr2tempsignals,prodtypedefs]=...
    ...
    accum=hdlgetallfromsltype(this.AccumSLtype);
    ...
    'filter',-1,prodcplxty,0,sumvtype,sumsltype);
