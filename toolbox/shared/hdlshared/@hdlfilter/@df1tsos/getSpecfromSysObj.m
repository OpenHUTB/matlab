function getSpecfromSysObj(this,hS,inputnumerictype)
    ...
    if fixedMode
        ...
        this.DenStateSLtype=sltypefromntype(dtinfo.DenominatorStateDataType);


        this.NumStateSLtype=sltypefromntype(dtinfo.NumeratorStateDataType);
        ...
        this.MultiplicandSLtype=sltypefromntype(dtinfo.MultiplicandDataType);
        ...
        this.MultiplicandSLtype='double';
