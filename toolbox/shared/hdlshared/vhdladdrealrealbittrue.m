...
vhdladdrealrealbittrue( in1, in2, out, rounding, saturation )
...
[ tempse1, tempse1_ptr ] = hdlnewsignal( 'add_cast', 'block',  - 1, 0, 0, castvtype, castsltype );
...
[ tempse2, tempse2_ptr ] = hdlnewsignal( 'add_cast', 'block',  - 1, 0, 0, castvtype, castsltype );
...
[ tempsum, tempsum_ptr ] = hdlnewsignal( 'add_temp', 'block',  - 1, 0, 0, sumvtype, sumsltype );
...
% Decoded using De-pcode utility v1.2 from file /tmp/tmpK7a0bK.p.
