classdef IntersectionPropertySheet<driving.internal.scenarioApp.road.PropertySheet&...
...
hStartPoint
    ...
    methods
        function this=IntersectionPropertySheet(varargin)
            this@driving.internal.scenarioApp.road.PropertySheet(varargin{:});
        end
        function update(this)
            road=getSpecification(this);
            setupWidgets(this,road,{'Width','StartPoint','EndPoint'});
    ...
    methods(Access=protected)
        function createWidgets(this)
            ...
            set(hRadiusLabel,'Visible','off')
            set(this.hRadius,'Visible','off')
            ...
            'VerticalGap',3);
            labelWidth=layout.getMinimumWidth([hWidthLabel,hStartLabel,hEndLabel]);
            this.Layout=layout;
            ...
            'MinimumWidth',20,...
            'Fill','Vertical');
            addLanesWidgetsToLayout(this,4);
            layout.add(hRadiusLabel,5,1,...
            'TopInset',labelInset,...
            'MinimumHeight',labelHeight,...
            'MinimumWidth',labelWidth,...
            'Anchor','NorthWest');

            layout.add(this.hRadius,5,[2,3],...
            'Fill','Horizontal',...
            'Anchor','NorthEast');
        end
