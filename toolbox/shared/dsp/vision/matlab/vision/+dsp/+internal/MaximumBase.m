classdef(Hidden)MaximumBase<matlab.system.SFunSystem
...
%#ok<*EMCA>
    ...
    properties(Nontunable)
        ...
        RunningMaximum(1,1)logical=false;
    ...
    methods
        function obj=MaximumBase(varargin)
            rcCoord=true;
    ...
    methods(Hidden)
        function setParameters(obj)
            ...
            if(obj.RunningMaximum)
                ...
                'dspshared:system:Maximum:incorrectOutputsSpecified');
            ...
            if obj.RunningMaximum&&obj.ResetInputPort
                ResetRunningMaximumIdx=getIndex(...
                obj.ResetConditionSet,obj.ResetCondition);
            else
                ResetRunningMaximumIdx=0;
            end
...
'ValidityOutputPort'...
    ...
    methods(Access=protected)
        function setPortDataTypeConnections(obj)
            ...
            portNum=1;
            if(obj.ValueOutputPort||obj.RunningMaximum)
