classdef(Hidden=true)FMUSpreadSheetReal<internal.fmudialog.FMUSpreadSheetItem
    properties
        rowUnit;
        rowDescription;
        rowParameter;
    ...
    methods
        ...
        function obj=FMUSpreadSheetReal(dataSource,name,unit,description,descName,isTopLevel)
        ...
        function setPropValue(obj,propName,propValue)
            ...
            if obj.isTopLevel
                ...
                p=mtree(propValue);
                if~p.isnull&&p.root.Next.isnull&&p.root.iskind('PRINT')&&p.root.Arg.Next.isnull
            ...
            if isValueOK
                ...
                msg=DAStudio.message('FMUBlock:FMU:InvalidRealValue');
