classdef(Hidden=true)FMUSpreadSheetEnumeration<internal.fmudialog.FMUSpreadSheetItem
    properties
        rowDescription;
        rowParameter;
        rowValueStringPos;
    ...
    methods
        ...
        function obj=FMUSpreadSheetEnumeration(dataSource,name,description,descName,isTopLevel)
        ...
        function propVal=getPropAllowedValues(obj,propName)
            ...
            case obj.FMUDialogColumn2
                if obj.isTopLevel
                    propVal=obj.dataSource.valueWidgetOptions{obj.rowValueStringPos(1)};
                else
                    propVal={};
                end
            case{obj.FMUDialogColumn1,obj.FMUDialogColumn3,obj.FMUDialogColumn4}
        ...
        function setPropValue(obj,propName,propValue)
            ...
            if isValueOK
                ...
                msg=DAStudio.message('FMUBlock:FMU:InvalidEnumValue');
