classdef(Hidden=true)FMUSpreadSheetInteger<internal.fmudialog.FMUSpreadSheetItem
    properties
        rowDescription;
        rowParameter;
        rowValueStringPos;
    ...
    methods
        ...
        function obj=FMUSpreadSheetInteger(dataSource,name,description,descName,isTopLevel)
        ...
        function iconFile=getDisplayIcon(obj)
            iconFile=fullfile('toolbox','shared','dastudio','resources','variable_fmi_int.png');
        end
        ...
        function setPropValue(obj,propName,propValue)
            ...
            if isValueOK
                ...
                msg=DAStudio.message('FMUBlock:FMU:InvalidIntValue');
