classdef(Hidden=true)spreadSheetBoolean<internal.fmuInterface.spreadSheetItem
    properties
        rowVariable;
        rowPos1;
        rowPos2;
    ...
    methods
        ...
        function obj=spreadSheetBoolean(dataSource,i,name,isTopLevel)
        ...
        function propType=getPropDataType(obj,propName)
            ...
            case{obj.FMUDialogColumn1,obj.FMUDialogColumn4,obj.FMUDialogColumn5}
                propType='string';
            case{obj.FMUDialogColumn2,obj.FMUDialogColumn3}
                propType='bool';
            end
        end
        ...
        function setPropValue(obj,propName,propValue)
            ...
            if strcmp(propName,obj.FMUDialogColumn3)
        ...
        function val=logicstr2str(~,logicVal)
            ...
            elseif strcmp(logicVal,'0')
                ...
                assert(false,'Unexpected logic value');
            end
        end
    end
end
