classdef(Hidden=true)spreadSheetArray<internal.fmuInterface.spreadSheetItem
    properties
        rowVariable;
        rowBusObjectName;
        rowPos1;
    ...
    methods
        ...
        function obj=spreadSheetArray(dataSource,i,name,busObjectName,children,isTopLevel)
        ...
        function isReadOnly=isReadonlyProperty(obj,propName)
            ...
            case obj.FMUDialogColumn3
                isReadOnly=false;
            case obj.FMUDialogColumn5
                isReadOnly=~obj.isTopLevel||isempty(obj.rowBusObjectName);
            otherwise
                warning('Unexpected type');
            end
        end
