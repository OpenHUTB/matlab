classdef(Hidden=true)spreadSheetEnumeration<internal.fmuInterface.spreadSheetItem
    properties
        rowVariable;
        rowPos1;
        rowPos2;
    ...
    methods
        ...
        function obj=spreadSheetEnumeration(dataSource,i,name,isTopLevel)
        ...
        function iconFile=getDisplayIcon(~)
            iconFile=fullfile('toolbox','shared','dastudio','resources','variable_fmi_enum.png');
        end
        ...
        function propVal=getPropAllowedValues(obj,propName)
            switch propName
            case{obj.FMUDialogColumn1,obj.FMUDialogColumn2,obj.FMUDialogColumn4,obj.FMUDialogColumn5}
                propVal={};
            case obj.FMUDialogColumn3
                if obj.isTopLevel
                    propVal=obj.dataSource.valueWidgetOptions{obj.rowPos1(1)};
                else
                    propVal={};
                end
            otherwise
