...
valueScalarTable
    ...
    methods(Access=private)
            ...
            if~isequal(size(this.valueStructure(i).ChildrenIndex),[1,0])
                ...
                if mdIdx>0
                    ...
                    if this.valueStructure(i).DataType==0
                        ...
                        treeItem=internal.parameterConfig.spreadSheetReal(this,i,name,varSource,isTop);
                    elseif this.valueStructure(i).DataType==1

                        treeItem=internal.parameterConfig.spreadSheetInteger(this,i,name,varSource,isTop);
                    elseif this.valueStructure(i).DataType==2

                        treeItem=internal.parameterConfig.spreadSheetBoolean(this,i,name,varSource,isTop);
                    elseif this.valueStructure(i).DataType==3

                        treeItem=internal.parameterConfig.spreadSheetString(this,i,name,varSource,isTop);
                    elseif this.valueStructure(i).DataType==4

                        treeItem=internal.parameterConfig.spreadSheetEnumeration(this,i,name,varSource,isTop);
                    else
        ...
        function treeItem=getArrayVariable(this,i,name,namePrefix,isTop)
            ...
            children(prod(dims))=internal.parameterConfig.spreadSheetItem;
            ...
            treeItem=internal.parameterConfig.spreadSheetArray(this,i,name,varSource,children,isTop);
        end

        function treeItem=getStructureVariable(this,i,name,namePrefix,isTop)

            children(1,length(this.valueStructure(i).ChildrenIndex))=internal.parameterConfig.spreadSheetItem;
            ...
            treeItem=internal.parameterConfig.spreadSheetStruct(this,i,name,varSource,children,isTop);
        end
    end
end
