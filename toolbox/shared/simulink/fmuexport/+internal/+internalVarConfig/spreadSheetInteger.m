classdef(Hidden=true)spreadSheetInteger<internal.internalVarConfig.spreadSheetItem
    ...
    methods
        ...
        function obj=spreadSheetInteger(dataSource,i,name,varSource,isTopLevel)
