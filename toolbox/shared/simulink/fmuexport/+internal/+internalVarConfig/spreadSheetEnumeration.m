classdef(Hidden=true)spreadSheetEnumeration<internal.internalVarConfig.spreadSheetItem
    ...
    methods
        ...
        function obj=spreadSheetEnumeration(dataSource,i,name,varSource,isTopLevel)
