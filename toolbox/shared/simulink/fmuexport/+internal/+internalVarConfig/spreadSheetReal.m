classdef(Hidden=true)spreadSheetReal<internal.internalVarConfig.spreadSheetItem
    ...
    methods
        ...
        function obj=spreadSheetReal(dataSource,i,name,varSource,isTopLevel)
        ...
        function propValue=getPropValue(obj,propName)
            ...
            case obj.ivDialogColumn5
                Idxs=obj.dataSource.valueScalarIndex{obj.rowPos1(1)};
                if numel(Idxs)==1
                    propValue=obj.dataSource.valueScalarTable(Idxs).unit;
                else
                    propValue=obj.dataSource.valueScalarTable(Idxs(obj.rowPos1(2))).unit;
                end
        ...
        function isValid=isValidProperty(obj,propName)
            switch propName
            case{obj.ivDialogColumn1,obj.ivDialogColumn3,obj.ivDialogColumn4,obj.ivDialogColumn5,obj.ivDialogColumn7}
                isValid=true;
