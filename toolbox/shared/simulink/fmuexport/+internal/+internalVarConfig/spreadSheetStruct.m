classdef(Hidden=true)spreadSheetStruct<internal.internalVarConfig.spreadSheetItem
    ...
    methods
        ...
        function propValue=getPropValue(obj,propName)
            ...
            case obj.ivDialogColumn7
                propValue=obj.dataSource.valueStructure(obj.rowPos2).busObjName;
        ...
        function isValid=isValidProperty(obj,propName)
            switch propName
            case{obj.ivDialogColumn1,obj.ivDialogColumn3,obj.ivDialogColumn7,obj.ivDialogColumn8}
                isValid=true;
            case{obj.ivDialogColumn2,obj.ivDialogColumn6}
