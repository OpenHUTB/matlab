classdef(Hidden=true)spreadSheetBoolean<internal.internalVarConfig.spreadSheetItem
    ...
    methods
        ...
        function obj=spreadSheetBoolean(dataSource,i,name,varSource,isTopLevel)
