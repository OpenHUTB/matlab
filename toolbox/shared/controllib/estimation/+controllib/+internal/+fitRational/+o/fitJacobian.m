function [B,D,N,solutionHistory] = ...
    ...
    basisPoles,basisPolesIsReal,lastB,lastD,lastN,mapParams,options,solutionHistory)
%

% Perform one IV iteration using fixed orthogonal-VF (OVF) bases.
%
% Inputs:
...
% Solve, with scaling and protection against bad matrices
