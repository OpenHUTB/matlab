...
% Perform one SK iteration using orthogonal-VF (OVF) bases.
%
% Inputs:
...
%   identifiedPoles: Identified poles in the last OVF iteration
...
% Linear constraints on TF coefficients. Also add non-triviality constraint, if necessary
