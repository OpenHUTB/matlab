...
% (denPoles) using OVF formulation. For a simple SISO fitting:
...
basisPoles = controllib.internal.fitRational.stabilizePoles(denPoles,mapParams.q);
...
% LocalWords:  OVF Overb LSQ controllib dp
