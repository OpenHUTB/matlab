...
classdef StructOfTimeseriesParser<Simulink.sdi.internal.import.TimeseriesParser
    ...
    methods
            ...
            if ret
                ...
                for idx=1:len
                    for fIdx=1:numFields
                        ...
                        if~isa(curVal,'timeseries')&&~isempty(curVal)&&~supportsType(this,curVal)&&~isa(curVal,'timetable')
                            ret=false;
                            return
                        end
                    end
        ...
        function ret=getSignalLabel(this)
            ...
            elseif~isempty(this.Parent)&&~isa(this.Parent,'Simulink.sdi.internal.import.StructOfTimeseriesParser')
        ...
        function ret=getChildren(this)
            ...
            if numChannels>1
                ...
                for idx=1:numChannels
                    ret{idx}=Simulink.sdi.internal.import.StructOfTimeseriesParser;
                    ret{idx}.Parent=this;
                ...
                for idx=1:numFields
                    ...
                    if isempty(curVar.VarValue)
                        curVar.VarValue=timeseries([],[],'Name','');
                    end
                    ...
                    ret{idx}.VariableSignalName=[busPrefix,'.',curField];
                    if isa(ret{idx},'Simulink.sdi.internal.import.StructOfTimeseriesParser')
        ...
        function ret=getExtendedSDIProperties(this,varargin)
            ret=struct.empty();
            if~isempty(this.Parent)
                ret=getExtendedSDIProperties(this.Parent,varargin{:});
            end
        end
    end
end
