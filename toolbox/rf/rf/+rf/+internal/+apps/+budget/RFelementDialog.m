classdef RFelementDialog<handle
...
ApplyLabel
    ...
    methods
        ...
        function self=RFelementDialog(parent)
    ...
    methods(Access=private)
        ...
        function parameterChanged(self,e)
            ...
            if applyflag
                self.ApplyLabel.Enable='on';
                self.Parent.View.setStatusBarMsg(...
                'Click ''Apply'' or hit ''Enter'' to update Generic Element parameters.');
                if self.Parent.View.UseAppContainer
        ...
        function applyFunction(self)
            ...
            i=self.Parent.View.Canvas.SelectIdx;
            rfelementobj=self.simrfV2_rfelement_design();
            self.Parent.notify('DisableCanvas',...
            rf.internal.apps.budget.ElementParameterChangedEventData(i,...
            'ApplyButton','inactive'));
            if self.NameChanged&&~self.OtherPropertiesChanged
        ...
        function FigKeyEvent(self,ev)
            ...
            if isa(self.Parent.ElementDialog,'rf.internal.apps.budget.RFelementDialog')
                key=ev.Key;
                switch key
                case 'return'
                    self.IsReturnKey=1;
        ...
        function rfelementobj=simrfV2_rfelement_design(self)
            rfelementobj=rfelement('Name',self.Name,'Gain',self.Gain,...
            'NF',self.NF,...
            'OIP2',self.OIP2,...
            'OIP3',self.OIP3,...
            'Zin',self.Zin,...
