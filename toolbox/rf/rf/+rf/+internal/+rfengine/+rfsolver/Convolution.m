...
History
    ...
    methods
        ...
        function o=Convolution(step,carrier_freqs,dae,X)
            ...
            if num_variables==0
                o.History=rf.internal.rfengine.rfsolver.History(step,0,[],[]);
            ...
            for i=1:length(carrier_freqs)
                ...
                imp=rf.internal.rfengine.rfsolver.ImpulseResponse(step,num_samples,carrier_freqs(i),f,values,variableToShift);
            ...
            o.History=rf.internal.rfengine.rfsolver.History(step,length(carrier_freqs),variables,history_lengths);
