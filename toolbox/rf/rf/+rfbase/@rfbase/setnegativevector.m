function out=setnegativevector(h,out,prop_name,...
    ...
    if isempty(out)
        ...
        error(message('rf:rfbase:rfbase:setnegativevector:EmptyNotAllowed',...
    ...
    if~isnumeric(out)||~isvector(out)||any(isnan(out))||...
        ...
        error(message(['rf:rfbase:rfbase:setnegativevector:'...
        ,'NotANegativeVector'],rferrhole1,rferrhole2));
    end
