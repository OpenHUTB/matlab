function dataWriter=addOrGetDataWriter(modelName,portName,topicPath,qosPath)
    ...
    publisher=dds.internal.simulink.addOrGetPublisher(modelName,portName,domainPath);
    writerName=[portName,'_Writer'];
