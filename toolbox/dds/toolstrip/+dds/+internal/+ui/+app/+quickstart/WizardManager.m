...
ModelToQuickStartWizardMap
    ...
    methods(Static,Access=private)
        function manager=instance()
            ...
            if isempty(singleton)
                manager=dds.internal.ui.app.quickstart.WizardManager();
                singleton=manager;
    ...
    methods(Static)
        function wizard(model)
            ...
            manager=dds.internal.ui.app.quickstart.WizardManager.instance();
            ...
            if manager.ModelToQuickStartWizardMap.isKey(modelH)
                ...
                quickStartWizard=dds.internal.ui.app.quickstart.Wizard(manager,model);
