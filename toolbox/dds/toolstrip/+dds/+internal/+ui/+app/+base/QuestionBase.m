...
Env
    ...
    methods
        ...
        function getAndAddOption(obj,tag)
            ...
            o=env.getOption(tag);
            if isempty(o)
                o=dds.internal.ui.app.option.(tag)(env);
            end
        ...
        function info=getInformation(obj)
            info.msg=dds.internal.ui.app.base.Gui.specialCharToJSON(...
            obj.QuestionMessage);
            info.rootModel=get_param(obj.Env.ModelHandle,'Name');
            info.hint=obj.HintMessage;
            info.hasHelp=obj.HasHelp;
            info.hasBack=obj.HasBack;
            info.isNextEnabled=obj.IsNextEnabled;
