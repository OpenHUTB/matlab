function filterTap=elabFilterTapSystolicPreAddWvldInS(this,topNet,blockInfo,dataRate,...
    ...
    '@FIRFilter','cgireml','FilterTapSystolicPreAddWvldInS.m'),'r');
    fcnBody=fread(fid,Inf,'char=>char')';
    fclose(fid);

    desc='FilterTapSystolicPreAddWvldInS';
    ...
    'EMLFileName','FilterTapSystolicPreAddWvldInS',...
    'EMLFileBody',fcnBody,...
