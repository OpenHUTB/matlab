function filterTap=elabFilterTapSystolicWvldInS(this,topNet,blockInfo,dataRate,...
    ...
    '@FIRFilter','cgireml','FilterTapSystolicWvldInS.m'),'r');
    fcnBody=fread(fid,Inf,'char=>char')';
    fclose(fid);

    desc='FilterTapSystlicWvldInS';
    ...
    'EMLFileName','FilterTapSystolicWvldInS',...
    'EMLFileBody',fcnBody,...
