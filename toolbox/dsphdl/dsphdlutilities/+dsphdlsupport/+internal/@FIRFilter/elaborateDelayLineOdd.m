function newNet=elaborateDelayLineOdd(~,net,numElements,dataInType,rdAddrType)
    ...
    'InportNames',{'dataIn','validIn','shiftEn','rdAddr'},...
    'InportTypes',[dataInType,pir_boolean_t,pir_boolean_t,rdAddrType],...
