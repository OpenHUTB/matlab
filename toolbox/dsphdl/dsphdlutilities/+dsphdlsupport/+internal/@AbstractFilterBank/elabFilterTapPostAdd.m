function filterTap=elabFilterTapPostAdd(this,topNet,blockInfo,dataRate,...
    ...
    '+dsphdlsupport','+internal','@AbstractFilterBank','cgireml','FilterTapPostAdd.m'),'r');
    fcnBody=fread(fid,Inf,'char=>char')';
    fclose(fid);

    desc='FilterTapPostAdd';
