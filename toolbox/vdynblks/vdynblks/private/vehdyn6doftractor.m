function[varargout]=vehdyn6doftractor(varargin)
    ...
    case 0
        if simStopped
            ...
            set_param([block,'/6 DOF Generic Vehicle Body/Aero Drag'],'LabelModeActiveChoice','ThreeAxleVehicle');
        ...
        {'beta_w',{}},'Cym',{}};
        autoblkscheckparams(block,'Tractor Body 6DOF 3 axles',[ParamList;HitchParmList],LookupTblList);
        if~strcmp(get_param(block,'extTamb'),'on')
...
function IconInfo=DrawCommands(BlkHdl)
    ...
    IconInfo.ImageName='6dof3axletractor.png';
