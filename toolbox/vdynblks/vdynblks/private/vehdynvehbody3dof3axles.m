function[varargout]=vehdynvehbody3dof3axles(varargin)
    ...
    case 0
        ...
        if simStopped
            [~]=vehdynvehbody3dof3axles(block,7);
            switch inputMode
            ...
            optList={'frontSteerMode';'middleSteerMode';'rearSteerMode';'windMode';'muMode';'extFMode';'extMMode';'htchFMode';'htchMMode'};
            varList={'front steer';'middle steer';'rear steer';'wind';'friction';'noVariant';'noVariant';'noVariant';'noVariant'};
            InportNames={'WhlAngF';'WhlAngM';'WhlAngR';'WindXYZ';'Mu';'FExt';'MExt';'Fh';'Mh'};
            if strcmp(get_param(block,'htchFMode'),'on')||strcmp(get_param(block,'htchMMode'),'on')
                ...
                set_param([block,'/hitch geometry parameters'],'LabelModeActiveChoice','0');
            end
            ...
            InportNames={'WhlAngF';'WhlAngM';'WhlAngR';'xdotin';'FwF';'FwM';'FwR';'FExt';'MExt';'Fh';'Mh';'WindXYZ';'Mu';'AirTemp';'X_o';'Y_o';'xdot_o';'ydot_o';'psi_o';'r_o'};
        ...
        if strcmp(get_param(block,'htchFMode'),'on')||strcmp(get_param(block,'htchMMode'),'on')
            ...
            autoblksgetmaskparms(block,{'dh'},true);
            L=dh;
        else
            HitchParmList={};
            L=[];
        ...
        if strcmp(get_param(block,'CalphaMode'),'on')
            ...
            CalphaParamList={'Cy_f',[1,1],{'gte',0};...
            'Cy_m',[1,1],{'gte',0};...
            'Cy_r',[1,1],{'gte',0}};
        ...
        ParamList=[BaseParamList;HitchParmList;TrackParmList;CalphaParamList];
    ...
    case 1
        if simStopped
            ...
            case 'External forces'
                set_param(block,'muMode','off')
                autoblksenableparameters(block,{'xdot_o';'w';'extxdoto'},{'Cy_f';'Cy_m';'Cy_r';'CalphaMode';'sigmaMode';'mu';'muMode';'sigma_f';'sigma_m';'sigma_r';'Cy_f_data';'Cy_m_data';'Cy_r_data';'alpha_f_brk';'alpha_m_brk';'alpha_r_brk'},[],[],'false')
            ...
            [~]=vehdynvehbody3dof3axles(block,3);
            [~]=vehdynvehbody3dof3axles(block,2);
        end
    ...
    case 3
        ...
        otherwise
            if strcmp(inputMode,'External forces')
                autoblksenableparameters(block,{'w'},{'Cy_f';'Cy_m';'Cy_r';'CalphaMode';'sigmaMode';'sigma_f';'sigma_m';'sigma_r';'Cy_f_data';'Cy_m_data';'Cy_r_data';'alpha_f_brk';'alpha_m_brk';'alpha_r_brk'},[],[])
            else
        ...
        [~]=vehdynvehbody3dof3axles(block,4);
        varargout{1}=0;
    ...
    case 4
        ...
        [~]=vehdynvehbody3dof3axles(block,5);
        varargout{1}=0;
...
function IconInfo=DrawCommands(BlkHdl,trackMode)
    ...
    case 'Single (bicycle)'
        ...
        IconInfo.ImageName='3dof3axlesvehiclestrack.png';
    otherwise
        AliasNames=[{'WhlAngF';'WhlAngM';'WhlAngR'},{'WhlAngF';'WhlAngM';'WhlAngR'}];
        IconInfo=autoblksgetportlabels(BlkHdl,AliasNames);

        IconInfo.ImageName='3dof3axlevehicle.png';
    end
