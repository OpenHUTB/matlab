function vdynThreeAxleTractorThreeAxleTrailerPlot(InertCGDisp,InertCGAng,InertCGVel,delta,vehRef,w,a,b,c,dh,bufferSize,figBorder,figWidth,extRef)
...
%#codegen
    ...
    if isempty(tireML)tireML=zeros(1,2);end
    if isempty(tireMR)tireMR=zeros(1,2);end
