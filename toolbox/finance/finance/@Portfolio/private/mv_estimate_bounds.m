function[glb,gub,isbounded]=mv_estimate_bounds(n0,A,b,lb,ub,options,obtainExactBounds)
    ...
    if nargin<6
        error(message('finance:Portfolio:mv_estimate_bounds:MissingInputArgument'));
    end
    ...
    if isempty(n)
        error(message('finance:Portfolio:mv_estimate_bounds:IllDefinedSet'));
    end
