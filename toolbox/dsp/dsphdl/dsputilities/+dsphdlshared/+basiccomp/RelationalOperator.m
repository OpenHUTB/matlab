classdef RelationalOperator<dsphdlshared.basiccomp.abstractElabHDLComp
...
Operator
    ...
    methods
        ...
        function this=RelationalOperator(varargin)
    ...
    methods(Access=protected)
        function hC=interfaceFcn(this,s)%#ok<MANU>
            ...
            hC=emlainterface.getRelationalOperator(s);
        end
    end
