...
%#ok<*EMCA>
    ...
    methods
        ...
        function obj=Convolver(varargin)
            coder.allowpcode('plain');
            coder.internal.warning('dsp:system:Convolver_NotSupported');
...
1...
    ...
    methods(Static)
        function helpFixedPoint
            ...
            matlab.system.dispFixptHelp('dsp.Convolver',dsp.Convolver.getDisplayFixedPointPropertiesImpl);
        end
    end

    methods(Static,Hidden)
        function a=getAlternateBlock
            a='dspsigops/Convolution';
        end
