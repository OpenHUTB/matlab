...
function ReadySignalGeneratorGaussJordan(~,hN,ReadySigGenInSigs,ReadySigGenOutSigs,...
    slRate,blockInfo)
    ...
    'Name','ReadySignalGeneratorGaussJordan',...
    ...
    Constant1_out1_s3=l_addSignal(hReadySigGenN,'Constant1_out1',pirTyp1,slRate);
    Constant2_out1_s4=l_addSignal(hReadySigGenN,'Constant2_out1',pirTyp1,slRate);
    LogicalOperator_out1_s6=l_addSignal(hReadySigGenN,sprintf('Logical\nOperator_out1'),pirTyp1,slRate);
    Switch_out1_s7=l_addSignal(hReadySigGenN,'Switch_out1',pirTyp1,slRate);
    Switch1_out1_s8=l_addSignal(hReadySigGenN,'Switch1_out1',pirTyp1,slRate);
    compFlag_out1_s9=l_addSignal(hReadySigGenN,'compFlag_out1',pirTyp1,slRate);
    compFlag2_out1_s10=l_addSignal(hReadySigGenN,'compFlag2_out1',pirTyp1,slRate);
