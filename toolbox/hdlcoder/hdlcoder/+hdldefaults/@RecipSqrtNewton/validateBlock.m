function v=validateBlock(this,hC)
    ...
    if(~strcmpi(functionName,'rsqrt'))
        v(end+1)=hdlvalidatestruct(1,message('hdlcoder:validate:rsqrtunsupportedfunc',functionName));

    elseif~strcmpi(algorithmType,'Newton-Raphson')
        v(end+1)=hdlvalidatestruct(1,message('hdlcoder:validate:rsqrtunsupportedmode'));
