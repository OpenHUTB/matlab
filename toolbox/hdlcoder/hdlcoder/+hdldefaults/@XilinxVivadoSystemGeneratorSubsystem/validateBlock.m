...
function validateStruct=validateXSGSubsystem(xsgSubsys,validateStruct)
    ...
    xsgBlks=targetcodegen.xilinxvivadosysgendriver.findXSGBlks(xsgSubsys);
    if(length(xsgBlks)~=1)
    ...
    xsgParams=targetcodegen.xilinxvivadosysgendriver.getXSGSettings(xsgBlk);
    ...
    if(~isempty(familyDevicePackageSpeed{1})||...
        ...
        xsgFamilyDevicePackageSpeed={xsgParams.Family,...
        xsgParams.Device,...
        xsgParams.Package,...
        xsgParams.Speed};
