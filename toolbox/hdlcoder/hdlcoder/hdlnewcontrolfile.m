function varargout = hdlnewcontrolfile(block)
% Warning! This function is DEPRECATED for external use.
%
% Please use hdlset_param and hdl_getparam interface to set model and block
% properties in HDL Coder instead of control files
...
if nargout == 0
    privhdlnewcontrolfile(block);
else
    varargout(1) = {privhdlnewcontrolfile(block)};
end
