...
function hTopN=getHalfRelopComp(hOrigN,opName,latency,slRate)
...
function hTopN=addNetworks(p,opName)
    ...
    hN.FullPath='Relops_Half';
    hTopN=hN;
    hN=p.addNetwork;
    hN.Name='NFP_MathWorks_Relops_Half';
    hN.FullPath='Relops_Half/NFP_MathWorks_Relops_Half';
    hN=p.addNetwork;
    hN.Name='CheckZeroNaN';
    hN.FullPath='Relops_Half/NFP_MathWorks_Relops_Half/CheckZeroNaN';
    hN=p.addNetwork;
    hN.Name='Greater_Or_Equal';
    hN.FullPath='Relops_Half/NFP_MathWorks_Relops_Half/Greater_Or_Equal';
    hN=p.addNetwork;
    hN.Name='InitialSequenceLogic';
    hN.FullPath='Relops_Half/NFP_MathWorks_Relops_Half/InitialSequenceLogic';
    switch opName
    case{'==','~='}
        hN=p.addNetwork;
        hN.Name='SSAEB';
        hN.FullPath='Relops_Half/NFP_MathWorks_Relops_Half/SSAEB';
    case{'<','>='}
        hN=p.addNetwork;
        hN.Name='SSAGB';
        hN.FullPath='Relops_Half/NFP_MathWorks_Relops_Half/SSAGB';
    case{'>','<='}
        hN=p.addNetwork;
        hN.Name='SSALB';
        hN.FullPath='Relops_Half/NFP_MathWorks_Relops_Half/SSALB';
    end
end
...
function createNetworks(p,opName,pipestage,latency,slRate)
    switch opName
    case{'>','<='}
        hN_n7=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/SSALB');
        createNetwork_n7(p,hN_n7,opName,pipestage,slRate);
    case{'<','>='}
        hN_n6=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/SSAGB');
        createNetwork_n6(p,hN_n6,opName,pipestage,slRate);
    case{'==','~='}
        hN_n5=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/SSAEB');
        createNetwork_n5(p,hN_n5,opName,pipestage,slRate);
    end
    hN_n4=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/InitialSequenceLogic');
    createNetwork_n4(p,hN_n4,latency,slRate);
    hN_n3=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/Greater_Or_Equal');
    createNetwork_n3(p,hN_n3,slRate);
    hN_n2=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/CheckZeroNaN');
    createNetwork_n2(p,hN_n2,slRate);
    hN_n1=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half');
    createNetwork_n1(p,hN_n1,opName,pipestage,slRate);
    hN_n0=p.findNetwork('fullname','Relops_Half');
...
function hN=createNetwork_n1(p,hN,opName,pipestage,slRate1)
    ...
    hRefN=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/CheckZeroNaN');
    ...
    hRefN=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/Greater_Or_Equal');
    ...
    hRefN=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/InitialSequenceLogic');
    ...
    switch opName
    case{'==','~='}
        hRefN=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/SSAEB');
        ...
        outSig);
    case{'<','>='}
        hRefN=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/SSAGB');
        ...
        outSig);
    case{'>','<='}
        hRefN=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half/SSALB');
...
function hN=createNetwork_n0(p,hN,opName,slRate1)
    ...
    hRefN=p.findNetwork('fullname','Relops_Half/NFP_MathWorks_Relops_Half');
    NFP_MathWorks_Relops_Half=hN.addComponent('ntwk_instance_comp',hRefN);
    NFP_MathWorks_Relops_Half.Name='NFP_MathWorks_Relops_Half';
    pirelab.connectNtwkInstComp(NFP_MathWorks_Relops_Half,...
