function hTopN=getSingleAddComp(hN,latency,slRate)
    p=pir(hN.getCtxName);
    hTopN=addNetworks(p);
...
function hTopN=addNetworks(p)
    hN=p.addNetwork;
    hN.Name='Add_Single';
    hN.FullPath='Add_Single';
    hTopN=hN;
    hN=p.addNetwork;
    hN.Name='NFP_Mathworks_ADD_Single';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single';
    hN=p.addNetwork;
    hN.Name='appendMantissaAndCorrectExponent';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/appendMantissaAndCorrectExponent';
    hN=p.addNetwork;
    hN.Name='appendMantissaAndCorrectExponent1';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/appendMantissaAndCorrectExponent1';
    hN=p.addNetwork;
    hN.Name='getAbsLarger';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/getAbsLarger';
    hN=p.addNetwork;
    hN.Name='isSub';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/isSub';
    hN=p.addNetwork;
    hN.Name='plus_Inf_or_NaN';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Inf_or_NaN';
    hN=p.addNetwork;
    hN.Name='plus_Main';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main';
    hN=p.addNetwork;
    hN.Name='Rounding_Denormals';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/Rounding_Denormals';
    hN=p.addNetwork;
    hN.Name='plus_Add_Mantissas';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Add_Mantissas';
    hN=p.addNetwork;
    hN.Name='plus_Align_Mantissa';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa';
    hN=p.addNetwork;
    hN.Name='get_Sticky';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky';
    hN=p.addNetwork;
    hN.Name='4_2_Multiplexer1';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky/4_2_Multiplexer1';
    hN=p.addNetwork;
    hN.Name='4_2_Multiplexer3';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky/4_2_Multiplexer3';
    hN=p.addNetwork;
    hN.Name='4_2_Multiplexer5';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky/4_2_Multiplexer5';
    hN=p.addNetwork;
    hN.Name='plus_Normalize';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize';
    hN=p.addNetwork;
    hN.Name='FindFirst1';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1';
    hN=p.addNetwork;
    hN.Name='Bottom 8 bits';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1/Bottom 8 bits';
    hN=p.addNetwork;
    hN.Name='Middle 8 bits';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1/Middle 8 bits';
    hN=p.addNetwork;
    hN.Name='Top 8 bits';
    hN.FullPath='Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1/Top 8 bits';
end

function createNetworks(p,pipestage,slRate1)
    hN_n32=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1/Top 8 bits');
    createNetwork_n32(p,hN_n32,slRate1);
    hN_n31=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1/Middle 8 bits');
    createNetwork_n31(p,hN_n31,slRate1);
    hN_n30=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1/Bottom 8 bits');
    createNetwork_n30(p,hN_n30,slRate1);
    hN_n29=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1');
    createNetwork_n29(p,hN_n29,slRate1);
    hN_n28=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize');
    createNetwork_n28(p,hN_n28,pipestage,slRate1);
    hN_n17=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky/4_2_Multiplexer5');
    createNetwork_n17(p,hN_n17,slRate1);
    hN_n15=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky/4_2_Multiplexer3');
    createNetwork_n15(p,hN_n15,slRate1);
    hN_n13=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky/4_2_Multiplexer1');
    createNetwork_n13(p,hN_n13,slRate1);
    hN_n11=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky');
    createNetwork_n11(p,hN_n11,slRate1);
    hN_n10=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa');
    createNetwork_n10(p,hN_n10,pipestage,slRate1);
    hN_n9=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Add_Mantissas');
    createNetwork_n9(p,hN_n9,pipestage,slRate1);
    hN_n8=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/Rounding_Denormals');
    createNetwork_n8(p,hN_n8,pipestage,slRate1);
    hN_n7=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main');
    createNetwork_n7(p,hN_n7,pipestage,slRate1);
    hN_n6=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Inf_or_NaN');
    createNetwork_n6(p,hN_n6,pipestage,slRate1);
    hN_n5=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/isSub');
    createNetwork_n5(p,hN_n5,slRate1);
    hN_n4=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/getAbsLarger');
    createNetwork_n4(p,hN_n4,pipestage,slRate1);
    hN_n3=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/appendMantissaAndCorrectExponent1');
    createNetwork_n3(p,hN_n3,pipestage,slRate1);
    hN_n2=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/appendMantissaAndCorrectExponent');
    createNetwork_n2(p,hN_n2,pipestage,slRate1);
    hN_n1=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single');
    createNetwork_n1(p,hN_n1,pipestage,slRate1);
    hN_n0=p.findNetwork('fullname','Add_Single');
...
function hN=createNetwork_n29(p,hN,slRate1)
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1/Bottom 8 bits');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1/Middle 8 bits');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1/Top 8 bits');
...
function hN=createNetwork_n28(p,hN,pipestage,slRate1)
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize/FindFirst1');
...
function hN=createNetwork_n11(p,hN,slRate1)
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky/4_2_Multiplexer1');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky/4_2_Multiplexer3');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky/4_2_Multiplexer5');
...
function hN=createNetwork_n10(p,hN,pipestage,slRate1)
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa/get_Sticky');
...
function hN=createNetwork_n7(p,hN,pipestage,slRate1)
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/Rounding_Denormals');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Add_Mantissas');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Align_Mantissa');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main/plus_Normalize');
...
function hN=createNetwork_n1(p,hN,pipestage,slRate1)
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/appendMantissaAndCorrectExponent');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/appendMantissaAndCorrectExponent1');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/getAbsLarger');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/isSub');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Inf_or_NaN');
    ...
    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single/plus_Main');
...
function hN=createNetwork_n0(p,hN,slRate1)
    ...
    hN.addOutputPort('RS');
    NFP_Mathworks_ADD_Single_out1_s6=addSignal(hN,'NFP_Mathworks_ADD_Single_out1',pirTyp1,slRate1);
    NFP_Mathworks_ADD_Single_out1_s6.addReceiver(hN,0);

    hN.addOutputPort('RE');
    NFP_Mathworks_ADD_Single_out2_s7=addSignal(hN,'NFP_Mathworks_ADD_Single_out2',pirTyp2,slRate1);
    NFP_Mathworks_ADD_Single_out2_s7.addReceiver(hN,1);

    hN.addOutputPort('RM');
    NFP_Mathworks_ADD_Single_out3_s8=addSignal(hN,'NFP_Mathworks_ADD_Single_out3',pirTyp3,slRate1);
    NFP_Mathworks_ADD_Single_out3_s8.addReceiver(hN,2);


    hRefN=p.findNetwork('fullname','Add_Single/NFP_Mathworks_ADD_Single');
    NFP_Mathworks_ADD_Single=hN.addComponent('ntwk_instance_comp',hRefN);
    NFP_Mathworks_ADD_Single.Name='NFP_Mathworks_ADD_Single';
    pirelab.connectNtwkInstComp(NFP_Mathworks_ADD_Single,...
    [AS_s0,AE_s1,AM_s2,BS_s3,BE_s4,BM_s5],...
    [NFP_Mathworks_ADD_Single_out1_s6,NFP_Mathworks_ADD_Single_out2_s7,NFP_Mathworks_ADD_Single_out3_s8]);
