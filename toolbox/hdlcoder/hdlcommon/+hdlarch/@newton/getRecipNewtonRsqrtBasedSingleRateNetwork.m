function hNewtonNet=getRecipNewtonRsqrtBasedSingleRateNetwork(topNet,hInSignals,hOutSignals,newtonInfo)
    ...
    hdlarch.newton.getRecipSqrtNewtonSingleRateComp(hNewtonNet,din_abs,rsqrt_out,rsnewtonInfo);
    ...
    if inSigned
        ...
        d3Comp=pireml.getIntDelayComp(hNewtonNet,din_sel,din_selp,(newtonInfo.iterNum*4)+8,'ds_reg');
