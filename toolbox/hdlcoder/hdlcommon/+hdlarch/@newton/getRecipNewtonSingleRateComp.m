function getRecipNewtonSingleRateComp(hN,hInSignals,hOutSignals,newtonInfo)
    ...
    pireml.getIntDelayComp(hN,onemoreshift,onemoreshift_p,(1+iterNum*2),'onemoreshift_reg');
    ...
    tSignalsIn=[xinit,anorm_p];
    hCoreNet=hdlarch.newton.getNewtonRecipCoreSingleRateNetwork(hN,tSignalsIn,newtonInfo);
    ...
    dsregComp=pireml.getIntDelayComp(hN,dynamicshift,dynamicshift_p,(1+iterNum*2),'ds_reg');
    dsregComp.addComment('Pipeline registers');



    inzero_p=hN.addSignal(ufix1Type,'inzero_p');
    d4Comp=pireml.getIntDelayComp(hN,inzero,inzero_p,(iterNum*2),'inzero_reg');
    ...
    if inSigned
        ...
        pireml.getIntDelayComp(hN,changesign,changesign_p,(1+iterNum*2),'changesign_reg');
