function hNewtonNet=getSqrtNewtonSingleRateNetwork(topNet,hInSignals,hOutSignals,newtonInfo)
    ...
    hdlarch.newton.getRecipSqrtNewtonSingleRateComp(hNewtonNet,din,rsqrt_out,rsnewtonInfo);
    ...
    d2Comp=pireml.getIntDelayComp(hNewtonNet,din,din_p,(newtonInfo.iterNum*4)+6,'din_reg');
