function hNewtonNet=getRecipSqrtNewtonNetwork(topNet,hInSignals,hOutSignals,newtonInfo)
    ...
    hdlarch.newton.getRecipSqrtNewtonComp(hNewtonNet,din,dout,newtonInfo);
