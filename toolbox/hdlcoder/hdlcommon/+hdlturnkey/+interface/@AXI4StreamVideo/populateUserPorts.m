function populateUserPorts(~,hN,hChannel)
    ...
    for ii=1:length(inputPortList)
        ...
        if~hSubPort.IsRequiredPort&&~hSubPort.isAssigned
            continue;
        end
        ...
        if hSubPortType.isBusType
            ...
            [portWidth,portDimension,totalWidth]=hChannel.getPortWidth(hSubPort,hChannel.PackingMode);
    ...
    for ii=1:length(outputPortList)
        ...
        if hSubPortType.isBusType
            ...
            portName=subPortName;
            [portWidth,portDimension,totWidth]=hChannel.getPortWidth(hSubPort,hChannel.PackingMode);
