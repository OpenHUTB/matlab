function hC=getInvMegaFunctionComp(targetCompInventory,hN,hInSignals,hOutSignals,className,mnemonic,pipeline)
    ...
    alteratarget.applyExtraArgs(fid,'Recip',baseType);
    ...
    if~isempty(targetCompInventory)
        ...
        alteratarget.generateMegafunction(targetCompInventory,altMegaFunctionName,'altfp_inv',mfparamsTempFile,pipeline,num);
    end
