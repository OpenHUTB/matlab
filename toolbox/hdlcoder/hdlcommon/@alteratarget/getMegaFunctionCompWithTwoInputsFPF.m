function[altMegaFunctionName,extraDir,status]=getMegaFunctionCompWithTwoInputsFPF(targetCompInventory,baseType,className,mnemonic,latencyFreq,isFreqDriven,fpFunction,dryRun,deviceInfo,fpSpecificArgs,nameSuffix)
