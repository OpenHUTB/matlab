function hC=getInvSqrtMegaFunctionComp(targetCompInventory,hN,hInSignals,hOutSignals,className,mnemonic,pipeline)
    ...
    alteratarget.applyExtraArgs(fid,'Rsqrt',baseType);
    ...
    if~isempty(targetCompInventory)
        ...
        alteratarget.generateMegafunction(targetCompInventory,altMegaFunctionName,'altfp_inv_sqrt',mfparamsTempFile,pipeline,num);
    end
