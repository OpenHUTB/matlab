function hC=getLogMegaFunctionComp(targetCompInventory,hN,hInSignals,hOutSignals,className,mnemonic,pipeline)
    ...
    alteratarget.applyExtraArgs(fid,'Log',baseType);
    ...
    if~isempty(targetCompInventory)
        ...
        alteratarget.generateMegafunction(targetCompInventory,altMegaFunctionName,'altfp_log',mfparamsTempFile,pipeline,num);
    end
