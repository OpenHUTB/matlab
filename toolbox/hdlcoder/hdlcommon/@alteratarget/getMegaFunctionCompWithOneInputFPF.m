function[altMegaFunctionName,extraDir,status]=getMegaFunctionCompWithOneInputFPF(targetCompInventory,baseType,className,mnemonic,latencyFreq,isFreqDriven,fpFunction,dryRun,deviceInfo,fpSpecificArgs,nameSuffix)
    ...
    assert(~isempty(targetCompInventory));
