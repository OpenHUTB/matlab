function[hC,num]=getTargetSpecificInstantiationCompsWithThreeInputsFPF(hN,hInSignals,hOutSignals,altMegaFunctionName,latency)
    ...
    function hC=getScalarTargetSpecificMegafunctionCompWithTwoInputs(hN,hInSignals,hOutSignals,altMegaFunctionName,latency)
        ...
        altMegaFunctionName,{'a','b','c'},{'q'},{'clk'},{'en'},{'areset'},latency);
