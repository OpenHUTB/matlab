function hC=getAbsMegaFunctionComp(targetCompInventory,hN,hInSignals,hOutSignals,className,pipeline)
    ...
    alteratarget.applyExtraArgs(fid,'Abs',baseType);
    ...
    if~isempty(targetCompInventory)
        ...
        alteratarget.generateMegafunction(targetCompInventory,altMegaFunctionName,'altfp_abs',mfparamsTempFile,pipeline,num);
    end
