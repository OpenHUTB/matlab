function hCs=getFIFOFWFTComp(hN,InSignals,OutSignals,fifoSize,fifoName,ramCorePrefix,statusOut,almost_full_thresh)
    ...
    if nDimsIn>1
        ...
        for ii=1:nDimsIn
            ...
            hFWFTNet=pirelab.getFIFOFWFTNetwork(hN,FIFOInSignals,info);


            hCs(ii)=pirelab.instantiateNetwork(hN,hFWFTNet,FIFOInSignals,FIFOOutSignals,...
        ...
        hCs=pirelab.instantiateNetwork(hN,hFWFTNet,FIFOInSignals,FIFOOutSignals,...
        sprintf('%s_inst',fifoName));
    end
