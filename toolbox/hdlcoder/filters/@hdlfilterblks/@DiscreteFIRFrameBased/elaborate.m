function hNewC=elaborate(this,hN,hC)
    ...
    blockInfo=getBlockInfo(this,hC,slbh);
    ...
    if blockInfo.progCoeff
        hTopNet.PirInputPorts(2).Name=[dfname,'_coeff_in'];
        hTopNet.PirInputSignals(2).Name=[dfname,'_coeff_in'];
    end
    ...
    this.elaborateFrameBased(hTopNet,hC,blockInfo);
