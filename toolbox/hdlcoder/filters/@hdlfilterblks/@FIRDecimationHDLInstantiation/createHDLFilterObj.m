function hf=createHDLFilterObj(this,hC)
    ...
    function hf=getHDLFiltObjFromBlockInfo(this,block,hC,options)
        ...
        hf.FilterStructure=block.filtStruct;
        ...
        function hf=updateFixedPointInfo(this,hf,hC,block,arith,inputformat)
            ...
            function hf=updateInputInfo(hf,inputformat,arith)
                ...
                function hf=updateCoeffInfo(this,hf,hC,arith,typeInfo,block)%#ok<INUSL>
                    ...
                    hf.DecimationFactor=decimfact;
                    hf.PolyphaseCoefficients=polyphase_coeffs(coeffs,decimfact);
                    ...
                    function hf=updateProdInfo(hf,arith,typeInfo)
                        ...
                        function hf=updateAccumInfo(hf,arith,typeInfo)
                            ...
                            function hf=updateStateInfo(hf)

                                if istransposedFIR(hf)
                                ...
                                function hf=updatePolyAccumInfo(hf)

                                    if istransposedFIR(hf)

                                        hf.polyAccumSLType=hf.Accumsltype;
                                    end
                                    ...
                                    function hf=updateOutputInfo(hf,arith,typeInfo)
                                        ...
                                        function isFIRt=istransposedFIR(hf)
                                            isFIRt=(isa(hf,'hdlfilter.firtdecim'));
                                                ...
                                                function hf=getHDLFiltObjFromFiltObj(this,block,hC,options)
                                                    ...
                                                    if~isempty(filtObjName)
                                                        ...
                                                        if isfield(ud,'filter');
                                                            ...
                                                            if isa(ud.filter,'dsp.FIRDecimator')
                                                    ...
                                                    if~isa(ud.filter,'dsp.FIRDecimator')
                                                        ...
                                                        if~strcmp(mfiltArithmetic,options.arithmetic)
                                                            ...
                                                            if strcmp(mfiltArithmetic,'fixed')
                                                                mfiltInputFormat=[hd.InputWordLength,hd.InputFracLength];
                                                                if~isequal(mfiltInputFormat,options.inputformat)
                                                                    error(message('hdlcoder:validate:InputFormatMismatch',filtObjName,num2str(mfiltInputFormat(1)),num2str(mfiltInputFormat(2)),num2str(options.inputformat(1)),num2str(options.inputformat(2))));
                                                                end
                                                            end
                                                            hf=createhdlfilter(hd);
                                                        end
                                                        ...
                                                        coeffs=hd.Numerator;
                                                        decimfactor=hd.DecimationFactor;
                                                        ...
                                                        hf.DecimationFactor=decimfactor;
                                                        hf.PolyphaseCoefficients=polyphase_coeffs(coeffs,decimfactor);
                                                    ...
                                                    if strcmpi(class(hd),'mfilt.firtdecim')
                                                        hf.Polyaccumsltype=hf.Accumsltype;
                                                        hf.statesltype=hf.Accumsltype;
                                                    end
