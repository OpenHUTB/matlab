function[addon]=schemaGenerateImplementationModel(task)
    ...
    dlgInfo=getGenerateImplementationModelDialog(mdladvObj);

    addon.Items{1}=dlgInfo.Items{1};
    addon.Items{1}.Enabled=true;
    addon.Items{2}=dlgInfo.Items{2};
    addon.Items{2}.Enabled=true;
    addon.Items{3}=dlgInfo.Items{3};
    addon.Items{3}.Enabled=true;


    addon.DialogTitle=DAStudio.message('hdlcoder:hdlssc:ssccodegenadvisor_checks:generateImplementationModelCheckTitle');
    ...
    addon.DialogTag=['com.mathworks.hdlssc.ssccodegenadvisor.generateImplementationDialog',...
    appID];
