function[addon]=schemaDiscretizeEquations(task)
    ...
    dlgInfo=getDiscretizeEquationsDialog(mdladvObj);
    ...
    addon.DialogTitle=DAStudio.message('hdlcoder:hdlssc:ssccodegenadvisor_checks:discretizeCheckTitle');
    addon.DialogTag='com.mathworks.hdlssc.ssccodegenadvisor.discretizeEquationsDialog';
