function[addon]=schemaExtractEquations(task)
    ...
    dlgInfo=getExtractEquationsDialog(mdladvObj);
    ...
    addon.DialogTitle=DAStudio.message('hdlcoder:hdlssc:ssccodegenadvisor_checks:getStateSpaceParametersCheckTitle');
    addon.DialogTag='com.mathworks.hdlssc.ssccodegenadvisor.extractEquationsDialog';
