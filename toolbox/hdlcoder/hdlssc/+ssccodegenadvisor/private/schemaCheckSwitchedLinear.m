function[addon]=schemaCheckSwitchedLinear(task)
    ...
    dlgInfo=getCheckSwitchedLinearDialog();

    addon.Items{1}=dlgInfo.Items{1};
    addon.Items{1}.Enabled=true;


    addon.DialogTitle=DAStudio.message('hdlcoder:hdlssc:ssccodegenadvisor_checks:checkSwitchedLinearCheckTitle');
    addon.DialogTag='com.mathworks.hdlssc.ssccodegenadvisor.checkSwitchedLinearDialog';
