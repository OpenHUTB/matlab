function[position,moveOnResize]=getPositionForSpec(positionSpec)
    ...
    if~(isa(positionSpec,'classdiagram.app.core.notifications.output.PositionSpecification'))
    ...
    moveOnResize=false;
    switch prefSide
    case classdiagram.app.core.notifications.output.utils.PreferredSide.TOP
        placed=tryPlacingOnTop()||tryPlacingOnLeft()||tryPlacingOnRight()||tryPlacingOnBottom();
    case classdiagram.app.core.notifications.output.utils.PreferredSide.LEFT
        placed=tryPlacingOnLeft()||tryPlacingOnTop()||tryPlacingOnBottom()||tryPlacingOnRight();
    case classdiagram.app.core.notifications.output.utils.PreferredSide.RIGHT
        placed=tryPlacingOnRight()||tryPlacingOnTop()||tryPlacingOnBottom()||tryPlacingOnLeft();
    case classdiagram.app.core.notifications.output.utils.PreferredSide.BOTTOM
