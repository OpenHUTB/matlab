function asap2SetAddressPDBPrivate(ASAP2File,PDBFile,db,addrPrefix,addrSuffix)
    ...
    if~isempty(missingSymbolList)
        MSLDiagnostic('RTW:asap2:NoSymbolInTable',strjoin(missingSymbolList,', '),'PDB',PDBFile).reportAsWarning;
    end
