...
AllWindows
    ...
    methods(Access=public)
        function obj=WindowManager(layout,contentWindowFactories)
            obj.Layout=slxmlcomp.internal.highlight.EmptyLayout();
        ...
        function activeWindows=getActiveWindows(obj)
            activeWindows=slxmlcomp.internal.highlight.HighlightWindow.empty;
        ...
        function delete(obj)
            ...
            delete(obj.Layout)
            import slxmlcomp.internal.highlight.deleteStructValues
