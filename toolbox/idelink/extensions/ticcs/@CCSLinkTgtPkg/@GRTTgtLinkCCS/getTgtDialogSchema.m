function[Tab1]=getTgtDialogSchema(hSrc,schemaName)
    ...
    RuntimeGroup.LayoutGrid=[3,1];
    RuntimeGroup.RowStretch=[0,0,1];


    widget.Name='Build action:         ';
    widget.Type='combobox';
    widget.Entries={'Create_project','Archive_library','Build','Build_and_execute'};
    ...
    RuntimeGroup.Items={buildAction,overrunNotificationMethod,overrunNotificationFcn,ideObjBuildTimeout};
