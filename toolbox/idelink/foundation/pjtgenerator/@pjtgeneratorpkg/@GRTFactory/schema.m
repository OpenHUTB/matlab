function schema()
    ...
    hThisClass=schema.class(hCreateInPackage,'GRTFactory',hDeriveFromClass);
    ...
    hThisProp=add_prop(hThisClass,'MultiInstanceErrorCode','CONFIG_TARGET_MULTIINSTANCEERRORCODE_ENUM');
