function[item,i]=getExtensionStringFormat(~,item,i)
    ...
    item(i).tlc_option_name='buildFormat';
    item(i).make_var_name='BUILDFORMAT';
    item(i).prop_name='buildFormat';
    i=i+1;