function schema()
    ...
    hThisClass=schema.class(hCreateInPackage,'GRTTgtLink',hDeriveFromClass);
    ...
    hThisProp=add_prop(hThisClass,'GenerateASAP2','slbool');
    hThisProp.FactoryValue='off';

    hThisProp=add_prop(hThisClass,'ExtMode','slbool');
    hThisProp.FactoryValue='off';

    hThisProp=add_prop(hThisClass,'ExtModeTransport','slint');
    hThisProp.FactoryValue=0;

    hThisProp=add_prop(hThisClass,'ExtModeStaticAlloc','slbool');
    hThisProp.FactoryValue='off';

    hThisProp=add_prop(hThisClass,'ExtModeStaticAllocSize','slint');
    hThisProp.FactoryValue=1000000;

    hThisProp=add_prop(hThisClass,'ExtModeTesting','slbool');
    hThisProp.FactoryValue='off';
    ...
    hThisProp=add_prop(hThisClass,'exportCCSObj','on/off');
    hThisProp.FactoryValue='on';

    hThisProp=add_prop(hThisClass,'ccsObjName','string');
