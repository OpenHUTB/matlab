classdef RealPartialSystolicQRMatrixSolve<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealPartialSystolicQRMatrixSolve(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Partial-Systolic Matrix Solve Using QR Decomposition block',...
            'HelpText','HDL will be emitted for the Real Partial-Systolic Matrix Solve Using QR Decomposition block');
