classdef RealPartialSystolicQR<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealPartialSystolicQR(block)





            blockName='Real Partial-Systolic QR Decomposition';
