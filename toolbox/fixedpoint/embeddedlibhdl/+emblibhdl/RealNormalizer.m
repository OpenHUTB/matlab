classdef RealNormalizer<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealNormalizer(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Normalizer HDL Optimized block',...
            'HelpText','HDL will be emitted for the Real Normalizer HDL Optimized block');
