classdef RealBurstQlessQRWholeROutput<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealBurstQlessQRWholeROutput(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Burst Q-less QR Decomposition Whole R Output block',...
            'HelpText','HDL will be emitted for the Real Burst Q-less QR Decomposition Whole R Output block');
