classdef RealPartialSystolicQlessQRMatrixSolve<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealPartialSystolicQlessQRMatrixSolve(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Partial-Systolic Matrix Solve Using Q-less QR Decomposition block',...
            'HelpText','HDL will be emitted for the Real Partial-Systolic Matrix Solve Using Q-less QR Decomposition block');
