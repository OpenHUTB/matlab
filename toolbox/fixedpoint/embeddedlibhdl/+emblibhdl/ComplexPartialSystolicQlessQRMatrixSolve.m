classdef ComplexPartialSystolicQlessQRMatrixSolve<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=ComplexPartialSystolicQlessQRMatrixSolve(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Complex Partial-Systolic Matrix Solve Using Q-less QR Decomposition block',...
            'HelpText','HDL will be emitted for the Complex Partial-Systolic Matrix Solve Using Q-less QR Decomposition block');
