classdef ComplexDivide<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=ComplexDivide(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Complex Divide HDL Optimized block',...
            'HelpText','HDL will be emitted for the Complex Divide HDL Optimized block');
