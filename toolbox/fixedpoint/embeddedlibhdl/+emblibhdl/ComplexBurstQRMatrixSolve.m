classdef ComplexBurstQRMatrixSolve<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=ComplexBurstQRMatrixSolve(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Complex Burst Matrix Solve Using QR Decomposition block',...
            'HelpText','HDL will be emitted for the Complex Burst Matrix Solve Using QR Decomposition block');
