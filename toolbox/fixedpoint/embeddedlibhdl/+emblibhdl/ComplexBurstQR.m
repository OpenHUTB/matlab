classdef ComplexBurstQR<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=ComplexBurstQR(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Complex Burst QR Decomposition block',...
            'HelpText','HDL will be emitted for the Complex Burst QR Decomposition block');
