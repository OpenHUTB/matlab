classdef ComplexBurstQlessQR<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=ComplexBurstQlessQR(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Complex Burst Q-less QR Decomposition block',...
            'HelpText','HDL will be emitted for the Complex Burst Q-less QR Decomposition block');
