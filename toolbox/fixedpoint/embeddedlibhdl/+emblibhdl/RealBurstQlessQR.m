classdef RealBurstQlessQR<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealBurstQlessQR(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Burst Q-less QR Decomposition block',...
            'HelpText','HDL will be emitted for the Real Burst Q-less QR Decomposition block');
