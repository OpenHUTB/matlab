classdef RealReciprocal<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealReciprocal(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Reciprocal HDL Optimized block',...
            'HelpText','HDL will be emitted for the Real Reciprocal HDL Optimized block');
