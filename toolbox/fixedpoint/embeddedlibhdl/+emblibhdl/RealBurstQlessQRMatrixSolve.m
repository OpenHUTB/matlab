classdef RealBurstQlessQRMatrixSolve<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealBurstQlessQRMatrixSolve(block)
            ...
            'HelpText','HDL will be emitted for the Real Burst Matrix Solve Using Q-less QR Decomposition block');
