classdef ComplexPartialSystolicQlessQRMatrixSolveWithForgettingFactor<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=ComplexPartialSystolicQlessQRMatrixSolveWithForgettingFactor(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Complex Partial-Systolic Matrix Solve Using Q-less QR Decomposition block with Forgetting Factor',...
            'HelpText','HDL will be emitted for the Complex Partial-Systolic Matrix Solve Using Q-less QR Decomposition block with Forgetting Factor');
