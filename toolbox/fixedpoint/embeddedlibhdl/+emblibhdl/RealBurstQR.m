classdef RealBurstQR<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealBurstQR(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Burst QR Decomposition block',...
            'HelpText','HDL will be emitted for the Real Burst QR Decomposition block');
