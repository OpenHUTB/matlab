classdef RealBurstAsynchronousQlessQRMatrixSolve<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealBurstAsynchronousQlessQRMatrixSolve(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Burst Matrix Solve Using Q-less QR Decomposition block',...
            'HelpText','HDL will be emitted for the Real Burst Asynchronous Matrix Solve Using Q-less QR Decomposition block');
