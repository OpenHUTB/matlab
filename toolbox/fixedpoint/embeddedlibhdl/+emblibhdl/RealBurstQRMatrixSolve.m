classdef RealBurstQRMatrixSolve<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealBurstQRMatrixSolve(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Burst Matrix Solve Using QR Decomposition block',...
            'HelpText','HDL will be emitted for the Real Burst Matrix Solve Using QR Decomposition block');
