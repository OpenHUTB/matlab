classdef ComplexBurstQlessQRWholeROutput<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=ComplexBurstQlessQRWholeROutput(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Complex Burst Q-less QR Decomposition Whole R Output block',...
            'HelpText','HDL will be emitted for the Complex Burst Q-less QR Decomposition Whole R Output block');
