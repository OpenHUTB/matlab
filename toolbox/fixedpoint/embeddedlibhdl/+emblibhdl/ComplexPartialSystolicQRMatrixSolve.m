classdef ComplexPartialSystolicQRMatrixSolve<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=ComplexPartialSystolicQRMatrixSolve(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Complex Partial-Systolic Matrix Solve Using QR Decomposition block',...
            'HelpText','HDL will be emitted for the Complex Partial-Systolic Matrix Solve Using QR Decomposition block');
