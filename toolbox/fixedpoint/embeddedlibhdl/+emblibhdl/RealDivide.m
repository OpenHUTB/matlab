classdef RealDivide<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealDivide(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Divide HDL Optimized block',...
            'HelpText','HDL will be emitted for the Real Divide HDL Optimized block');
