classdef PositiveRealNormalizer<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=PositiveRealNormalizer(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Positive Real Normalizer HDL Optimized block',...
            'HelpText','HDL will be emitted for the Positive Real Normalizer HDL Optimized block');
