classdef ComplexBurstQlessQRMatrixSolve<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=ComplexBurstQlessQRMatrixSolve(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Complex Burst Matrix Solve Using Q-less QR Decomposition block',...
            'HelpText','HDL will be emitted for the Complex Burst Matrix Solve Using Q-less QR Decomposition block');
