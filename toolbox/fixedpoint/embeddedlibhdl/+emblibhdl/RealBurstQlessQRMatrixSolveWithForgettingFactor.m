classdef RealBurstQlessQRMatrixSolveWithForgettingFactor<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=RealBurstQlessQRMatrixSolveWithForgettingFactor(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Real Burst Matrix Solve Using Q-less QR Decomposition with Forgetting Factor block',...
            'HelpText','HDL will be emitted for the Real Burst Matrix Solve Using Q-less QR Decomposition with Forgetting Factor block');
