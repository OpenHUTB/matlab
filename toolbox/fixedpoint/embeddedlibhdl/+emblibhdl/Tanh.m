classdef Tanh<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=Tanh(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Hyperbolic Tangent HDL Optimized block',...
            'HelpText','HDL will be emitted for the Hyperbolic Tangent HDL Optimized block');
