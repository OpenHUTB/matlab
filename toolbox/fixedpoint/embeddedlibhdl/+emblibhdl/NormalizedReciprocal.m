classdef NormalizedReciprocal<hdlimplbase.HDLRecurseIntoSubsystem
    ...
    methods
        function this=NormalizedReciprocal(block)
            ...
            desc=struct('ShortListing','Generate HDL Code for the Normalized Reciprocal HDL Optimized block',...
            'HelpText','HDL will be emitted for the Normalized Reciprocal HDL Optimized block');
