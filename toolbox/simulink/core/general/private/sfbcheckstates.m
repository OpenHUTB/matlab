...
NumPWorks = ad.SfunBuilderWidgets.fNumPWork;
NumPWorks = char( NumPWorks.getText );
ad.SfunWizardData.NumberOfPWorks = NumPWorks;

NumDWorks = ad.SfunBuilderWidgets.fNumDWork;
NumDWorks = char( NumDWorks.getText );
ad.SfunWizardData.NumberOfDWorks = NumDWorks;
...
% Decoded using De-pcode utility v1.2 from file /tmp/tmpX4lblP.p.
