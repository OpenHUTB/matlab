classdef InterfaceMappingInportPropertySchema<Simulink.InterfaceMappingPropertySchema
    ...
    methods
        function this=InterfaceMappingInportPropertySchema(h)
            this.Source=h;
        end
            ...
            case 'Simulink:studio:DataViewPerspective_CodeGen'
                ...
                if strcmp(target,'CoderDictionary')||strcmp(target,'SimulinkCoderCTarget')
                    if strcmp(target,'CoderDictionary')&&mapping.isFunctionPlatform&&...
                        ...
                        props{end+1}=DAStudio.message('coderdictionary:mapping:ReadServiceColumnName');
                    else
                ...
                elseif strcmp(target,'CppModelMapping')
                    if slfeature('CppIOCustomization')==1
                        ...
                        props{end+1}=DAStudio.message('coderdictionary:mapping:ReaderXMLTagLabel');
                        props{end+1}=DAStudio.message('coderdictionary:mapping:ReaderQoSLabel');
                ...
                if isa(obj.Source,'DataView')
                    ...
                    if~strcmp(target,'CppModelMapping')||...
                        (strcmp(target,'CppModelMapping')&&...
                        strcmp(mapping.DeploymentType,'Application')&&...
                        slfeature('DDSCodeMappingsQuickEditor')>0)
