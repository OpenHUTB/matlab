classdef InterfaceHDLMappingOutportPropertySchema<Simulink.InterfaceMappingPropertySchema
    ...
    methods
        function this=InterfaceHDLMappingOutportPropertySchema(h)
            this.Source=h;
        end
        ...
        function props=getPerInstanceProperties(obj,perspective)
            ...
            if strcmp(perspective,'Simulink:studio:DataViewPerspective_CodeGen')
                ...
                props=hdlcoder.mapping.internal.ui.getPerInstancePropertyList(blockH,1);
            end
        end
