classdef ConfigurationParametersRightClickBuildExportFunction<Simulink.ModelReference.Conversion.ConfigurationParameters
    methods(Access=public)
        function this=ConfigurationParametersRightClickBuildExportFunction(ActiveConfigSet,ConversionData,currentSubsystem,modelRefHandle,isCopyContent)
    ...
    methods(Access=protected)
        ...
        function copySolverInfoImpl(this)
            Simulink.ModelReference.Conversion.CopySolverInfoForExportedFcn(this.currentSubsystem,this.modelRefHandle,this.isCopyContent);
        end
