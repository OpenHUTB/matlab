function slddShowChanges_refdelete( filename, ref_name, ref_key, report_id )
...
ddConn.removeReference( ref_name );
ddConn.close(  );
...
% Decoded using De-pcode utility v1.2 from file /tmp/tmpw5IYTy.p.
