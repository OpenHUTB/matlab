function addonStruct=TransformsDialogSchema(group)
    ...
    introductionStr4.Name=strcat('<b>',DAStudio.message('sl_pir_cpp:creator:TransformDesc'),'<\b>');
    ...
    usingPAGroupItems=[{introductionStr4,introductionStr5,introductionStr6,spacer2}];
    usingPAGroupItems=[usingPAGroupItems,{spacer3,spacer4,introductionStr9,runallButton}];
