classdef ArrayOfBus<starepository.ioitem.Container&starepository.ioitem.DataSetChild
...
LoggedName
    ...
    methods
        function obj=ArrayOfBus(ListItems,BusName)
        ...
        function metaData=getMetaData(obj)
            ...
            if obj.isLogged
                dataFormatStr=[dataFormatStr,'loggedsignal:aobbusstructure'];
                ...
                dataFormatStr=[dataFormatStr,'aobbusstructure'];
