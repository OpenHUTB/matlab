function setProperties(data,widgetId,model,isLibWidget,isSlimDialog)
    ...
    if isa(dlgSrc,'hmiblockdlg.RadioButtonGroup')
        hmiblockdlg.RadioButtonGroup.setProperties(data,widgetId,model,isLibWidget,isSlimDialog);
        return
    elseif isa(dlgSrc,'hmiblockdlg.ComboBox')
        hmiblockdlg.ComboBox.setProperties(data,widgetId,model,isLibWidget,isSlimDialog);
        return
    end
