...
HelpArgs
    ...
    methods(Access=public)
        function obj=Gui(env,ID,guiTag,title)
            ...
            obj.Title=title;
            obj.Tag=guiTag;
            webfolder='/toolbox/simulink/sl_interface_dict/migrator/+sl/+interface/+dict/+migrator/web/';
        ...
        function dlgstruct=getDialogSchema(obj,~)
            ...
            dlgstruct.CloseCallback='sl.interface.dict.migrator.base.Gui.closeCallBack';
    ...
    methods(Access=private)
        ...
        function launchHelp(obj)
            ...
            helpview(fullfile(docroot,'simulink','helptargets.map'),helpViewID);
        end
