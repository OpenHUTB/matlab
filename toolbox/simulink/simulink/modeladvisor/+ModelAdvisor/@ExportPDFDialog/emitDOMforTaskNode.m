function domObjs=emitDOMforTaskNode(~,taskNode,this)




    counterStructure=modeladvisorprivate('modeladvisorutil2','getNodeSummaryInfo',taskNode);
    domObjs=loc_emitDOMforTaskNode(this,taskNode,counterStructure.generateTime,1,'',0);
end
...
function resultHTML=emitDOMforLeafNode(rptObj,this,generateTime,level)
    ...
    while~strcmp(dp.CurrentHoleId,'#end#')
        ...
        case 'CheckTitle'
            ...
            if(this.RunTime~=0)&&(this.RunTime<generateTime)&&~strcmp(this.State,ModelAdvisor.CheckStatus.NotRun)
