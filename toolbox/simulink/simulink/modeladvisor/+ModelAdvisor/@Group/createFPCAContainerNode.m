...
function addonStruct=createFPCAContainerNode(this)
    addonStruct.Items={};
    ...
    row=row+1;
    Line1.Name=DAStudio.message('Simulink:tools:FPCARootMsg1');
    ...
    row=row+1;
    txt1=ModelAdvisor.Text(DAStudio.message('Simulink:tools:FPCAContainerMsg1'));
    txt2=ModelAdvisor.Text(DAStudio.message('Simulink:tools:FPCAContainerMsg2'));
    txt3=ModelAdvisor.Text(DAStudio.message('Simulink:tools:FPCAContainerMsg3'));
    list=ModelAdvisor.List;
    list.setType('numbered');
    sublist=ModelAdvisor.List;
    sublist.addItem(ModelAdvisor.Text(DAStudio.message('Simulink:tools:FPCAContainerMsg5')));
    sublist.addItem(ModelAdvisor.Text(DAStudio.message('Simulink:tools:FPCAContainerMsg6')));
    list.addItem([ModelAdvisor.Text(DAStudio.message('Simulink:tools:FPCAContainerMsg4')),sublist]);
    sublist2=ModelAdvisor.List;
    sublist2.addItem(ModelAdvisor.Text(DAStudio.message('Simulink:tools:FPCAContainerMsg8')));
    sublist2.addItem(ModelAdvisor.Text(DAStudio.message('Simulink:tools:FPCAContainerMsg9')));
    list.addItem([ModelAdvisor.Text(DAStudio.message('Simulink:tools:FPCAContainerMsg7')),sublist2]);
    list.addItem(ModelAdvisor.Text(DAStudio.message('Simulink:tools:FPCAContainerMsg10')));
    table=ModelAdvisor.Table(6,1);
    table.setBorder(0);
    table.setEntry(1,1,[txt1,ModelAdvisor.LineBreak]);
    table.setEntry(2,1,txt2);
    table.setEntry(3,1,list);
    table.setEntry(4,1,txt3);
    doc=ModelAdvisor.Document;
    doc.addItem({table});
    row=row+1;

    GeneralDescription.Text=strrep(doc.emitHTML,['<li>',ModelAdvisor.Paragraph('&nbsp;').emitHTML,'</li>'],'<p>&nbsp;</p>');
