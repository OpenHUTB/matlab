...
function addonStruct=createHDLContainerNode(this)
    ...
    row=row+1;
    Line1.Name=DAStudio.message('HDLShared:hdldialog:HDLWARootMsg1');
    ...
    row=row+1;
    txt1=ModelAdvisor.Text(DAStudio.message('HDLShared:hdldialog:HDLWAContainerMsg1'));
    txt2=ModelAdvisor.Text(DAStudio.message('HDLShared:hdldialog:HDLWAContainerMsg2'));
    ...
    curRow=curRow+1;
    R2FInProgree.Name=DAStudio.message('Simulink:tools:MAInProgress',['"',DAStudio.message('Simulink:tools:MARunAll'),'"']);
