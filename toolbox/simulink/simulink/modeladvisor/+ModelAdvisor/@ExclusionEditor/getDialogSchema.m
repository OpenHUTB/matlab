function dlg=getDialogSchema(this,~)
    ...
    dlg.DialogTag='ModelAdvisorExclusionEditor';
    dlg.DialogTitle=DAStudio.message('ModelAdvisor:engine:ModelAdvisorExclusionEditor');
    dlg.PostApplyMethod='postApply';
    dlg.DialogRefresh=true;
    dlg.HelpMethod='helpview';
    dlg.HelpArgs={fullfile(docroot,'slcheck','helptargets.map'),'MAExclusion_GUI_Help'};
