classdef BlockNamePosition<edittime.Violation

    methods
        function self=BlockNamePosition(system,blkHandle,checkID)
        ...
        function createDiagnostic(obj)
            obj.diagnostic=MSLDiagnostic(message('sledittimecheck:edittimecheck:BlockNamePosition',...
