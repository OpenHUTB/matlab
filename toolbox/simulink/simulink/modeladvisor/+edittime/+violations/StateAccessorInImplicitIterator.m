classdef StateAccessorInImplicitIterator<edittime.Violation
    methods
        function self=StateAccessorInImplicitIterator(system,blkHandle,checkID)
        ...
        function createDiagnostic(obj)
            obj.diagnostic=MSLDiagnostic(message('sledittimecheck:edittimecheck:StateAccessorInImplicitIterator'));
            cause=MSLDiagnostic(message('sledittimecheck:edittimecheck:StateAccessorInImplicitIterator_Cause'));
