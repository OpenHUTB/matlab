function Result=CheckIfNeedOptimalSolverResetCausedByZcFix(taskobj)
    ...
    baseline.check.name=DAStudio.message('SimulinkPerformanceAdvisor:advisor:CheckIfNeedOptimalSolverResetCausedByZcTitle');
    ...
    oldSettings=get_param(model,'OptimalSolverResetCausedByZc');
    ...
    set_param(model,'OptimalSolverResetCausedByZc',newSettings);
    result_text1=ModelAdvisor.LineBreak;
    result_text=ModelAdvisor.Text(DAStudio.message('SimulinkPerformanceAdvisor:advisor:CheckIfNeedOptimalSolverResetCausedByZcChangeConfirmed',oldSettings,newSettings));
...
function Result=UndoFix(model,oldSettings,Failed)
    ...
    set_param(model,'OptimalSolverResetCausedByZc',oldSettings);

    text=ModelAdvisor.Text([Failed.emitHTML,DAStudio.message('SimulinkPerformanceAdvisor:advisor:CheckIfNeedOptimalSolverResetCausedByZcNotChanged',oldSettings)]);
