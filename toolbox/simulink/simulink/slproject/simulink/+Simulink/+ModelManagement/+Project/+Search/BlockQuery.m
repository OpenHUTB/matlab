classdef BlockQuery<Simulink.ModelManagement.Project.Search.AbstractQuery
...
function query=i_createValueQuery
    query=Simulink.loadsave.Query('//System/Block/*');
end

function query=i_createPathQuery
    query=i_createValueQuery;
    query.Modifier=Simulink.loadsave.Modifier.BlockPath;
end
