function result=actionUpdateCompileBlocks(taskobj)
    ...
    updateInfo=ModelUpdater.update(model,'OperatingMode','AnalyzeCompiled');
    blkList1=updateInfo.blockList;

    ModelUpdater.update(model,'prompt',0,'OperatingMode','updateCompiled');
