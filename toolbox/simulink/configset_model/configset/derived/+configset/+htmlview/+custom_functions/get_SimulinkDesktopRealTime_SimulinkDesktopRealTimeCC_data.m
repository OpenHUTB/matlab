...
function[params,groups,FC]=get_SimulinkDesktopRealTime_SimulinkDesktopRealTimeCC_data(cs)

    mcs=configset.internal.getConfigSetStaticData;
    mcc=mcs.getComponent('SimulinkDesktopRealTime.SimulinkDesktopRealTimeCC');
    ...
    if compStatus<3
        ...
        p_widgets{1}={};
        params{end+1}={95,{'widgets',p_widgets}};
    end
