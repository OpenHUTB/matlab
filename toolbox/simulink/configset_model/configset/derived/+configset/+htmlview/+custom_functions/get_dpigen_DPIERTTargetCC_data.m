...
function[params,groups,FC]=get_dpigen_DPIERTTargetCC_data(cs)

    mcs=configset.internal.getConfigSetStaticData;
    mcc=mcs.getComponent('dpigen.DPIERTTargetCC');
    ...
    if compStatus<3
        ...
        p_widgets{1}={{'options',w_options}};
        params{end+1}={105,{'st',p_st},{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{1}={};
        params{end+1}={111,{'st',p_st},{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{3}={{'st',w_st}};
        params{end+1}={127,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{3}={{'st',w_st}};
        params{end+1}={128,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={162,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={190,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={195,{'options',p_options},{'st',p_st}};
    end
