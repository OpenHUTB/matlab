...
function[params,groups,FC]=get_MDX_MDXTargetCC_data(cs)
    ...
    if compStatus<3
        ...
        params{end+1}={96,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={97,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={98,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={100,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={101,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={102,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={103,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={104,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={105,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={106,{'options',p_options}};
    end
    ...
    if compStatus<3
        p_options=configset.internal.util.convertToOptions(configset.internal.custom.coderGroupNameList(cs,'GroupModelData'));
        params{end+1}={107,{'options',p_options}};
    end
    ...
    if compStatus<3
        p_options=configset.internal.util.convertToOptions(configset.internal.custom.coderGroupNameList(cs,'GroupParameters'));
        params{end+1}={108,{'options',p_options}};
    end
    ...
    if compStatus<3
        p_options=configset.internal.util.convertToOptions(configset.internal.custom.coderGroupNameList(cs,'GroupConstants'));
        params{end+1}={109,{'options',p_options}};
    end
    ...
    if compStatus<3
        p_options=configset.internal.util.convertToOptions(configset.internal.custom.coderGroupNameList(cs,'GroupRootInputs'));
        params{end+1}={110,{'options',p_options}};
    end
    ...
    if compStatus<3
        p_options=configset.internal.util.convertToOptions(configset.internal.custom.coderGroupNameList(cs,'GroupRootOutputs'));
        params{end+1}={111,{'options',p_options}};
    end
    ...
    if compStatus<3
        p_options=configset.internal.util.convertToOptions(configset.internal.custom.coderGroupNameList(cs,'GroupInternal'));
        params{end+1}={112,{'options',p_options}};
    end
    ...
    if compStatus<3
        p_options=configset.internal.util.convertToOptions(configset.internal.custom.coderGroupNameList(cs,'GroupInstanceSpecificParameters'));
        params{end+1}={113,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{1}={{'options',w_options}};
        params{end+1}={119,{'st',p_st},{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{1}={};
        params{end+1}={125,{'st',p_st},{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{1}={};
        params{end+1}={133,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={198,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={199,{'options',p_options},{'st',p_st}};
    end
