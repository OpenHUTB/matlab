...
function[params,groups,FC]=get_AUTOSAR_AUTOSARAdaptiveTargetCC_data(cs)

    mcs=configset.internal.getConfigSetStaticData;
    mcc=mcs.getComponent('AUTOSAR.AUTOSARAdaptiveTargetCC');
    ...
    if compStatus<3
        ...
        p_widgets{1}={{'options',w_options}};
        params{end+1}={101,{'st',p_st},{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{1}={};
        params{end+1}={107,{'st',p_st},{'widgets',p_widgets}};
    end
