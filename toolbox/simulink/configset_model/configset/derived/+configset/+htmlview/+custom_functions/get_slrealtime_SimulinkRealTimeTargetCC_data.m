...
function[params,groups,FC]=get_slrealtime_SimulinkRealTimeTargetCC_data(cs)

    mcs=configset.internal.getConfigSetStaticData;
    mcc=mcs.getComponent('slrealtime.SimulinkRealTimeTargetCC');
    ...
    if compStatus<3
        ...
        p_widgets{1}={{'options',w_options}};
        params{end+1}={104,{'st',p_st},{'widgets',p_widgets}};
    end
