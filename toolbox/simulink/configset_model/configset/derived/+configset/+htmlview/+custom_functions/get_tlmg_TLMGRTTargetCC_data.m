...
function[params,groups,FC]=get_tlmg_TLMGRTTargetCC_data(cs)

    mcs=configset.internal.getConfigSetStaticData;
    mcc=mcs.getComponent('tlmg.TLMGRTTargetCC');
    ...
    if compStatus<3
        ...
        p_widgets{1}={{'options',w_options}};
        params{end+1}={156,{'st',p_st},{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{1}={};
        params{end+1}={157,{'st',p_st},{'widgets',p_widgets}};
    end
