...
function[params,groups,FC]=get_SimulinkRealTime_SimulinkRealTimeERTCC_data(cs)

    mcs=configset.internal.getConfigSetStaticData;
    mcc=mcs.getComponent('SimulinkRealTime.SimulinkRealTimeERTCC');
    ...
    if compStatus<3
        p_options=configset.internal.util.convertToOptions(configset.internal.custom.slrt_xPCIRQSourceBoardEnum_entries(cs,'xPCIRQSourceBoard'));
        params{end+1}={99,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{1}={{'options',w_options}};
        params{end+1}={120,{'st',p_st},{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{1}={};
        params{end+1}={126,{'st',p_st},{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{1}={};
        params{end+1}={134,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{3}={{'st',w_st}};
        params{end+1}={143,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{3}={{'st',w_st}};
        params{end+1}={146,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={174,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={193,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={194,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={195,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={196,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={197,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={200,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={201,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={202,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={203,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={204,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={205,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={206,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={207,{'options',p_options},{'st',p_st}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={208,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={209,{'options',p_options}};
    end
