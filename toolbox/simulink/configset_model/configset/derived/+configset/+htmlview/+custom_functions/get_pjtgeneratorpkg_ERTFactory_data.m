...
function[params,groups,FC]=get_pjtgeneratorpkg_ERTFactory_data(cs)

    mcs=configset.internal.getConfigSetStaticData;
    mcc=mcs.getComponent('pjtgeneratorpkg.ERTFactory');
    ...
    if compStatus<3
        ...
        p_widgets{1}={{'options',w_options}};
        params{end+1}={93,{'st',p_st},{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{1}={};
        params{end+1}={99,{'st',p_st},{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{3}={{'st',w_st}};
        params{end+1}={115,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{3}={{'st',w_st}};
        params{end+1}={116,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{3}={{'st',w_st}};
        params{end+1}={117,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{3}={{'st',w_st}};
        params{end+1}={118,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        p_widgets{3}={{'st',w_st}};
        params{end+1}={119,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={150,{'widgets',p_widgets}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={167,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={168,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={169,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={170,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={171,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={172,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={173,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={181,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={182,{'options',p_options}};
    end
    ...
    if compStatus<3
        ...
        params{end+1}={183,{'options',p_options},{'st',p_st}};
    end
    ...
    g_schema=configset.layout.custom.getIDELinkUpgradeWidget(cs,'web');
    groups{end+1}={'CoderTarget:ToolChainAutomationTab',{'schema',g_schema}};
