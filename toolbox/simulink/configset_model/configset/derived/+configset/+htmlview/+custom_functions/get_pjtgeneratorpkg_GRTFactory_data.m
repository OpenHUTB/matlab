...
function[params,groups,FC]=get_pjtgeneratorpkg_GRTFactory_data(cs)

    mcs=configset.internal.getConfigSetStaticData;
    mcc=mcs.getComponent('pjtgeneratorpkg.GRTFactory');
    ...
    if compStatus<3
        ...
        p_widgets{1}={};
        params{end+1}={100,{'st',p_st},{'widgets',p_widgets}};
    end
