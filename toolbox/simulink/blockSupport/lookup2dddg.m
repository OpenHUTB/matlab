function dlgStruct=lookup2dddg(source,h)
    ...
    dataTypeItems.inheritRules=Simulink.DataTypePrmWidget.getInheritList('BP_In1');
    ...
    rowValues=start_property(h,'RowIndex');
    rowValues.Type='edit';
    rowValues.RowSpan=[rowIdx,rowIdx];
    ...
    colValues=start_property(h,'ColumnIndex');
    colValues.Type='edit';
    colValues.RowSpan=[rowIdx,rowIdx];
    ...
    inputSameDT=start_property(h,'InputSameDT');
    inputSameDT.Type='checkbox';
    inputSameDT.RowSpan=[rowIdx,rowIdx];
    inputSameDT.ColSpan=[1,2];
    ...
    dataTab.Items={outMin,outMax,inputSameDT,dataTypeGroup,lockOutScale,round,saturate,spacer};
