...
classdef TruthTableObject<slci.results.StateflowObject
    ...
    methods(Access=public,Hidden=true)
        ...
        function obj=TruthTableObject(aSID,aParent,aName)
            if nargin==0
                DAStudio.error('Slci:results:DefaultConstructorError',...
                'TRUTHTABLEOBJECT');
            end
            aKey=slci.results.TruthTableObject.constructKey(aSID);
