...
function deleteJustificationCommentFromJson(obj,data)
    try
        answer=questdlg(...
        ...
        case 'Yes'
            ...
            if strcmpi(data.dataFor,'codeSliceGrid')
                ...
                modelManager.deleteJustification(data.BlockSID);
            end
