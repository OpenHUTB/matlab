function showMessageDialogWithAdditionalMessage(this,parentFrame,messageDialogParameterName,messageToAppend,userData,cbFcn)
    ...
    dialog=com.mathworks.toolbox.imaq.browser.dialogs.MessageDialog(parentFrame,params,userData,messageToAppend);
