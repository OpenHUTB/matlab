classdef PortExtendedTableSource<hdllinkddg.TableSource
    ...
    methods
        function this=PortExtendedTableSource(tableName,srcData)
            ...
            this.colPos=hdllinkddg.PortExtendedRowSource.getColumnPositionStruct();
            this.colName=hdllinkddg.PortExtendedRowSource.getColumnOrder();
