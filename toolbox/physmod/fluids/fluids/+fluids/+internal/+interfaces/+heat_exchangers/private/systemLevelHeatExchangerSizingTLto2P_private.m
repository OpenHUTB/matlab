...
function[geometry_2P,geometry_TL,Q_seg_calc,h_nodes_2P,T_nodes_2P,u_nodes_2P,...
    ...
    =systemLevelHeatExchangerSizingTLto2P_private(flow_arrangement,Q_nom,...
...
%#codegen
    ...
    if T_in_TL<=T_in_2P
        exitflag=-10;
        return
    elseif T_seg_TL<=T_seg_2P
        exitflag=-20;
        return
    end


    UA_overall=Q_nom/(T_seg_TL-T_seg_2P);
...
function[residual,Q_seg_calc,h_out_2P,T_out_2P,wgt_liq_seg_2P,wgt_vap_seg_2P,wgt_mix_seg_2P,...
    ...
    Q_seg_calc=UA_seg_overall*(T_seg_TL-T_seg_2P);
