function varargout=grid_surface(varargin)
    ...
    if isempty(BlockInfoCache)
        className=pm_message('mech2:gridSurface:parameters:className:Value');
        ...
        pm_message('sm:library:curvesSurfaces:gridSurface:Name');
