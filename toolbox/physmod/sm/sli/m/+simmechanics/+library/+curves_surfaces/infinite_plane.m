function varargout=infinite_plane(varargin)
    ...
    if isempty(BlockInfoCache)
        className=pm_message('mech2:infinitePlane:parameters:className:Value');
        ...
        pm_message('sm:library:curvesSurfaces:infinitePlane:Name');
