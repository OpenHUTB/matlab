function varargout=magic_formula_tire_force_torque(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:forcesAndTorques:magicFormulaTireForceTorque:Name');
        className=...
        pm_message('mech2:magicFormulaTireForceTorque:parameters:className:Value');
