function varargout=flexible_rectangular_beam(varargin)
    ...
    if isempty(BlockInfoCache)
        blockReader=simmechanics.library.helper.BlockXmlReader('flexibleRectangularBeam');
        srcFile=mfilename('fullpath');
        blkName=pm_message('sm:library:bodyElements:flexibleBodies:beams:flexibleRectangularBeam:Name');
