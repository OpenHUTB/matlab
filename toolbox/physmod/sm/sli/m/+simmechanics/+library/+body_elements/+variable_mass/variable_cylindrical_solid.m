function varargout=variable_cylindrical_solid(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:bodyElements:variableMass:variableCylindricalSolid:Name');
        ...
        BlockInfoCache.addPorts(reference_port('variableCylindricalSolidBlock'));
        ...
        pm_message('sm:model:blockNames:variableCylindricalSolidBlock:TypeId'));

        pa=simmechanics.library.helper.ParameterAccessor;
        pa.Namespace='mech2:messages:parameters:inertia:variableInertia:variableCylindricalInertia';
