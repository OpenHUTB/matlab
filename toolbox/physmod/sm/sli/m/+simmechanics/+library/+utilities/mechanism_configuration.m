function varargout=mechanism_configuration(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:utilities:mechanismConfig:Name');
        className=pm_message('mech2:mechanismConfiguration:parameters:className:Value');

        [b,mp,p]=sm_get_block_info(className);
        pNames={mp.ParamName};

        gvi=strcmp(pNames,pm_message('mech2:mechanismConfiguration:parameters:uniformGravity:values:constant:gravityVector:ParamName'));
        mp(gvi).UnitsParamName=...
        pm_message('mech2:mechanismConfiguration:parameters:uniformGravity:values:constant:gravityVector:unit:ParamName');
        ...
        sprintf('sm_lib/Utilities/Mechanism \nConfiguration'),...
        'simmechanics.library.joints.sl_postprocess');


        BlockInfoCache.setTransformationFunction(...
        'simmechanics.library.utilities.sl_postprocess',0.0,4.30);
