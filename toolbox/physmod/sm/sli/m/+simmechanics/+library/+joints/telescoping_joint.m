function varargout=telescoping_joint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:joints:telescoping:Name');
        ...
        sprintf('sm_lib/Joints/Telescoping \nJoint'),...
        ...
        pm_message('sm:model:blockNames:telescopingJoint:TypeId'));
        ...
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:telescopingJoint:sphPrimitive:Prefix'));

        maskParams=simple_primitive_params('prismatic');
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:telescopingJoint:pzPrimitive:Prefix'));
    end
