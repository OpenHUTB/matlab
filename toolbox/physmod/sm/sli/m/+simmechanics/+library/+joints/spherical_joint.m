function varargout=spherical_joint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:joints:spherical:Name');
        ...
        sprintf('sm_lib/Joints/Spherical \nJoint'),...
        ...
        pm_message('sm:model:blockNames:sphericalJoint:TypeId'));
