function varargout=prismatic_joint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:joints:prismatic:Name');
        ...
        sprintf('sm_lib/Joints/Prismatic \nJoint'),...
        ...
        pm_message('sm:model:blockNames:prismaticJoint:TypeId'));
