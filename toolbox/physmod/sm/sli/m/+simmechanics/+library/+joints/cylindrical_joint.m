function varargout=cylindrical_joint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:joints:cylindrical:Name');
        ...
        sprintf('sm_lib/Joints/Cylindrical \nJoint'),...
        ...
        pm_message('sm:model:blockNames:cylindricalJoint:TypeId'));
        ...
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:cylindricalJoint:prismaticPrimitive:Prefix'));

        maskParams=simple_primitive_params('revolute');
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:cylindricalJoint:revolutePrimitive:Prefix'));
    end
