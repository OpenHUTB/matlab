function varargout=constant_velocity_joint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:joints:constantVelocity:Name');
        ...
        BlockInfoCache.setTransformationFunction(...
        'simmechanics.library.joints.constant_velocity_joint_sl_postprocess',...
        4.82,7.32);
        ...
        pm_message('sm:model:blockNames:constantVelocityJoint:TypeId'));
        ...
        maskParams=constant_velocity_primitive_params();
        BlockInfoCache.addMaskParameters(maskParams);
    end
