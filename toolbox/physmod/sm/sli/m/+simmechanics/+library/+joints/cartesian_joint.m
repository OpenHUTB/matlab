function varargout=cartesian_joint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:joints:cartesian:Name');
        ...
        sprintf('sm_lib/Joints/Cartesian \nJoint'),...
        ...
        pm_message('sm:model:blockNames:cartesianJoint:TypeId'));
        ...
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:cartesianJoint:pxPrimitive:Prefix'));
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:cartesianJoint:pyPrimitive:Prefix'));
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:cartesianJoint:pzPrimitive:Prefix'));
