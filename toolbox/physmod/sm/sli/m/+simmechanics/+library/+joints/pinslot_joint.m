function varargout=pinslot_joint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:joints:pinSlot:Name');
        ...
        pm_message('sm:model:blockNames:pinSlotJoint:TypeId'));
        ...
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:pinSlotJoint:prismaticPrimitive:Prefix'));

        maskParams=simple_primitive_params('revolute');
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:pinSlotJoint:revolutePrimitive:Prefix'));
    end
