function varargout=rectangular_joint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:joints:rectangular:Name');
        ...
        sprintf('sm_lib/Joints/Rectangular \nJoint'),...
        ...
        pm_message('sm:model:blockNames:rectangularJoint:TypeId'));
        ...
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:rectangularJoint:pxPrimitive:Prefix'));
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:rectangularJoint:pyPrimitive:Prefix'));
    end
