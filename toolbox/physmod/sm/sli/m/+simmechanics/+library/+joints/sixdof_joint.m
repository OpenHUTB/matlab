function varargout=sixdof_joint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:joints:sixDof:Name');
        ...
        pm_message('sm:model:blockNames:sixDofJoint:TypeId'));
        ...
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:sixDofJoint:pxPrimitive:Prefix'));
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:sixDofJoint:pyPrimitive:Prefix'));
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:sixDofJoint:pzPrimitive:Prefix'));

        maskParams=spherical_primitive_params();
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:sixDofJoint:sphPrimitive:Prefix'));
    end
