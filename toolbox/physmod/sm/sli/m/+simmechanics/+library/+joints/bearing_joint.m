function varargout=bearing_joint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:joints:bearing:Name');
        ...
        pm_message('sm:model:blockNames:bearingJoint:TypeId'));
        ...
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:bearingJoint:pzPrimitive:Prefix'));

        maskParams=simple_primitive_params('revolute');
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:bearingJoint:rxPrimitive:Prefix'));
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:bearingJoint:ryPrimitive:Prefix'));
        addPrefixedParams(BlockInfoCache,maskParams,pm_message('mech2:messages:parameters:joint:bearingJoint:rzPrimitive:Prefix'));
