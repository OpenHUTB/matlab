function varargout=aiming_constraint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:constraints:aiming:Name');
        className=pm_message('mech2:aimingConstraint:parameters:className:Value');
