function varargout=point_surface_constraint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        pm_message('sm:library:constraints:pointOnSurface:Name');
        className=pm_message('mech2:pointOnSurfaceConstraint:parameters:className:Value');
