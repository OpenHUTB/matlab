function varargout=gear_belt_constraint(varargin)
    ...
    if isempty(BlockInfoCache)
        ...
        BlockInfoCache.SLBlockProperties.Name=pm_message('sm:model:blockNames:gearBeltConstraint:TypeName');
        ...
        pm_message('sm:model:blockNames:gearBeltConstraint:TypeId'));
