function WindTurbineIndGenDisplay(blockHandle)
    ...
    [wind_base,P_wind_base,speed_nom,pitch_angle]=getSPSmaskvalues(block,{'wind_base','P_wind_base','speed_nom','pitch_angle'});
    ...
    lambda_nom=str2num(get_param([block,'/Wind Turbine'],'lambda_nom'));%#ok<*ST2NM>
