function[WantBlockChoice,Ts,sps]=PLL3phInit(block,Fmin,Par_Init,ParK,TcD,MaxRateChangeFreq,FilterCutOffFreq,AGC,Ts)
    ...
    if Init
        ...
        Erreur.identifier='SpecializedPowerSystems:PLL3phBlock:ParameterError';
