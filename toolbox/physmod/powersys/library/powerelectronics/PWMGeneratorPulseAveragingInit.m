function[NumberOfPulses,NumberOfArms,Vref_PortDim,NumberOfCarriers,Kin,ADDin,...
    Pselect_Index,Pselect_PortSize,WantBlockChoice]...
    =PWMGeneratorPulseAveragingInit(GeneratorType,Ts,Fc)
    ...
    case 'Two-quadrant'
        ...
        WantBlockChoice='PWMgenPavg_123arms';
    ...
    case 'Three-level, three-phase'
        ...
        Pselect_Index=[1:12];
        Pselect_PortSize=NumberOfPulses;
        WantBlockChoice='PWMgenPavg_3Level';
    end