function hLineSeries=plotAsynchronousMachineSaturationInductance(varargin)
    ...
    case 'ee.enum.unit.pu'
        ...
        hLineSeries=plot(hAxes,f.psi,f.L_m,'-o');
        xlabel(hAxes,getString(message('physmod:ee:library:comments:utils:mask:plotAsynchronousMachineSaturationInductance:label_MagneticFluxLinkagepsi_mPu')));
        ylabel(hAxes,getString(message('physmod:ee:library:comments:utils:mask:plotAsynchronousMachineSaturationInductance:label_MagnetizingInductanceLmPu')));
        grid(hAxes,'on');
    ...
    case 'ee.enum.unit.si'
        ...
        hLineSeries=plot(hAxes,f.psi*b.psi,f.L_m*b.L,'-o');
        xlabel(hAxes,getString(message('physmod:ee:library:comments:utils:mask:plotAsynchronousMachineSaturationInductance:label_MagneticFluxLinkagepsi_mWb')));
        ylabel(hAxes,getString(message('physmod:ee:library:comments:utils:mask:plotAsynchronousMachineSaturationInductance:label_MagnetizingInductanceLmH')));
        grid(hAxes,'on');
        title(hAxes,blockName,'Interpreter','none');
