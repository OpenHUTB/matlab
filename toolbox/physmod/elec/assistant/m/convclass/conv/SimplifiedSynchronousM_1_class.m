classdef SimplifiedSynchronousM_1_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Machines/Simplified Synchronous Machine pu Units'
        NewPath='elec_conv_SimplifiedSynchronousM_1/SimplifiedSynchronousM_1'
    end
    ...
    methods
        function obj=objParamMappingDirect(obj)
            ...
            obj.NewDirectParam.R_pu=ConvClass.mapDirect(obj.OldParam.InternalRL,1);
            obj.NewDirectParam.L_pu=ConvClass.mapDirect(obj.OldParam.InternalRL,2);
        end


        function obj=SimplifiedSynchronousM_1_class(NominalParameters,InitialConditions,Mechanical,InternalRL)
            if nargin>0
