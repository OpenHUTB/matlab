classdef VoltageMeasurement_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Measurements/Voltage Measurement'
        NewPath='elec_conv_VoltageMeasurement/VoltageMeasurement'
    end
