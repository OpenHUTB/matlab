classdef Three_PhaseParallelRLCLo_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Elements/Three-Phase Parallel RLC Load'
        NewPath='elec_conv_Three_PhaseParallelRLCLo/Three_PhaseParallelRLCLo'
    end
    ...
    methods
        ...
        function obj=Three_PhaseParallelRLCLo_class(CapacitivePower)
            if nargin>0
        ...
        function obj=objDropdownMapping(obj)
            ...
            elseif ActivePowerValue~=0&&...
                InductivePowerValue~=0&&...
                CapacitivePowerValue==0
                obj.NewDropdown.component_structure_PQ='8';
                obj.NewDropdown.component_structure='8';
            elseif ActivePowerValue~=0&&...
                InductivePowerValue==0&&...
                CapacitivePowerValue~=0
                obj.NewDropdown.component_structure_PQ='9';
                obj.NewDropdown.component_structure='9';
            elseif ActivePowerValue==0&&...
                InductivePowerValue~=0&&...
                CapacitivePowerValue~=0
                obj.NewDropdown.component_structure_PQ='10';
                obj.NewDropdown.component_structure='10';
            elseif ActivePowerValue~=0&&...
                InductivePowerValue~=0&&...
                CapacitivePowerValue~=0
                obj.NewDropdown.component_structure_PQ='11';
