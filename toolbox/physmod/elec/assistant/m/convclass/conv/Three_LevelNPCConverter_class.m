classdef Three_LevelNPCConverter_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Power Electronics/Three-Level NPC Converter'
        NewPath='elec_conv_Three_LevelNPCConverter/Three_LevelNPCConverter'
    end
    ...
    methods
        ...
        function obj=Three_LevelNPCConverter_class(ModelType,Ron,Rs,Cs,Ron_Diode,Rs_Diode,Cs_Diode,Vf_Diode)
            if nargin>0
        ...
        function obj=objDropdownMapping(obj)
            ...
            otherwise
                logObj.addMessage(obj,'OptionNotSupportedNoImport','Model type','Average model (Uref-controlled)')
            end
        end
    end
