classdef PulseGenerator_Thyristor_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib_meascontrol/Pulse & Signal Generators/Pulse Generator (Thyristor, 12-Pulse)'
        NewPath='elec_conv_sl_PulseGenerator_Thyristor/PulseGenerator_Thyristor'
    end
    ...
    methods
        ...
        function obj=PulseGenerator_Thyristor_class(pwidth,Ts,Double_Pulse)
            if nargin>0
