classdef PLL_3ph__class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib_meascontrol/PLL/PLL (3ph)'
        NewPath='elec_conv_sl_PLL_3ph_/PLL_3ph_'
    end
    ...
    methods
        ...
        function obj=PLL_3ph__class(Par_Init)
            if nargin>0
