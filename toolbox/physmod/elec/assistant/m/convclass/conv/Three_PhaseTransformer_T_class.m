classdef Three_PhaseTransformer_T_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Elements/Three-Phase Transformer (Three Windings)'
        NewPath='elec_conv_Three_PhaseTransformer_T/Three_PhaseTransformer_T'
    end
    ...
    methods
        function obj=objParamMappingDirect(obj)
            ...
            obj.NewDirectParam.VRated3=ConvClass.mapDirect(obj.OldParam.Winding3,1);
        ...
        function obj=Three_PhaseTransformer_T_class(Winding1Connection,Winding2Connection,Winding3Connection,...
            UNITS,NominalPower,Winding1,Winding2,Winding3,Rm,Lm,L0,...
        ...
        function obj=objParamMappingDerived(obj)
            ...
            case 'Delta (D1)'
                xWinding3Connection=ee.enum.Connection.delta1;
            case 'Delta (D11)'
                xWinding3Connection=ee.enum.Connection.delta11;
            otherwise
            ...
            case 'pu'
                ...
                if obj.OldParam.Winding3(2)==0
                    ...
                    obj.NewDerivedParam.pu_Rw3=obj.OldParam.Winding3(2);
                end

                if obj.OldParam.Winding3(3)==0
                    obj.NewDerivedParam.pu_Xl3=1e-6;
                else
                    obj.NewDerivedParam.pu_Xl3=obj.OldParam.Winding3(3);
                end
            ...
            case 'SI'
                ...
                if obj.OldParam.Winding3(2)==0
                    ...
                    obj.NewDerivedParam.pu_Rw3=obj.OldParam.Winding3(2)/b.winding(3).R;
                end

                if obj.OldParam.Winding3(3)==0
                    obj.NewDerivedParam.pu_Xl3=1e-6;
                else
                    obj.NewDerivedParam.pu_Xl3=obj.OldParam.Winding3(3)/b.winding(3).L;
                end
