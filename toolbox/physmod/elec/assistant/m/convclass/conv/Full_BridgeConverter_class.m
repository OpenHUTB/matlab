classdef Full_BridgeConverter_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Power Electronics/Full-Bridge Converter'
        NewPath='elec_conv_Full_BridgeConverter/Full_BridgeConverter'
    end
    ...
    methods
        ...
        function obj=Full_BridgeConverter_class(ModelType,Ron,Rs,Cs,Ron_Diode,Rs_Diode,Cs_Diode,Vf_Diode)
            if nargin>0
