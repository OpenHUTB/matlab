classdef BoostConverter_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Power Electronics/Boost Converter'
        NewPath='elec_conv_BoostConverter/BoostConverter'
    end
    ...
    methods
        ...
        function obj=BoostConverter_class(ModelType,Ron,Rs,Cs,Vforward,Ron_Diode,Rs_Diode,Cs_Diode,Vf_Diode)
            if nargin>0
                obj.OldDropdown.ModelType=ModelType;
                obj.OldParam.Ron=Ron;
                obj.OldParam.Rs=Rs;
                obj.OldParam.Cs=Cs;
                obj.OldParam.Vforward=Vforward;
        ...
        function obj=objParamMappingDerived(obj)
            ...
            if strcmp(obj.OldDropdown.ModelType,'Switching devices')
                obj.NewDerivedParam.IGBT_Vf=max(obj.OldParam.Vforward(1),1e-3);
                obj.NewDerivedParam.diode_Vf=max(obj.OldParam.Vforward(2),1e-3);
