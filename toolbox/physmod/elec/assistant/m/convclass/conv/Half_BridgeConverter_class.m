classdef Half_BridgeConverter_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Power Electronics/Half-Bridge Converter'
        NewPath='elec_conv_Half_BridgeConverter/Half_BridgeConverter'
    end
    ...
    methods
        ...
        function obj=Half_BridgeConverter_class(ModelType,Ron,Rs,Cs,Ron_Diode,Rs_Diode,Cs_Diode,Vf_Diode)
            if nargin>0
