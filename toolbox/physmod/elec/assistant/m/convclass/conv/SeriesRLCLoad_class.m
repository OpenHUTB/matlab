classdef SeriesRLCLoad_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Elements/Series RLC Load'
        NewPath='elec_conv_SeriesRLCLoad/SeriesRLCLoad'
    end
    ...
    methods
        ...
        function obj=SeriesRLCLoad_class(ActivePower,NominalFrequency,NominalVoltage,InductivePower,CapacitivePower)
            if nargin>0
        ...
        function obj=objParamMappingDerived(obj)
            ...
            obj.NewDerivedParam.R=(P*VRated^2)/(P^2+Qneg^2+2*Qneg*Qpos+Qpos^2);
            obj.NewDerivedParam.l=(Qpos*VRated^2)/(w*(P^2+Qneg^2+2*Qneg*Qpos+Qpos^2));
            obj.NewDerivedParam.c=-(P^2+Qneg^2+2*Qneg*Qpos+Qpos^2)/(Qneg*VRated^2*w);
