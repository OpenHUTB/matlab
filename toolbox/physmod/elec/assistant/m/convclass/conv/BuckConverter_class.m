classdef BuckConverter_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Power Electronics/Buck Converter'
        NewPath='elec_conv_BuckConverter/BuckConverter'
    end
    ...
    methods
        ...
        function obj=BuckConverter_class(ModelType,Ron,Rs,Cs,Vforward,Ron_Diode,Rs_Diode,Cs_Diode,Vf_Diode)
            if nargin>0
