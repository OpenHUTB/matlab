classdef DetailedThyristor_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Power Electronics/Detailed Thyristor'
        NewPath='elec_conv_DetailedThyristor/DetailedThyristor'
    end
    ...
    methods
        ...
        function obj=DetailedThyristor_class(Ron,Rs,Cs,Vf)
            if nargin>0
        ...
        function obj=objDropdownMapping(obj)
            ...
            logObj.addMessage(obj,'CustomMessage','Latching current Il (A) not imported');
            logObj.addMessage(obj,'CustomMessage','Turn-off time Tq (s) not imported');
