classdef Full_BridgeMMC_class<ConvClass&handle
    ...
    properties(Constant)
        OldPath='powerlib/Power Electronics/Full-Bridge MMC'
        NewPath='elec_conv_Full_BridgeMMC/Full_BridgeMMC'
    end
    ...
    methods
        ...
        function obj=Full_BridgeMMC_class(ModelType,C,Vc_Initial,Ron,Rs,Cs,Ron_Diode,Rs_Diode,Cs_Diode,Vf_Diode)
            if nargin>0
