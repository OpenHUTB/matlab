    ...
    methods
        function this=spiceCCCS(str)
            ...
            if nargin<1
                ...
                str=string(str);
                if length(str)>1
                    pm_error('physmod:ee:library:TooMany',getString(message('physmod:ee:library:comments:spice2ssc:spiceCCCS:error_InputStringsToSpiceCCCS')));
                end
                ...
                if~strncmpi(this.name,this.id,1)
                    pm_warning('physmod:ee:spice2ssc:UnexpectedComponentIdentifier',this.id,getString(message('physmod:ee:library:comments:spice2ssc:spiceCCCS:warning_CurrentcontrolledCurrentSource')),this.name);
                end
                    ...
                    elseif polyControlled
                        ...
                        for ii=1:numAmmeters
                            ...
                            if~strncmpi(controlAmmeters(ii),'v',1)
                                pm_error('physmod:ee:spice2ssc:UnexpectedComponentIdentifier','V',getString(message('physmod:ee:library:comments:spice2ssc:spiceCCCS:error_CurrentmeasuringVoltageSource')),controlAmmeters(ii));
                            end
                        end
                    ...
                    elseif tableControlled
                        ...
                        elseif pdex==5
                            ...
                            if~strncmpi(controlcomponent,'v',1)
                                pm_warning('physmod:ee:spice2ssc:UnexpectedComponentIdentifier','V',getString(message('physmod:ee:library:comments:spice2ssc:spiceCCCS:error_CurrentmeasuringVoltageSource')),controlcomponent);
                            end
