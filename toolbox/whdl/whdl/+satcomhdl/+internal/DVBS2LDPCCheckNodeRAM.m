classdef(StrictDefaults)DVBS2LDPCCheckNodeRAM<matlab.System
...
%#codegen
    ...
    methods
        ...
        function obj=DVBS2LDPCCheckNodeRAM(varargin)
    ...
    methods(Access=protected)
        ...
        function setupImpl(obj,varargin)
            obj.memDepth=45;
            obj.beta1=cast(zeros(obj.nLayers,obj.memDepth),'like',varargin{1});
            obj.beta2=cast(zeros(obj.nLayers,obj.memDepth),'like',varargin{2});
