classdef ( StrictDefaults )WLANLDPCFunctionalUnit < matlab.System
...
function obj = WLANLDPCFunctionalUnit( varargin )
...
if obj.countVec == 22
sign22 =  - 1 * fi( bitsliceget( betacompress1, 1, 1 ), 1, 2, 0 );
sign21 =  - 1 * fi( bitsliceget( betacompress1, 2, 2 ), 1, 2, 0 );
sign20 =  - 1 * fi( bitsliceget( betacompress1, 3, 3 ), 1, 2, 0 );
sign19 =  - 1 * fi( bitsliceget( betacompress1, 4, 4 ), 1, 2, 0 );
sign18 =  - 1 * fi( bitsliceget( betacompress1, 5, 5 ), 1, 2, 0 );
sign17 =  - 1 * fi( bitsliceget( betacompress1, 6, 6 ), 1, 2, 0 );
sign16 =  - 1 * fi( bitsliceget( betacompress1, 7, 7 ), 1, 2, 0 );
sign15 =  - 1 * fi( bitsliceget( betacompress1, 8, 8 ), 1, 2, 0 );
sign14 =  - 1 * fi( bitsliceget( betacompress1, 9, 9 ), 1, 2, 0 );
sign13 =  - 1 * fi( bitsliceget( betacompress1, 10, 10 ), 1, 2, 0 );
sign12 =  - 1 * fi( bitsliceget( betacompress1, 11, 11 ), 1, 2, 0 );
sign11 =  - 1 * fi( bitsliceget( betacompress1, 12, 12 ), 1, 2, 0 );
sign10 =  - 1 * fi( bitsliceget( betacompress1, 13, 13 ), 1, 2, 0 );
sign9 =  - 1 * fi( bitsliceget( betacompress1, 14, 14 ), 1, 2, 0 );
sign8 =  - 1 * fi( bitsliceget( betacompress1, 15, 15 ), 1, 2, 0 );
sign7 =  - 1 * fi( bitsliceget( betacompress1, 16, 16 ), 1, 2, 0 );
sign6 =  - 1 * fi( bitsliceget( betacompress1, 17, 17 ), 1, 2, 0 );
sign5 =  - 1 * fi( bitsliceget( betacompress1, 18, 18 ), 1, 2, 0 );
sign4 =  - 1 * fi( bitsliceget( betacompress1, 19, 19 ), 1, 2, 0 );
sign3 =  - 1 * fi( bitsliceget( betacompress1, 20, 20 ), 1, 2, 0 );
sign2 =  - 1 * fi( bitsliceget( betacompress1, 21, 21 ), 1, 2, 0 );
sign1 =  - 1 * fi( bitsliceget( betacompress1, 22, 22 ), 1, 2, 0 );

min_index = bitsliceget( betacompress1, 27, 23 );
prodsign =  - 1 * fi( bitsliceget( betacompress1, 28, 28 ), 1, 2, 0 );
else 
sign16 =  - 1 * fi( bitsliceget( betacompress1, 1, 1 ), 1, 2, 0 );
sign15 =  - 1 * fi( bitsliceget( betacompress1, 2, 2 ), 1, 2, 0 );
sign14 =  - 1 * fi( bitsliceget( betacompress1, 3, 3 ), 1, 2, 0 );
sign13 =  - 1 * fi( bitsliceget( betacompress1, 4, 4 ), 1, 2, 0 );
sign12 =  - 1 * fi( bitsliceget( betacompress1, 5, 5 ), 1, 2, 0 );
sign11 =  - 1 * fi( bitsliceget( betacompress1, 6, 6 ), 1, 2, 0 );
sign10 =  - 1 * fi( bitsliceget( betacompress1, 7, 7 ), 1, 2, 0 );
sign9 =  - 1 * fi( bitsliceget( betacompress1, 8, 8 ), 1, 2, 0 );
sign8 =  - 1 * fi( bitsliceget( betacompress1, 9, 9 ), 1, 2, 0 );
sign7 =  - 1 * fi( bitsliceget( betacompress1, 10, 10 ), 1, 2, 0 );
sign6 =  - 1 * fi( bitsliceget( betacompress1, 11, 11 ), 1, 2, 0 );
sign5 =  - 1 * fi( bitsliceget( betacompress1, 12, 12 ), 1, 2, 0 );
sign4 =  - 1 * fi( bitsliceget( betacompress1, 13, 13 ), 1, 2, 0 );
sign3 =  - 1 * fi( bitsliceget( betacompress1, 14, 14 ), 1, 2, 0 );
sign2 =  - 1 * fi( bitsliceget( betacompress1, 15, 15 ), 1, 2, 0 );
sign1 =  - 1 * fi( bitsliceget( betacompress1, 16, 16 ), 1, 2, 0 );

min_index = bitsliceget( betacompress1, 21, 17 );
prodsign =  - 1 * fi( bitsliceget( betacompress1, 22, 22 ), 1, 2, 0 );
end 
...
sign16, sign17, sign18, sign19, sign20, sign21, sign22, min1, min2, min_index, obj.countTo1 );
...
if obj.countVec == 22
sign22_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 1, 1 ), 1, 2, 0 );
sign21_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 2, 2 ), 1, 2, 0 );
sign20_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 3, 3 ), 1, 2, 0 );
sign19_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 4, 4 ), 1, 2, 0 );
sign18_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 5, 5 ), 1, 2, 0 );
sign17_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 6, 6 ), 1, 2, 0 );
sign16_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 7, 7 ), 1, 2, 0 );
sign15_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 8, 8 ), 1, 2, 0 );
sign14_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 9, 9 ), 1, 2, 0 );
sign13_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 10, 10 ), 1, 2, 0 );
sign12_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 11, 11 ), 1, 2, 0 );
sign11_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 12, 12 ), 1, 2, 0 );
sign10_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 13, 13 ), 1, 2, 0 );
sign9_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 14, 14 ), 1, 2, 0 );
sign8_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 15, 15 ), 1, 2, 0 );
sign7_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 16, 16 ), 1, 2, 0 );
sign6_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 17, 17 ), 1, 2, 0 );
sign5_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 18, 18 ), 1, 2, 0 );
sign4_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 19, 19 ), 1, 2, 0 );
sign3_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 20, 20 ), 1, 2, 0 );
sign2_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 21, 21 ), 1, 2, 0 );
sign1_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 22, 22 ), 1, 2, 0 );

min_index_1 = bitsliceget( obj.betaCompress1, 27, 23 );
prodsign_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 28, 28 ), 1, 2, 0 );
else 
sign16_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 1, 1 ), 1, 2, 0 );
sign15_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 2, 2 ), 1, 2, 0 );
sign14_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 3, 3 ), 1, 2, 0 );
sign13_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 4, 4 ), 1, 2, 0 );
sign12_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 5, 5 ), 1, 2, 0 );
sign11_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 6, 6 ), 1, 2, 0 );
sign10_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 7, 7 ), 1, 2, 0 );
sign9_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 8, 8 ), 1, 2, 0 );
sign8_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 9, 9 ), 1, 2, 0 );
sign7_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 10, 10 ), 1, 2, 0 );
sign6_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 11, 11 ), 1, 2, 0 );
sign5_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 12, 12 ), 1, 2, 0 );
sign4_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 13, 13 ), 1, 2, 0 );
sign3_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 14, 14 ), 1, 2, 0 );
sign2_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 15, 15 ), 1, 2, 0 );
sign1_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 16, 16 ), 1, 2, 0 );

min_index_1 = bitsliceget( obj.betaCompress1, 21, 17 );
prodsign_1 =  - 1 * fi( bitsliceget( obj.betaCompress1, 22, 22 ), 1, 2, 0 );
end 
...
sign15_1, sign16_1, sign17_1, sign18_1, sign19_1, sign20_1, sign21_1, sign22_1, min1_1, min2_1, min_index_1, obj.countTo3 );
...
datasign11, datasign12, datasign13, datasign14, datasign15, datasign16, datasign17, datasign18, datasign19, datasign20, datasign21, datasign22, datasign1 ];
else 
smux = [ datasign1, datasign2, datasign3, datasign4, datasign5, datasign6, datasign7, datasign8, datasign9, datasign10,  ...
datasign11, datasign12, datasign13, datasign14, datasign15, datasign16, datasign1 ];
end 
...
obj.datax( idx, 15 );obj.datax( idx, 16 );obj.datax( idx, 17 );obj.datax( idx, 18 );obj.datax( idx, 19 );obj.datax( idx, 20 );obj.datax( idx, 21 );obj.datax( idx, 22 ) ];
else 
dataval = [ obj.datax( idx, 1 );obj.datax( idx, 2 );obj.datax( idx, 3 );obj.datax( idx, 4 );obj.datax( idx, 5 );obj.datax( idx, 6 );obj.datax( idx, 7 ); ...
obj.datax( idx, 8 );obj.datax( idx, 9 );obj.datax( idx, 10 );obj.datax( idx, 11 );obj.datax( idx, 12 );obj.datax( idx, 13 );obj.datax( idx, 14 ); ...
obj.datax( idx, 15 );obj.datax( idx, 16 ); ];
end 
...
% Decoded using De-pcode utility v1.2 from file /tmp/tmp60Xd4K.p.
