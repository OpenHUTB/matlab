classdef ( StrictDefaults )WLANLDPCCheckNodeRAM < matlab.System
...
function obj = WLANLDPCCheckNodeRAM( varargin )
...
% Decoded using De-pcode utility v1.2 from file /tmp/tmpkvoGIm.p.
