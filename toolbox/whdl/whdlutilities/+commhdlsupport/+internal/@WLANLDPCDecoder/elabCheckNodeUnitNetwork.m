function cNet=elabCheckNodeUnitNetwork(this,topNet,blockInfo,dataRate)
    ...
    cType=pir_ufixpt_t(blockInfo.betadecmpWL-6,0);
    ...
    reset_reg=cNet.addSignal(reset.Type,'resetReg');%#ok<NASGU> 
    ...
    '+commhdlsupport','+internal','@WLANLDPCDecoder','cgireml','minCalculation.m'),'r');
    ...
    'EmlParams',{maxVal,mem,ul,bFL,sFlag},...
