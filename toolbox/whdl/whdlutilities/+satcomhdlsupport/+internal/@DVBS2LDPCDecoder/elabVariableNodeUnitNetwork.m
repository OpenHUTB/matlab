function vNet=elabVariableNodeUnitNetwork(this,topNet,blockInfo,dataRate)
    ...
    'Inportnames',{'data','beta','valid','valid_beta','reset','ddsm'},...
    'InportTypes',[v1Type,v2Type,ufix1Type,ufix1Type,ufix1Type,ufix1Type],...
    ...
    dataDTmp=vNet.addSignal(v1Type,'dataDTmp');
    ddsmreg=vNet.addSignal(ufix1Type,'ddsmReg');
    pirelab.getUnitDelayComp(vNet,ddsm,ddsmreg,'',0);
    ...
    pirelab.getSwitchComp(vNet,[datad,dataD],dataDTmp,ddsmreg,'switchComp','==',1);
    pirelab.getWireComp(vNet,dataDTmp,dataout,'');
