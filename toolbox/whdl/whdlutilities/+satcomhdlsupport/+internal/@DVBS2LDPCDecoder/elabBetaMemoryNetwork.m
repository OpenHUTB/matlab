function bmNet=elabBetaMemoryNetwork(this,topNet,blockInfo,dataRate)
    ...
    'InportTypes',[bcVType1,bcVType2,layType,ufix1Type,ufix1Type],...
    ...
    pirelab.getSimpleDualPortRamComp(bmNet,[beta1,countlayer,validin,countlayer],betaout1,'CheckNodeRAM1',45,-1,[],'','',blockInfo.ramAttr_block);
    pirelab.getSimpleDualPortRamComp(bmNet,[beta2,countlayer,validin,countlayer],betaout2,'CheckNodeRAM2',45,-1,[],'','',blockInfo.ramAttr_block);
