function call = getTargetHardwareInterruptEnableCall( hObj )
...
call = targetInfo.getGlobalInterruptEnableCall(  );
end 

% Decoded using De-pcode utility v1.2 from file /tmp/tmpKfFNrs.p.
