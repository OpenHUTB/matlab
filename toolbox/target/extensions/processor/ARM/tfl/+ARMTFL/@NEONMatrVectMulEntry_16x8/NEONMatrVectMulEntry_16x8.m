classdef NEONMatrVectMulEntry_16x8<RTW.TflCOperationEntryML
    methods
        function ent=do_match(hThis,...
            ...
            if mod(hCSO.ConceptualArgs(2).getNthDimension(1),8)==0...
                &&mod(hCSO.ConceptualArgs(2).getNthDimension(2),8)==0...
                &&mod(hCSO.ConceptualArgs(3).getNthDimension(1),8)==0...
