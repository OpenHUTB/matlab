classdef NEONMatrVectMulEntry_8x16<RTW.TflCOperationEntryML
    methods
        function ent=do_match(hThis,...
            ...
            if mod(hCSO.ConceptualArgs(2).getNthDimension(1),16)==0...
                &&mod(hCSO.ConceptualArgs(2).getNthDimension(2),16)==0...
                &&mod(hCSO.ConceptualArgs(3).getNthDimension(1),16)==0...
