classdef(ConstructOnLoad)SSEMatrMatrMulEntry_f32x4<RTW.TflCOperationEntryML




    methods
        function obj=SSEMatrMatrMulEntry_f32x4(varargin)
            mlock;
        ...
        function ent=do_match(hThis,...
            ...
            if mod(hCSO.ConceptualArgs(1).getNthDimension(1),4)==0...
                &&mod(hCSO.ConceptualArgs(1).getNthDimension(2),4)==0...
                &&mod(hCSO.ConceptualArgs(2).getNthDimension(1),4)==0...
