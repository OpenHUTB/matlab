function[outData]=autolibpmsmexterior_block_forwardv1(inData)
    ...
    outData.NewInstanceData(8).Name='Ldq_';
    outData.NewInstanceData(8).Value='1.7e-3';
    ...
    outData.NewInstanceData(21).Name='Ldq';
    outData.NewInstanceData(21).Value='[0.0017 0.0017]';
