function[y,xdot]=automldiffls(u,bw1,bd,bw2,Ndiff,shaftSwitch,Jd,Jw1,Jw2,x)%#codegen
    ...
    Bprime=[diffDir./2.*Ndiff,-1,0,-1/2;diffDir./2.*Ndiff,0,-1,1/2];
    C=[diffDir./2.*Ndiff,diffDir./2.*Ndiff;-1,0;0,-1;1/2,-1/2];
    D=zeros(4,4);
    term1=Ndiff.^2.*Jd;
