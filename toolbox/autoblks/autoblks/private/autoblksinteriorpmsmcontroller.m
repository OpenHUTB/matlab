function[varargout]=autoblksinteriorpmsmcontroller(varargin)
    ...
    case 'MotorConstraintPopup'
        MotorConstraintPopup(Block);
    end
end
...
function Initialization(Block)
    PmsmOptions=...
    {'autolibpmsmcommon/Interior PMSM Speed Control Drive CE','Interior PMSM Speed Control Drive CE';
    'autolibpmsmcommon/Interior PMSM Torque Control Drive CE','Interior PMSM Torque Control Drive CE';
    'autolibpmsmcommon/Interior PMSM Speed Control Drive TL','Interior PMSM Speed Control Drive TL';
    'autolibpmsmcommon/Interior PMSM Torque Control Drive TL','Interior PMSM Torque Control Drive TL';
    };
    ...
    LookupTblList={{'T_mtpa',{'gte',0}},'id_mtpa',{};...
    {'T_mtpa',{'gte',0}},'iq_mtpa',{};...
...
function CalcMtpa(Block)
    Rs=autolibgeteditparamval(Block,'Rs');
    Ld=autolibgeteditparamval(Block,'Ld');
    Lq=autolibgeteditparamval(Block,'Lq');
    PolePairs=autolibgeteditparamval(Block,'PolePairs');
    T_max=autolibgeteditparamval(Block,'T_max');
    I_max=autolibgeteditparamval(Block,'I_max');
    bp=autolibgeteditparamval(Block,'bp');
    lambda_pm=autolibgeteditparamval(Block,'lambda_pm');
    Ref_Selection=get_param(Block,'MotorConstraint');

    switch Ref_Selection
    case 'Maximum Torque'
        [T_mtpa,id_mtpa,iq_mtpa,idq_limits]=autoblks_determine_mtpa(Rs,lambda_pm,Ld,Lq,PolePairs,T_max,bp);
    case 'Maximum Current'
        [T_mtpa,id_mtpa,iq_mtpa,idq_limits]=autoblks_determine_mtpa(Rs,lambda_pm,Ld,Lq,PolePairs,T_max,bp,I_max);
    end

    autolibseteditparamval(Block,'T_mtpa',T_mtpa);
    autolibseteditparamval(Block,'id_mtpa',id_mtpa);
    autolibseteditparamval(Block,'iq_mtpa',iq_mtpa);
...
function MotorConstraintPopup(Block)
    ...
    switch Ref_Selection
    case 'Maximum Torque'
        autoblksenableparameters(Block,'T_max','I_max');
    case 'Maximum Current'
        autoblksenableparameters(Block,'I_max','T_max');
    end
