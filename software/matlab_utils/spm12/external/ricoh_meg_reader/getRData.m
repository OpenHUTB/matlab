...
function out=getRData(varargin)
    try
        function_revision=1;
        function_name='getRData';
    ...
    function calib_data=GetCalibrationData(data,sqf_sysinfo,sqf_acqcond,sqf_channel,calib_offset,calib_gain,unit_type)
        ...
        AdcDigitalMin24=-8388608;
        AdcDigitalMax24=8388607;
        AdcDigitalRange24=16777216;
        AdcDigitalMin32=-2147483648;
        AdcDigitalMax32=2147483647;
        AdcDigitalRange32=4294967296;
        ...
        elseif sqf_sysinfo.adc_allocated==32&&sqf_sysinfo.adc_stored==24
            m_nAdcDigitalMin=AdcDigitalMin24;
            m_nAdcDigitalMax=AdcDigitalMax24;
            m_nAdcDigitalRange=AdcDigitalRange24;
        else
            return;
        end
