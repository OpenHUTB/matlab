classdef SequenceUnfoldingCustomLayerClassBuilder<coder.internal.ctarget.layerClassBuilder.CustomLayerClassBuilder
    ...
    methods(Static,Access=public)
        ...
        function customLayer=convert(layerComp,converter)
            ...
            customLayer=coder.internal.layer.SequenceUnfoldingLayer(layerName,inputFormat,outputFormat,miniBatchSize);
        end
