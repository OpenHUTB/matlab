function Z=conv2dDirectColMajor(layer,X,varargin)
...
%#codegen
    ...
    parfor idxFlattenedDimsConvolution=1:flattenedDimensionsConvolution
%#ok<*PFBNS>

        [idxOutHeight,idxOutWidth,idxOutChannel,idxOutBatch]=ind2sub([outputHeightSize,outputWidthSize,outputChannelSize,outputBatchSize],idxFlattenedDimsConvolution);
        ...
        Z(idxFlattenedDimsConvolution)=activationFunction(outPixel);
    end
