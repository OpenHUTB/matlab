...
// Source File Name:   GetAllUpdatedSoftwareResponse.java
...
//            GetAllUpdatedSoftwareReturn, ExtensionMapper

public class GetAllUpdatedSoftwareResponse
    implements ADBBean
{
    public static class Factory
    {

        public static GetAllUpdatedSoftwareResponse parse(XMLStreamReader reader)
            throws Exception
        {
            GetAllUpdatedSoftwareResponse object;
            object = new GetAllUpdatedSoftwareResponse();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"getAllUpdatedSoftwareResponse".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetAllUpdatedSoftwareResponse)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            {
                object.setResponse(GetAllUpdatedSoftwareReturn.Factory.parse(reader));
                reader.next();
            } else
            {
    ...
    public GetAllUpdatedSoftwareResponse()
    {
    }
    ...
    public GetAllUpdatedSoftwareReturn getResponse()
    {
        return localResponse;
    }

    public void setResponse(GetAllUpdatedSoftwareReturn param)
    {
        localResponse = param;
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(MY_QNAME, factory) {
            ...
            {
                GetAllUpdatedSoftwareResponse.this.serialize(GetAllUpdatedSoftwareResponse.MY_QNAME, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final GetAllUpdatedSoftwareResponse this$0;

            
            {
                this$0 = GetAllUpdatedSoftwareResponse.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":getAllUpdatedSoftwareResponse").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getAllUpdatedSoftwareResponse", xmlWriter);
        }
    ...
    public static final QName MY_QNAME = new QName("https://services.mathworks.com/dws3/services/DownloadService", "getAllUpdatedSoftwareResponse", "ns1");
    protected GetAllUpdatedSoftwareReturn localResponse;
