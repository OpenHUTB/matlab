...
// Source File Name:   PingResponse.java
    ...
    implements ADBBean
{
    public static class Factory
    {
        ...
        public static PingResponse parse(XMLStreamReader reader)
            throws Exception
        {
            PingResponse object;
            object = new PingResponse();
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"pingResponse".equals(type))
                        {
                            ...
                            return (PingResponse)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            reader.next();
            for(; !reader.isStartElement() && !reader.isEndElement(); reader.next());
            if(reader.isStartElement() && (new QName("https://services.mathworks.com/dws3/services/DownloadService", "pingReturn")).equals(reader.getName()))
            {
                content = reader.getElementText();
                object.setPingReturn(ConverterUtil.convertToString(content));
                reader.next();
            } else
            {
    ...
    public String getPingReturn()
    {
        return localPingReturn;
    }

    public void setPingReturn(String param)
    {
        localPingReturn = param;
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(MY_QNAME, factory) {
            ...
            {
                PingResponse.this.serialize(PingResponse.MY_QNAME, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final PingResponse this$0;

            
            {
                this$0 = PingResponse.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":pingResponse").toString(), xmlWriter);
            else
        ...
        if(!namespace.equals(""))
        {
            ...
            {
                prefix = generatePrefix(namespace);
                xmlWriter.writeStartElement(prefix, "pingReturn", namespace);
                xmlWriter.writeNamespace(prefix, namespace);
                xmlWriter.setPrefix(prefix, namespace);
            } else
            {
                xmlWriter.writeStartElement(namespace, "pingReturn");
            }
        } else
        {
            xmlWriter.writeStartElement("pingReturn");
        }
        if(localPingReturn == null)
        {
            throw new ADBException("pingReturn cannot be null!!");
        } else
        {
            xmlWriter.writeCharacters(localPingReturn);
        ...
        throws ADBException
    {
        ...
        elementList.add(new QName("https://services.mathworks.com/dws3/services/DownloadService", "pingReturn"));
        if(localPingReturn != null)
            elementList.add(ConverterUtil.convertToString(localPingReturn));
        else
            throw new ADBException("pingReturn cannot be null!!");
        return new ADBXMLStreamReaderImpl(qName, elementList.toArray(), attribList.toArray());
    }

    public static final QName MY_QNAME = new QName("https://services.mathworks.com/dws3/services/DownloadService", "pingResponse", "ns1");
    protected String localPingReturn;
