...
// Source File Name:   GetUpdatedSoftwareWithinReleaseAndArchReturn.java
...
public class GetUpdatedSoftwareWithinReleaseAndArchReturn
    implements ADBBean
{
    public static class Factory
    {

        public static GetUpdatedSoftwareWithinReleaseAndArchReturn parse(XMLStreamReader reader)
            throws Exception
        {
            GetUpdatedSoftwareWithinReleaseAndArchReturn object;
            object = new GetUpdatedSoftwareWithinReleaseAndArchReturn();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"getUpdatedSoftwareWithinReleaseAndArchReturn".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetUpdatedSoftwareWithinReleaseAndArchReturn)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
    ...
    public GetUpdatedSoftwareWithinReleaseAndArchReturn()
    {
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(parentQName, factory) {
            ...
            {
                GetUpdatedSoftwareWithinReleaseAndArchReturn.this.serialize(parentQName, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final GetUpdatedSoftwareWithinReleaseAndArchReturn this$0;

            
            {
                this$0 = GetUpdatedSoftwareWithinReleaseAndArchReturn.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":getUpdatedSoftwareWithinReleaseAndArchReturn").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getUpdatedSoftwareWithinReleaseAndArchReturn", xmlWriter);
        }
