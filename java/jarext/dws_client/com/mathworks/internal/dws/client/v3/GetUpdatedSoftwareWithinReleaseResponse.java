...
// Source File Name:   GetUpdatedSoftwareWithinReleaseResponse.java
...
//            GetUpdatedSoftwareWithinReleaseReturn, ExtensionMapper

public class GetUpdatedSoftwareWithinReleaseResponse
    implements ADBBean
{
    public static class Factory
    {

        public static GetUpdatedSoftwareWithinReleaseResponse parse(XMLStreamReader reader)
            throws Exception
        {
            GetUpdatedSoftwareWithinReleaseResponse object;
            object = new GetUpdatedSoftwareWithinReleaseResponse();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"getUpdatedSoftwareWithinReleaseResponse".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetUpdatedSoftwareWithinReleaseResponse)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            {
                object.setResponse(GetUpdatedSoftwareWithinReleaseReturn.Factory.parse(reader));
                reader.next();
            } else
            {
    ...
    public GetUpdatedSoftwareWithinReleaseResponse()
    {
    }
    ...
    public GetUpdatedSoftwareWithinReleaseReturn getResponse()
    {
        return localResponse;
    }

    public void setResponse(GetUpdatedSoftwareWithinReleaseReturn param)
    {
        localResponse = param;
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(MY_QNAME, factory) {
            ...
            {
                GetUpdatedSoftwareWithinReleaseResponse.this.serialize(GetUpdatedSoftwareWithinReleaseResponse.MY_QNAME, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final GetUpdatedSoftwareWithinReleaseResponse this$0;

            
            {
                this$0 = GetUpdatedSoftwareWithinReleaseResponse.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":getUpdatedSoftwareWithinReleaseResponse").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getUpdatedSoftwareWithinReleaseResponse", xmlWriter);
        }
    ...
    public static final QName MY_QNAME = new QName("https://services.mathworks.com/dws3/services/DownloadService", "getUpdatedSoftwareWithinReleaseResponse", "ns1");
    protected GetUpdatedSoftwareWithinReleaseReturn localResponse;
