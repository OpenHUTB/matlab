...
// Source File Name:   GetSoftwareProductInfoByLicenseAndArchitecturesResponse.java
...
//            GetSoftwareProductInfoByLicenseAndArchitecturesReturn, ExtensionMapper

public class GetSoftwareProductInfoByLicenseAndArchitecturesResponse
    implements ADBBean
{
    public static class Factory
    {

        public static GetSoftwareProductInfoByLicenseAndArchitecturesResponse parse(XMLStreamReader reader)
            throws Exception
        {
            GetSoftwareProductInfoByLicenseAndArchitecturesResponse object;
            object = new GetSoftwareProductInfoByLicenseAndArchitecturesResponse();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"getSoftwareProductInfoByLicenseAndArchitecturesResponse".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetSoftwareProductInfoByLicenseAndArchitecturesResponse)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            reader.next();
            for(; !reader.isStartElement() && !reader.isEndElement(); reader.next());
            if(reader.isStartElement() && (new QName("https://services.mathworks.com/dws3/services/DownloadService", "response")).equals(reader.getName()))
            {
                object.setResponse(GetSoftwareProductInfoByLicenseAndArchitecturesReturn.Factory.parse(reader));
                reader.next();
            } else
            {
    ...
    public GetSoftwareProductInfoByLicenseAndArchitecturesResponse()
    {
    }
    ...
    public GetSoftwareProductInfoByLicenseAndArchitecturesReturn getResponse()
    {
        return localResponse;
    }

    public void setResponse(GetSoftwareProductInfoByLicenseAndArchitecturesReturn param)
    {
        localResponse = param;
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(MY_QNAME, factory) {
            ...
            {
                GetSoftwareProductInfoByLicenseAndArchitecturesResponse.this.serialize(GetSoftwareProductInfoByLicenseAndArchitecturesResponse.MY_QNAME, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final GetSoftwareProductInfoByLicenseAndArchitecturesResponse this$0;

            
            {
                this$0 = GetSoftwareProductInfoByLicenseAndArchitecturesResponse.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":getSoftwareProductInfoByLicenseAndArchitecturesResponse").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getSoftwareProductInfoByLicenseAndArchitecturesResponse", xmlWriter);
        }
        ...
        {
            localResponse.serialize(new QName("https://services.mathworks.com/dws3/services/DownloadService", "response"), factory, xmlWriter);
        ...
        throws ADBException
    {
        ...
        elementList.add(new QName("https://services.mathworks.com/dws3/services/DownloadService", "response"));
        if(localResponse == null)
        {
            throw new ADBException("response cannot be null!!");
        } else
    ...
    public static final QName MY_QNAME = new QName("https://services.mathworks.com/dws3/services/DownloadService", "getSoftwareProductInfoByLicenseAndArchitecturesResponse", "ns1");
    protected GetSoftwareProductInfoByLicenseAndArchitecturesReturn localResponse;
