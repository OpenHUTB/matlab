...
// Source File Name:   ArrayOfSoftwareProduct.java
...
//            SoftwareProduct, ExtensionMapper

public class ArrayOfSoftwareProduct
    implements ADBBean
{
    public static class Factory
    {

        public static ArrayOfSoftwareProduct parse(XMLStreamReader reader)
            throws Exception
        {
            ArrayOfSoftwareProduct object;
            object = new ArrayOfSoftwareProduct();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"ArrayOfSoftwareProduct".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ArrayOfSoftwareProduct)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            {
                list1.add(SoftwareProduct.Factory.parse(reader));
                loopDone1 = false;
                while(!loopDone1) 
                {
                ...
                object.setItem((SoftwareProduct[])(SoftwareProduct[])ConverterUtil.convertToArray(com/mathworks/internal/dws/client/v3/SoftwareProduct, list1));
            }
            for(; !reader.isStartElement() && !reader.isEndElement(); reader.next());
    ...
    public SoftwareProduct[] getItem()
    {
        return localItem;
    }

    protected void validateItem(SoftwareProduct asoftwareproduct[])
    {
    }

    public void setItem(SoftwareProduct param[])
    {
        validateItem(param);
        if(param != null)
    ...
    public void addItem(SoftwareProduct param)
    {
        if(localItem == null)
            localItem = new SoftwareProduct[0];
        localItemTracker = true;
        List list = ConverterUtil.toList(localItem);
        list.add(param);
        localItem = (SoftwareProduct[])(SoftwareProduct[])list.toArray(new SoftwareProduct[list.size()]);
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(parentQName, factory) {
            ...
            {
                ArrayOfSoftwareProduct.this.serialize(parentQName, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final ArrayOfSoftwareProduct this$0;

            
            {
                this$0 = ArrayOfSoftwareProduct.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":ArrayOfSoftwareProduct").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ArrayOfSoftwareProduct", xmlWriter);
        }
        if(localItemTracker)
            if(localItem != null)
            {
    ...
    protected SoftwareProduct localItem[];
