    ...
    implements ADBBean
{
    public static class Factory
    {
        ...
        public static BitVer parse(XMLStreamReader reader)
            throws Exception
        {
            BitVer object;
            object = new BitVer();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"BitVer".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (BitVer)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(parentQName, factory) {
            ...
            {
                BitVer.this.serialize(parentQName, factory, xmlWriter);
            }
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":BitVer").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "BitVer", xmlWriter);
        }
