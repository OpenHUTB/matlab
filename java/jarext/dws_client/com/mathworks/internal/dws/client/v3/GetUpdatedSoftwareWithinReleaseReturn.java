...
// Source File Name:   GetUpdatedSoftwareWithinReleaseReturn.java
...
public class GetUpdatedSoftwareWithinReleaseReturn
    implements ADBBean
{
    public static class Factory
    {

        public static GetUpdatedSoftwareWithinReleaseReturn parse(XMLStreamReader reader)
            throws Exception
        {
            GetUpdatedSoftwareWithinReleaseReturn object;
            object = new GetUpdatedSoftwareWithinReleaseReturn();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"getUpdatedSoftwareWithinReleaseReturn".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetUpdatedSoftwareWithinReleaseReturn)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
    ...
    public GetUpdatedSoftwareWithinReleaseReturn()
    {
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(parentQName, factory) {
            ...
            {
                GetUpdatedSoftwareWithinReleaseReturn.this.serialize(parentQName, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final GetUpdatedSoftwareWithinReleaseReturn this$0;

            
            {
                this$0 = GetUpdatedSoftwareWithinReleaseReturn.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":getUpdatedSoftwareWithinReleaseReturn").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getUpdatedSoftwareWithinReleaseReturn", xmlWriter);
        }
