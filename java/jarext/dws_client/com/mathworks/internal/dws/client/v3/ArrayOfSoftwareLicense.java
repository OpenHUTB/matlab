...
// Source File Name:   ArrayOfSoftwareLicense.java
...
//            SoftwareLicense, ExtensionMapper

public class ArrayOfSoftwareLicense
    implements ADBBean
{
    public static class Factory
    {

        public static ArrayOfSoftwareLicense parse(XMLStreamReader reader)
            throws Exception
        {
            ArrayOfSoftwareLicense object;
            object = new ArrayOfSoftwareLicense();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"ArrayOfSoftwareLicense".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ArrayOfSoftwareLicense)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            {
                list1.add(SoftwareLicense.Factory.parse(reader));
                loopDone1 = false;
                while(!loopDone1) 
                {
                ...
                object.setItem((SoftwareLicense[])(SoftwareLicense[])ConverterUtil.convertToArray(com/mathworks/internal/dws/client/v3/SoftwareLicense, list1));
            }
            for(; !reader.isStartElement() && !reader.isEndElement(); reader.next());
    ...
    public SoftwareLicense[] getItem()
    {
        return localItem;
    }

    protected void validateItem(SoftwareLicense asoftwarelicense[])
    {
    }

    public void setItem(SoftwareLicense param[])
    {
        validateItem(param);
        if(param != null)
    ...
    public void addItem(SoftwareLicense param)
    {
        if(localItem == null)
            localItem = new SoftwareLicense[0];
        localItemTracker = true;
        List list = ConverterUtil.toList(localItem);
        list.add(param);
        localItem = (SoftwareLicense[])(SoftwareLicense[])list.toArray(new SoftwareLicense[list.size()]);
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(parentQName, factory) {
            ...
            {
                ArrayOfSoftwareLicense.this.serialize(parentQName, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final ArrayOfSoftwareLicense this$0;

            
            {
                this$0 = ArrayOfSoftwareLicense.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":ArrayOfSoftwareLicense").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ArrayOfSoftwareLicense", xmlWriter);
        }
        if(localItemTracker)
            if(localItem != null)
            {
    ...
    protected SoftwareLicense localItem[];
