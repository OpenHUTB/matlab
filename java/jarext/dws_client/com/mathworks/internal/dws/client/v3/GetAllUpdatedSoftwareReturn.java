...
// Source File Name:   GetAllUpdatedSoftwareReturn.java
...
public class GetAllUpdatedSoftwareReturn
    implements ADBBean
{
    public static class Factory
    {

        public static GetAllUpdatedSoftwareReturn parse(XMLStreamReader reader)
            throws Exception
        {
            GetAllUpdatedSoftwareReturn object;
            object = new GetAllUpdatedSoftwareReturn();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"getAllUpdatedSoftwareReturn".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetAllUpdatedSoftwareReturn)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
    ...
    public GetAllUpdatedSoftwareReturn()
    {
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(parentQName, factory) {
            ...
            {
                GetAllUpdatedSoftwareReturn.this.serialize(parentQName, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final GetAllUpdatedSoftwareReturn this$0;

            
            {
                this$0 = GetAllUpdatedSoftwareReturn.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":getAllUpdatedSoftwareReturn").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getAllUpdatedSoftwareReturn", xmlWriter);
        }
