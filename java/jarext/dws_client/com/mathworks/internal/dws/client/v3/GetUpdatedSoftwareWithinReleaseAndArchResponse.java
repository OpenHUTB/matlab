...
// Source File Name:   GetUpdatedSoftwareWithinReleaseAndArchResponse.java
...
//            GetUpdatedSoftwareWithinReleaseAndArchReturn, ExtensionMapper

public class GetUpdatedSoftwareWithinReleaseAndArchResponse
    implements ADBBean
{
    public static class Factory
    {

        public static GetUpdatedSoftwareWithinReleaseAndArchResponse parse(XMLStreamReader reader)
            throws Exception
        {
            GetUpdatedSoftwareWithinReleaseAndArchResponse object;
            object = new GetUpdatedSoftwareWithinReleaseAndArchResponse();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"getUpdatedSoftwareWithinReleaseAndArchResponse".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetUpdatedSoftwareWithinReleaseAndArchResponse)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            {
                object.setResponse(GetUpdatedSoftwareWithinReleaseAndArchReturn.Factory.parse(reader));
                reader.next();
            } else
            {
    ...
    public GetUpdatedSoftwareWithinReleaseAndArchResponse()
    {
    }
    ...
    public GetUpdatedSoftwareWithinReleaseAndArchReturn getResponse()
    {
        return localResponse;
    }

    public void setResponse(GetUpdatedSoftwareWithinReleaseAndArchReturn param)
    {
        localResponse = param;
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(MY_QNAME, factory) {
            ...
            {
                GetUpdatedSoftwareWithinReleaseAndArchResponse.this.serialize(GetUpdatedSoftwareWithinReleaseAndArchResponse.MY_QNAME, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final GetUpdatedSoftwareWithinReleaseAndArchResponse this$0;

            
            {
                this$0 = GetUpdatedSoftwareWithinReleaseAndArchResponse.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":getUpdatedSoftwareWithinReleaseAndArchResponse").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getUpdatedSoftwareWithinReleaseAndArchResponse", xmlWriter);
        }
    ...
    public static final QName MY_QNAME = new QName("https://services.mathworks.com/dws3/services/DownloadService", "getUpdatedSoftwareWithinReleaseAndArchResponse", "ns1");
    protected GetUpdatedSoftwareWithinReleaseAndArchReturn localResponse;
