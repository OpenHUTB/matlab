...
// Source File Name:   ArrayOfSoftware.java
...
//            Software, ExtensionMapper

public class ArrayOfSoftware
    implements ADBBean
{
    public static class Factory
    {

        public static ArrayOfSoftware parse(XMLStreamReader reader)
            throws Exception
        {
            ArrayOfSoftware object;
            object = new ArrayOfSoftware();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"ArrayOfSoftware".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ArrayOfSoftware)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            {
                list1.add(Software.Factory.parse(reader));
                loopDone1 = false;
                while(!loopDone1) 
                {
                    ...
                    if((new QName("https://services.mathworks.com/dws3/services/DownloadService", "software")).equals(reader.getName()))
                        list1.add(Software.Factory.parse(reader));
                    else
                        loopDone1 = true;
                }
                object.setSoftware((Software[])(Software[])ConverterUtil.convertToArray(com/mathworks/internal/dws/client/v3/Software, list1));
            }
            for(; !reader.isStartElement() && !reader.isEndElement(); reader.next());
    ...
    public ArrayOfSoftware()
    {
        localSoftwareTracker = false;
    }
    ...
    protected void validateSoftware(Software asoftware[])
    {
    }

    public void setSoftware(Software param[])
    {
        validateSoftware(param);
        if(param != null)
            localSoftwareTracker = true;
        else
            localSoftwareTracker = false;
        localSoftware = param;
    }

    public void addSoftware(Software param)
    {
        if(localSoftware == null)
            localSoftware = new Software[0];
        localSoftwareTracker = true;
        List list = ConverterUtil.toList(localSoftware);
        list.add(param);
        localSoftware = (Software[])(Software[])list.toArray(new Software[list.size()]);
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(parentQName, factory) {
            ...
            {
                ArrayOfSoftware.this.serialize(parentQName, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final ArrayOfSoftware this$0;

            
            {
                this$0 = ArrayOfSoftware.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":ArrayOfSoftware").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ArrayOfSoftware", xmlWriter);
        }
        if(localSoftwareTracker)
            if(localSoftware != null)
            {
                for(int i = 0; i < localSoftware.length; i++)
                    if(localSoftware[i] != null)
                        localSoftware[i].serialize(new QName("https://services.mathworks.com/dws3/services/DownloadService", "software"), factory, xmlWriter);

            } else
            {
                throw new ADBException("software cannot be null!!");
            }
            ...
            if(localSoftware != null)
            {
                for(int i = 0; i < localSoftware.length; i++)
                    if(localSoftware[i] != null)
                    {
                        ...
                        elementList.add(localSoftware[i]);
                    }
    ...
    protected Software localSoftware[];
    protected boolean localSoftwareTracker;
}
