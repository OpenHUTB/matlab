...
// Source File Name:   GetUpdatedSoftwareWithinPasscodeAndArchResponse.java
...
//            GetUpdatedSoftwareWithinPasscodeAndArchReturn, ExtensionMapper

public class GetUpdatedSoftwareWithinPasscodeAndArchResponse
    implements ADBBean
{
    public static class Factory
    {

        public static GetUpdatedSoftwareWithinPasscodeAndArchResponse parse(XMLStreamReader reader)
            throws Exception
        {
            GetUpdatedSoftwareWithinPasscodeAndArchResponse object;
            object = new GetUpdatedSoftwareWithinPasscodeAndArchResponse();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"getUpdatedSoftwareWithinPasscodeAndArchResponse".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetUpdatedSoftwareWithinPasscodeAndArchResponse)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            {
                object.setResponse(GetUpdatedSoftwareWithinPasscodeAndArchReturn.Factory.parse(reader));
                reader.next();
            } else
            {
    ...
    public GetUpdatedSoftwareWithinPasscodeAndArchResponse()
    {
    }
    ...
    public GetUpdatedSoftwareWithinPasscodeAndArchReturn getResponse()
    {
        return localResponse;
    }

    public void setResponse(GetUpdatedSoftwareWithinPasscodeAndArchReturn param)
    {
        localResponse = param;
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(MY_QNAME, factory) {
            ...
            {
                GetUpdatedSoftwareWithinPasscodeAndArchResponse.this.serialize(GetUpdatedSoftwareWithinPasscodeAndArchResponse.MY_QNAME, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final GetUpdatedSoftwareWithinPasscodeAndArchResponse this$0;

            
            {
                this$0 = GetUpdatedSoftwareWithinPasscodeAndArchResponse.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":getUpdatedSoftwareWithinPasscodeAndArchResponse").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getUpdatedSoftwareWithinPasscodeAndArchResponse", xmlWriter);
        }
    ...
    public static final QName MY_QNAME = new QName("https://services.mathworks.com/dws3/services/DownloadService", "getUpdatedSoftwareWithinPasscodeAndArchResponse", "ns1");
    protected GetUpdatedSoftwareWithinPasscodeAndArchReturn localResponse;
