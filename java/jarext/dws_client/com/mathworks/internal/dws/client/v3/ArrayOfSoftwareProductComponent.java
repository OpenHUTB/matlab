...
// Source File Name:   ArrayOfSoftwareProductComponent.java
...
//            SoftwareProductComponent, ExtensionMapper

public class ArrayOfSoftwareProductComponent
    implements ADBBean
{
    public static class Factory
    {

        public static ArrayOfSoftwareProductComponent parse(XMLStreamReader reader)
            throws Exception
        {
            ArrayOfSoftwareProductComponent object;
            object = new ArrayOfSoftwareProductComponent();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"ArrayOfSoftwareProductComponent".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ArrayOfSoftwareProductComponent)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            {
                list1.add(SoftwareProductComponent.Factory.parse(reader));
                loopDone1 = false;
                while(!loopDone1) 
                {
                ...
                object.setItem((SoftwareProductComponent[])(SoftwareProductComponent[])ConverterUtil.convertToArray(com/mathworks/internal/dws/client/v3/SoftwareProductComponent, list1));
            }
            for(; !reader.isStartElement() && !reader.isEndElement(); reader.next());
    ...
    public ArrayOfSoftwareProductComponent()
    {
    ...
    public SoftwareProductComponent[] getItem()
    {
        return localItem;
    }

    protected void validateItem(SoftwareProductComponent asoftwareproductcomponent[])
    {
    }

    public void setItem(SoftwareProductComponent param[])
    {
        validateItem(param);
        if(param != null)
    ...
    public void addItem(SoftwareProductComponent param)
    {
        if(localItem == null)
            localItem = new SoftwareProductComponent[0];
        localItemTracker = true;
        List list = ConverterUtil.toList(localItem);
        list.add(param);
        localItem = (SoftwareProductComponent[])(SoftwareProductComponent[])list.toArray(new SoftwareProductComponent[list.size()]);
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(parentQName, factory) {
            ...
            {
                ArrayOfSoftwareProductComponent.this.serialize(parentQName, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final ArrayOfSoftwareProductComponent this$0;

            
            {
                this$0 = ArrayOfSoftwareProductComponent.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":ArrayOfSoftwareProductComponent").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ArrayOfSoftwareProductComponent", xmlWriter);
        }
        if(localItemTracker)
            if(localItem != null)
            {
                for(int i = 0; i < localItem.length; i++)
                    if(localItem[i] != null)
                        localItem[i].serialize(new QName("https://services.mathworks.com/dws3/services/DownloadService", "item"), factory, xmlWriter);
    ...
    protected SoftwareProductComponent localItem[];
