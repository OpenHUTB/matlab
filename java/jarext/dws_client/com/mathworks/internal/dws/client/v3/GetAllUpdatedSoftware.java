...
// Source File Name:   GetAllUpdatedSoftware.java
...
public class GetAllUpdatedSoftware
    implements ADBBean
{
    public static class Factory
    {

        public static GetAllUpdatedSoftware parse(XMLStreamReader reader)
            throws Exception
        {
            GetAllUpdatedSoftware object;
            object = new GetAllUpdatedSoftware();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"getAllUpdatedSoftware".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetAllUpdatedSoftware)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(MY_QNAME, factory) {
            ...
            {
                GetAllUpdatedSoftware.this.serialize(GetAllUpdatedSoftware.MY_QNAME, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final GetAllUpdatedSoftware this$0;

            
            {
                this$0 = GetAllUpdatedSoftware.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":getAllUpdatedSoftware").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getAllUpdatedSoftware", xmlWriter);
        }
    ...
    public static final QName MY_QNAME = new QName("https://services.mathworks.com/dws3/services/DownloadService", "getAllUpdatedSoftware", "ns1");
