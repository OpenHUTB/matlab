...
// Source File Name:   GetUpdatedSoftwareWithinPasscodeAndArch.java
...
public class GetUpdatedSoftwareWithinPasscodeAndArch
    implements ADBBean
{
    public static class Factory
    {

        public static GetUpdatedSoftwareWithinPasscodeAndArch parse(XMLStreamReader reader)
            throws Exception
        {
            GetUpdatedSoftwareWithinPasscodeAndArch object;
            object = new GetUpdatedSoftwareWithinPasscodeAndArch();
            ...
            try
            {
                ...
                if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if(fullTypeName != null)
                    {
                        ...
                        if(!"getUpdatedSoftwareWithinPasscodeAndArch".equals(type))
                        {
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetUpdatedSoftwareWithinPasscodeAndArch)ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
            }
            ...
            if(reader.isStartElement() && (new QName("https://services.mathworks.com/dws3/services/DownloadService", "architecture")).equals(reader.getName()))
            {
                ...
                object.setArchitecture(ConverterUtil.convertToString(content));
                reader.next();
            } else
            {
                throw new ADBException((new StringBuilder()).append("Unexpected subelement ").append(reader.getLocalName()).toString());
    ...
    public GetUpdatedSoftwareWithinPasscodeAndArch()
    {
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(MY_QNAME, factory) {
            ...
            {
                GetUpdatedSoftwareWithinPasscodeAndArch.this.serialize(GetUpdatedSoftwareWithinPasscodeAndArch.MY_QNAME, factory, xmlWriter);
            }

            final OMFactory val$factory;
            final GetUpdatedSoftwareWithinPasscodeAndArch this$0;

            
            {
                this$0 = GetUpdatedSoftwareWithinPasscodeAndArch.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
;
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":getUpdatedSoftwareWithinPasscodeAndArch").toString(), xmlWriter);
            else
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getUpdatedSoftwareWithinPasscodeAndArch", xmlWriter);
        }
        if(localBv != null)
        {
    ...
    public static final QName MY_QNAME = new QName("https://services.mathworks.com/dws3/services/DownloadService", "getUpdatedSoftwareWithinPasscodeAndArch", "ns1");
