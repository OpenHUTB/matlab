...
// Source File Name:   ArrayOfString.java
    ...
    implements ADBBean
{
    public static class Factory
    {
            ...
            throws Exception
        {
            ...
            if(reader.isStartElement() && (new QName("https://services.mathworks.com/dws3/services/DownloadService", "item")).equals(reader.getName()))
            {
                ...
                object.setItem((String[])(String[])list1.toArray(new String[list1.size()]));
            }
            for(; !reader.isStartElement() && !reader.isEndElement(); reader.next());
    ...
    protected void validateItem(String as[])
    {
    }
    ...
    {
        if(localItem == null)
            localItem = new String[0];
        localItemTracker = true;
        List list = ConverterUtil.toList(localItem);
        list.add(param);
        localItem = (String[])(String[])list.toArray(new String[list.size()]);
    }
        ...
        throws ADBException
    {
        org.apache.axiom.om.OMDataSource dataSource = new ADBDataSource(parentQName, factory) {
            ...
            final ArrayOfString this$0;

            
            {
                this$0 = ArrayOfString.this;
                factory = omfactory;
                super(x0, x1);
            }
        }
        ...
        throws XMLStreamException, ADBException
    {
        ...
        if(serializeType)
        {
            ...
            if(namespacePrefix != null && namespacePrefix.trim().length() > 0)
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", (new StringBuilder()).append(namespacePrefix).append(":ArrayOfString").toString(), xmlWriter);
            else
